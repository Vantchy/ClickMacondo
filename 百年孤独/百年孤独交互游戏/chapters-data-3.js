...
registerChapter({
  ...
  scenes: {
    ...
    ch6_r1_choice: { id:'ch6_r1_choice', type:'choice', chapter:6, round:1, title:'第一轮选择 · 初战', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['你的第一场战役。敌人是保守党的正规军——人数比你们多三倍，武器比你们精良。你的手下是农民——他们手里是农具改造的矛。','一个中尉建议撤退，另外有人主张正面冲锋。所有人都在等你的命令。'], transition:'你选择——' }, choices:[
      { id:'ch6_r1_a', label:'夜袭——以少胜多', description:'利用地势和夜色。打游击战——你不是正规军，不需要按规则来。', nextScene:'ch6_r1a', effects:{ tags:['游击战术家'], fate:2, memory:null } },
      { id:'ch6_r1_b', label:'撤退——保存实力', description:'今天不打——等更好的时机。活着比勇敢更重要。', nextScene:'ch6_r1b', effects:{ tags:['谨慎的指挥官'], fate:1, memory:null } },
      { id:'ch6_r1_c', label:'正面迎战——鼓舞士气', description:'站在最前面，让每个士兵都看见你的脸。恐惧只有在你转身的时候才会放大。', nextScene:'ch6_r1c', effects:{ tags:['勇敢的领袖'], fate:2, memory:null } }
    ...
    ch6_r1_settlement: { id:'ch6_r1_settlement', type:'settlement', chapter:6, round:1, title:'第一轮 · 结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['首战告捷——或至少活下来了。你的名字开始在自由党控制的地区流传。人们叫你"布恩迪亚上校"——这个称号会跟随你直到死。']}, settlement:{ summary:'第一轮完成。你指挥了第一场战役。', nextScene:'ch6_r2_choice', nextLabel:'进入第二轮' } },
    ...
    ch6_r2_choice: { id:'ch6_r2_choice', type:'choice', chapter:6, round:2, title:'第二轮选择 · 阿尔卡蒂奥的暴政', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['你不在马孔多的时候，阿尔卡蒂奥——你的侄子——接管了镇子。他穿上军装，学着你走路。他设立了军事法庭——实际上就是他自己坐在一张桌子后面，凭感觉判刑。','村民们开始害怕走进镇公所。他枪毙了一个卖鸡蛋的——因为鸡蛋涨价了。"投机倒把。"他说。乌尔苏拉冲进镇公所，脱下拖鞋——当着所有人的面打了阿尔卡蒂奥。'], transition:'你选择——' }, choices:[
      { id:'ch6_r2_a', label:'回去——制止阿尔卡蒂奥', description:'你不能让布恩迪亚的名字变成暴政的同义词。放下前线的事，回去整顿。', nextScene:'ch6_r2a', effects:{ tags:['纠正者'], fate:1, memory:null } },
      { id:'ch6_r2_b', label:'写信警告他', description:'你不能离开前线——但可以写信。告诉阿尔卡蒂奥：权力不是用来报仇的。', nextScene:'ch6_r2b', effects:{ tags:['远程的父亲'], fate:1, memory:null } },
      { id:'ch6_r2_c', label:'信任乌尔苏拉——她会处理', description:'乌尔苏拉不需要你的帮助。她已经用拖鞋教训了他——现在让他自己学会做人。', nextScene:'ch6_r2c', effects:{ tags:['放手者'], fate:1, memory:null } }
    ...
    ch6_r2_settlement: { id:'ch6_r2_settlement', type:'settlement', chapter:6, round:2, title:'第二轮 · 结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['阿尔卡蒂奥的暴政结束了——以这样或那样的方式。布恩迪亚的名字没有被玷污——但它已经被权力触碰过了。有些痕迹是洗不掉的。']}, settlement:{ summary:'第二轮完成。你面对了家族中产生的暴政。', nextScene:'ch6_r3_choice', nextLabel:'进入第三轮' } },
    ...
    ch6_r3_choice: { id:'ch6_r3_choice', type:'choice', chapter:6, round:3, title:'第三轮选择 · 处决令', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['你的一个老朋友——和你一起从马孔多出征的人——被俘了。不是被敌人——是被自己人。他被指控叛变——但你知道他是无辜的。他只是在一封家书里写了一句"也许我们该和谈了"。','军事法庭判他死刑。但你有权否决。你的手下正看着你——他们中有的人认为叛变就是叛变，无论形式。'], transition:'你选择——' }, choices:[
      { id:'ch6_r3_a', label:'否决处决——救他', description:'他是无辜的——你知道。行使你的权力，撤销死刑。哪怕手下人不满。', nextScene:'ch6_r3a', effects:{ tags:['公正的裁决者'], fate:1, memory:null } },
      { id:'ch6_r3_b', label:'签署处决令', description:'你不能因为一个人而动摇全军纪律。军法就是军法——即使你知道他不该死。', nextScene:'ch6_r3b', effects:{ tags:['铁血指挥官'], fate:3, memory:'签署的名字' } },
      { id:'ch6_r3_c', label:'放他逃走', description:'你不能正式否决——但你可以在夜里让人放他走。让他带着秘密活着离开。', nextScene:'ch6_r3c', effects:{ tags:['暗中救赎者'], fate:2, memory:null } }
    ...
    ch6_r3_settlement: { id:'ch6_r3_settlement', type:'settlement', chapter:6, round:3, title:'第三轮 · 结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['处决或不处决——你的手上已经有了血迹。战争中没有人是干净的。区别只在于是谁的血——敌人的，朋友的，还是你自己的。']}, settlement:{ summary:'第三轮完成。你面对了战争中最难的抉择——朋友的生死。', nextScene:'ch6_r4_choice', nextLabel:'进入第四轮' } },
    ...
    ch6_r4_choice: { id:'ch6_r4_choice', type:'choice', chapter:6, round:4, title:'第四轮选择 · 孤独的将军', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['你打了三十二场起义——三十二场全部失败。你和十七个女人生下十七个儿子——一夜之间全部被杀死。你躲过十四次暗杀、七十三次伏击和一次行刑队。','你拒绝共和国总统颁发的勋章。你已经不是最初那个为正义而战的年轻人了。你在打一场自己都不知道为什么要打的仗。'], transition:'你选择——' }, choices:[
      { id:'ch6_r4_a', label:'继续战斗——直到胜利或死亡', description:'你已经走了这么远。不能回头。哪怕路早就变成了圆圈——也必须走下去。', nextScene:'ch6_r4a', effects:{ tags:['至死不渝者'], fate:3, memory:null } },
      { id:'ch6_r4_b', label:'寻求和平谈判', description:'战争已经吞噬了太多生命。是时候坐下来谈了——哪怕对方曾经想杀你。', nextScene:'ch6_r4b', effects:{ tags:['和平寻求者'], fate:1, memory:'停战协议' } },
      { id:'ch6_r4_c', label:'退回马孔多——做小金鱼', description:'你已经做完了你能做的一切。回家——做那条永远做不完的小金鱼。', nextScene:'ch6_r4c', effects:{ tags:['疲倦的归乡者'], fate:1, memory:'作坊里的金鱼', antiFate:true } }
    ...
    ch6_r4_settlement: { id:'ch6_r4_settlement', type:'settlement', chapter:6, round:4, title:'第四轮 · 结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['战争在继续——或结束了。但你已经不是最初那个人了。你的军装旧了，你的手上有老茧，你的眼睛里有某种永远不会再亮起来的东西。但你还活着——这本身就是一个奇迹。']}, settlement:{ summary:'第四轮完成。你面对了战争的无意义——选择了继续、和谈还是归乡。', nextScene:'ch6_r5_choice', nextLabel:'进入最终轮' } },
    ...
    ch6_r5_choice: { id:'ch6_r5_choice', type:'choice', chapter:6, round:5, title:'第五轮选择 · 权力的终局', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['战争终于结束了——真的结束了。你回到马孔多，把自己关在作坊里。你不接见任何人，不读信，不回答任何问题。你做一条小金鱼，卖掉——换来金币，然后把金币熔掉，重新做成金鱼。一个完美的循环。','有人来请你做总统——你拒绝了。有人来请你做将军——你拒绝了。有人来给你颁发勋章——你拒绝了。乌尔苏拉站在作坊门口："你在里面做什么？""做金鱼。"她转身走了——但她把一碗汤放在门口。'], transition:'你选择——' }, choices:[
      { id:'ch6_r5_a', label:'永远留在作坊里', description:'关上门。再不出去。让世界忘记你还活着——你也忘记世界还存在。', nextScene:'ch6_r5a', effects:{ tags:['永远的隐士'], fate:2, memory:'金鱼的永恒循环' } },
      { id:'ch6_r5_b', label:'偶尔出来——陪乌尔苏拉吃饭', description:'你不需要参与世界——但你需要陪母亲吃晚饭。这是你能做的最小的事。', nextScene:'ch6_r5b', effects:{ tags:['孝子'], fate:1, memory:null } },
      { id:'ch6_r5_c', label:'重新开始——以另一种方式', description:'战争结束了，但世界还在。走出作坊，用你的双手建一些东西——不是武器，不是金鱼。', nextScene:'ch6_r5c', effects:{ tags:['重生者'], fate:1, memory:'作坊外的阳光', antiFate:true } }
    ...
    ch6_r5_settlement: { id:'ch6_r5_settlement', type:'settlement', chapter:6, round:5, title:'第五轮 · 结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['战争结束了。你的战争，阿尔卡蒂奥的战争，这场把整个国家撕裂成两半的战争——都结束了。马孔多还在。栗树还在。作坊里的坩埚还在——你还在。这也许就够了。']}, settlement:{ summary:'最终轮完成。战争结束了——剩下的日子是循环、陪伴或重生。', nextScene:'chapter6_end', nextLabel:'查看章末结算' } },
    chapter6_end: { id:'chapter6_end', type:'settlement', chapter:6, round:6, title:'第六章 · 章末结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['第九章完结。你经历了战争的开始与结束，权力的诱惑与拒绝。从现在开始，马孔多的历史将翻开新的一页——一个没有枪声但同样残酷的篇章。']}, settlement:{ summary:'第六章完结。战争教会你权力最可怕的一面——它不会让你变成怪物，它只会让你不再认识自己。', isChapterEnd:true, nextLabel:'进入第七章 · 战争循环' } }
  },
  memories: {
...
registerChapter({
  ...
  scenes: {
    ...
    ch7_r1_choice: { id:'ch7_r1_choice', type:'choice', chapter:7, round:1, title:'第一轮选择 · 自杀未遂', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['你把枪口抵在自己胸口。不是因为害怕敌人——是因为你知道：战争已经变成了一个圆圈。你杀的人越多，你要保护的人就越少。你已经不记得你最初是为了什么而拿起枪的。','你的手指在扳机上。帐篷外——有人在喊你的名字。不是"上校"，是"奥雷里亚诺"。那个声音很老——你认得。是乌尔苏拉。但她在马孔多——你不该在这里听见她。也许你已经疯了。'], transition:'你选择——' }, choices:[
      { id:'ch7_r1_a', label:'放下枪——继续活着', description:'不是因为怕死——是因为你还欠乌尔苏拉一碗汤。至少活着回去喝掉它。', nextScene:'ch7_r1a', effects:{ tags:['幸存者'], fate:1, memory:null } },
      { id:'ch7_r1_b', label:'扣下扳机——结束一切', description:'你已经累了。让这个循环停止——哪怕不是以胜利的方式。', nextScene:'ch7_r1b', effects:{ tags:['自我毁灭者'], fate:3, memory:'枪口的硝烟' } },
      { id:'ch7_r1_c', label:'朝天开枪——释放信号', description:'不杀自己，也不继续战斗。朝天开一枪——让所有人都知道你在这里，然后就停下来了。', nextScene:'ch7_r1c', effects:{ tags:['宣言者'], fate:2, memory:'天空中的枪声' } }
    ...
    ch7_r1_settlement: { id:'ch7_r1_settlement', type:'settlement', chapter:7, round:1, title:'第一轮 · 结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['你活下来了——或以某种方式。你走出了帐篷。战争还在继续——但你的战争已经结束了。你把自己的左轮枪埋在了帐篷外的一棵树下。没有人知道那棵树的位置——除了你。']}, settlement:{ summary:'第一轮完成。你在循环的底部触摸了死亡。', nextScene:'ch7_r2_choice', nextLabel:'进入第二轮' } },
    ...
    ch7_r2_choice: { id:'ch7_r2_choice', type:'choice', chapter:7, round:2, title:'第二轮选择 · 十七个儿子', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['在战争期间，你和十七个女人生下了十七个儿子。不是爱——是一种更孤独的东西。她们来了又走——只有儿子们留下来了。你在每个儿子出生时寄去一封信，一封同样的信："你的父亲叫奥雷里亚诺·布恩迪亚上校。这不是你的幸运——是你的十字架。"','现在——你听说他们中有几个被暗杀了。不是因为战争——是因为他们姓布恩迪亚。有人在猎杀你的孩子们。'], transition:'你选择——' }, choices:[
      { id:'ch7_r2_a', label:'召集所有儿子——保护他们', description:'把他们全部叫到马孔多。在布恩迪亚家的庇护下——没有人能动他们。', nextScene:'ch7_r2a', effects:{ tags:['保护者父亲'], fate:2, memory:null } },
      { id:'ch7_r2_b', label:'让他们自己选择——不要来找你', description:'姓布恩迪亚已经够危险了——不要让这个姓氏变成他们的靶子。各自散去，各自保命。', nextScene:'ch7_r2b', effects:{ tags:['放手的父亲'], fate:1, memory:null } },
      { id:'ch7_r2_c', label:'追查凶手——为他们复仇', description:'你不等——你去找那些暗杀者。一个都不留。用你的方式。', nextScene:'ch7_r2c', effects:{ tags:['复仇的父亲'], fate:3, memory:'十七封信的灰烬' } }
    ...
    ch7_r2_settlement: { id:'ch7_r2_settlement', type:'settlement', chapter:7, round:2, title:'第二轮 · 结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['十七个儿子。十七个被暗杀的目标。他们因你的名字而生——因同一个名字而死。你没有办法阻止子弹——你只能决定子弹射来时，你是挡在前面还是已经转身不看。']}, settlement:{ summary:'第二轮完成。你的儿子们被猎杀——你做了你能做的。', nextScene:'ch7_r3_choice', nextLabel:'进入第三轮' } },
    ...
    ch7_r3_choice: { id:'ch7_r3_choice', type:'choice', chapter:7, round:3, title:'第三轮选择 · 勋章与拒绝', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['共和国总统派人送来一枚勋章——表彰你在战争中的贡献。金质的勋章在桌上闪闪发光。','你在作坊里做金鱼。你抬头看了一眼——然后继续做金鱼。使者等在门口，尴尬地端着那枚勋章。乌尔苏拉站在走廊上——她没有说话，但你在她眼睛里看见了一种你不需要翻译的语言。'], transition:'你选择——' }, choices:[
      { id:'ch7_r3_a', label:'拒绝勋章——让他拿回去', description:'你不是为了勋章才打仗的。让使者带着它回去——告诉总统他误解了一切。', nextScene:'ch7_r3a', effects:{ tags:['拒绝荣誉者'], fate:1, memory:null, antiFate:true } },
      { id:'ch7_r3_b', label:'接受——但转送给阵亡将士家属', description:'这勋章不是你的——是那些回不来的人的。把它融掉，换成金币分给他们的家人。', nextScene:'ch7_r3b', effects:{ tags:['转赠者'], fate:1, memory:null } },
      { id:'ch7_r3_c', label:'接受——把它放在蕾梅黛丝墓前', description:'你唯一想领受的荣誉——是让她看见。哪怕她在另一个世界。', nextScene:'ch7_r3c', effects:{ tags:['永恒的爱人'], fate:2, memory:'墓前的勋章' } }
    ...
    ch7_r3_settlement: { id:'ch7_r3_settlement', type:'settlement', chapter:7, round:3, title:'第三轮 · 结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['勋章被你以某种方式处理了。总统不会理解你为什么拒绝——他永远不会。但马孔多的人会——因为他们知道你从来不是为了勋章才出征的。']}, settlement:{ summary:'第三轮完成。你面对了荣誉——选择接受、转赠或拒绝。', nextScene:'ch7_r4_choice', nextLabel:'进入第四轮' } },
    ...
    ch7_r4_choice: { id:'ch7_r4_choice', type:'choice', chapter:7, round:4, title:'第四轮选择 · 回归与空虚', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['战争结束了——这一次真的结束了。停战协议签了，军队解散了，将军们各回各家。你回到马孔多，推开作坊的门。灰尘。坩埚已经冷了——你的金鱼还在里面，但已经氧化变黑了。','你在作坊里站了很久。你不知道你还能做什么——你已经做了所有的事。战争、爱情、死亡、权力——你都经历过了。现在只剩下一件事：等死。但这也许不是唯一的选择。'], transition:'你选择——' }, choices:[
      { id:'ch7_r4_a', label:'继续做金鱼——让它成为你的修行', description:'金鱼不是逃避——是修行。在重复中寻找平静。把剩下的日子变成一件一件的小金鱼。', nextScene:'ch7_r4a', effects:{ tags:['工匠'], fate:1, memory:null } },
      { id:'ch7_r4_b', label:'写回忆录', description:'把你的经历写下来。不是为了出版——是为了记住。让后人知道这场战争到底是怎么回事。', nextScene:'ch7_r4b', effects:{ tags:['记录者'], fate:1, memory:'未完成的回忆录' } },
      { id:'ch7_r4_c', label:'帮助重建马孔多', description:'不要整天关在作坊里。走出去——帮村里人修房子、挖水渠、教孩子们识字。用你的双手做有用的事。', nextScene:'ch7_r4c', effects:{ tags:['重建者'], fate:1, memory:null, antiFate:true } }
    ...
    ch7_r4_settlement: { id:'ch7_r4_settlement', type:'settlement', chapter:7, round:4, title:'第四轮 · 结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['你回到了马孔多——不是以上校的身份，是以一个疲倦的人的身份。栗树还在。乌尔苏拉还在。作坊还在。你还在——这本身就是一个你从来没有料到的结局。']}, settlement:{ summary:'第四轮完成。战后余生——你选择了如何度过。', nextScene:'ch7_r5_choice', nextLabel:'进入最终轮' } },
    ...
    ch7_r5_choice: { id:'ch7_r5_choice', type:'choice', chapter:7, round:5, title:'第五轮选择 · 死亡的到来', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['你在作坊里做金鱼。手已经老了，手指不太听使唤了——金鱼做得越来越小，越来越简单。你听见心脏在胸腔里跳动——它跳得很慢，像是在数着什么。','你知道这一天会来。你从来不害怕它——你只是不确定：当你闭眼的时候，你会在脑海里看见什么？是冰块？是糖苹果？是行刑队的墙？还是乌尔苏拉站在门口把一双筷子放在空位上的样子？'], transition:'你选择——' }, choices:[
      { id:'ch7_r5_a', label:'在作坊里安静离世', description:'不需要大张旗鼓。坐在你熟悉的坩埚前，做完最后一条金鱼，然后闭上眼睛。', nextScene:'ch7_r5a', effects:{ tags:['安详的终结'], fate:2, memory:'最后一条金鱼' } },
      { id:'ch7_r5_b', label:'走到栗树下——和父亲一起等死', description:'你已经很久没有和父亲说话了。走到栗树下，解开他的绳子——让他知道你也来了。', nextScene:'ch7_r5b', effects:{ tags:['回归的儿子'], fate:2, memory:'栗树下的重逢' } },
      { id:'ch7_r5_c', label:'坐在饭桌前——等乌尔苏拉摆碗筷', description:'死在哪里都可以——但你希望在走之前，再喝一碗她的汤。', nextScene:'ch7_r5c', effects:{ tags:['感恩的告别'], fate:1, memory:'最后一碗汤' } }
...
registerChapter({
  ...
  scenes: {
    ...
    ch8_r1_choice: { id:'ch8_r1_choice', type:'choice', chapter:8, round:1, title:'第一轮选择 · 迎接巨人', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['何塞·阿尔卡蒂奥坐在客厅里——那张椅子在他身下吱吱作响。他的身上刺满了纹身——每一幅都是一个国家的地图。他讲起他在海上的经历：与日本水手打架，用牙咬断桅杆绳，在六十多个国家的码头上醉过酒。','乌尔苏拉站在厨房门口——她认出了儿子，但她不敢上前。因为这个儿子离开的时候是个孩子，回来的时候是个陌生男人——一个身体比门还宽、声音比鼓还沉的男人。'], transition:'你选择——' }, choices:[
      { id:'ch8_r1_a', label:'张开双臂欢迎他', description:'他是布恩迪亚——不管走多远，他永远是这个家的人。', nextScene:'ch8_r1a', effects:{ tags:['欢迎的拥抱'], fate:1, memory:null } },
      { id:'ch8_r1_b', label:'警惕——问清楚他为什么回来', description:'他走了这么多年，为什么现在回来？他身上有太多你不认识的纹身。', nextScene:'ch8_r1b', effects:{ tags:['审慎的家属'], fate:1, memory:null } },
      { id:'ch8_r1_c', label:'让他自己找到回家的路', description:'不急着上前。给他时间——让他自己走进这所房子，就像那个下午他跟着吉卜赛人走时一样。', nextScene:'ch8_r1c', effects:{ tags:['沉默的接纳者'], fate:1, memory:'门廊上的等待' } }
    ...
    ch8_r1_settlement: { id:'ch8_r1_settlement', type:'settlement', chapter:8, round:1, title:'第一轮 · 结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['何塞·阿尔卡蒂奥回来了。布恩迪亚家的院子再次被巨人的身影填满。他将住在这里，带来风暴——以他自己的方式。']}, settlement:{ summary:'第一轮完成。巨人回家了。', nextScene:'ch8_r2_choice', nextLabel:'进入第二轮' } },
    ...
    ch8_r2_choice: { id:'ch8_r2_choice', type:'choice', chapter:8, round:2, title:'第二轮选择 · 美人儿蕾梅黛丝', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['美人儿蕾梅黛丝——家族第四代的美人——这天下午站在院子里晾她的床单。风很大——床单在她手里鼓起来，像一面白色的帆。她仰起头——阳光穿过床单洒在她身上，把她染成半透明的白色。','但她不穿衣服。不是故意的——是她不在乎。她觉得衣服是这世界上最没有意义的东西——和名字一样没意义。她的美丽是一种危险的美丽——危险到每一个看过她的男人都会在接下来的很长一段时间里无法看别的女人。'], transition:'你选择——' }, choices:[
      { id:'ch8_r2_a', label:'保护她——把她藏在家里', description:'她的美貌是危险的。不让外人看到她——把她留在家里，确保她的安全。', nextScene:'ch8_r2a', effects:{ tags:['过度保护者'], fate:1, memory:null } },
      { id:'ch8_r2_b', label:'让她自由——不要限制她', description:'她的美是她的——不是你的，不是任何人的。让她做她自己想做的事。', nextScene:'ch8_r2b', effects:{ tags:['自由主义者'], fate:1, memory:null, antiFate:true } },
      { id:'ch8_r2_c', label:'教她应对这个世界', description:'她需要知道外面的人会怎么看她。不是要改变她——是要让她有准备。', nextScene:'ch8_r2c', effects:{ tags:['引导者'], fate:1, memory:'床单与风' } }
    ...
    ch8_r2_settlement: { id:'ch8_r2_settlement', type:'settlement', chapter:8, round:2, title:'第二轮 · 结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['美人儿蕾梅黛丝继续她的生活——以只有她能理解的方式。她的美不是武器，不是工具，不是礼物——它只是一种存在。像一个没有答案的问题。']}, settlement:{ summary:'第二轮完成。你面对了家族中最纯粹的美丽。', nextScene:'ch8_r3_choice', nextLabel:'进入第三轮' } },
    ...
    ch8_r3_choice: { id:'ch8_r3_choice', type:'choice', chapter:8, round:3, title:'第三轮选择 · 升天', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['一个普通的下午。美人儿蕾梅黛丝在院子里收床单。风突然大了起来——床单鼓胀起来，拉着她的手往上升。她没有松手。她也没有叫——她只是仰起头看着天空，看着那片白色的布在她手中变成了一对翅膀。','她升起来了。不是很快——是缓缓地，像一片被热气流托起的羽毛。她越升越高——超过了晾衣绳，超过了房顶，超过了栗树，超过了马孔多最高的教堂尖顶。她没有回头——不是因为她不想，是因为她的眼睛一直在看上面。'], transition:'你选择——' }, choices:[
      { id:'ch8_r3_a', label:'伸手抓住她', description:'你不能让她就这样走了。跳起来——抓住她的脚踝，把她拉回来。', nextScene:'ch8_r3a', effects:{ tags:['试图挽留者'], fate:2, memory:null } },
      { id:'ch8_r3_b', label:'目送她升天——不要打扰', description:'这是她的离开方式。不是死亡——是离开。你不能碰——只能看。', nextScene:'ch8_r3b', effects:{ tags:['目送者'], fate:2, memory:'升天的床单' } },
      { id:'ch8_r3_c', label:'闭上眼睛——然后记住', description:'你不看——但你记住了。把这一刻刻在脑海里——让它成为永不褪色的东西。', nextScene:'ch8_r3c', effects:{ tags:['内心的铭记者'], fate:1, memory:'闭眼看见的光' } }
    ...
    ch8_r4_choice: { id:'ch8_r4_choice', type:'choice', chapter:8, round:4, title:'第四轮选择 · 何塞·阿尔卡蒂奥的死亡', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['何塞·阿尔卡蒂奥死了。不是死在海上——是死在自己的房子里。枪声在午后响起——不大，像一扇门被风猛地关上。没有人知道是谁开的枪，没有人知道为什么。','他的血从门缝里流出来——沿着走廊的地砖一直流到院子里，流到栗树下他父亲还在画圆圈的地方。老人低头看了看血，然后继续画圆圈——他以为那是雨水。'], transition:'你选择——' }, choices:[
      { id:'ch8_r4_a', label:'追查凶手', description:'不能让他就这样不明不白地死了。找出真相——用你的方式。', nextScene:'ch8_r4a', effects:{ tags:['追查者'], fate:2, memory:null } },
      { id:'ch8_r4_b', label:'安葬他——让他的死成为一个秘密', description:'也许有些秘密不该被揭开。安葬他——让他像他活着时一样，安安静静地离开。', nextScene:'ch8_r4b', effects:{ tags:['沉默的送葬者'], fate:1, memory:null } },
      { id:'ch8_r4_c', label:'把房子锁起来——不去触碰', description:'把门锁上。让房子里的一切保持原样——让时间在那里停止。', nextScene:'ch8_r4c', effects:{ tags:['封存者'], fate:1, memory:'锁上的房门' } }
    ...
    ch8_r4_settlement: { id:'ch8_r4_settlement', type:'settlement', chapter:8, round:4, title:'第四轮 · 结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['巨人倒下了。栗树下多了一座土堆。马孔多的地平线上少了一个过于高大的身影——但他的故事会被人反复讲述：讲他如何在海上用牙咬断桅杆绳，如何在码头上醉倒，如何在回家的那天弯下腰来看着父亲的画在泥土中的圆圈。']}, settlement:{ summary:'第四轮完成。何塞·阿尔卡蒂奥死了——你选择了如何面对他的死亡。', nextScene:'ch8_r5_choice', nextLabel:'进入最终轮' } },
    ...
    ch8_r5_choice: { id:'ch8_r5_choice', type:'choice', chapter:8, round:5, title:'第五轮选择 · 家族的新篇章', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['巨人不在了。美人也不在了。栗树下的老人还在画圆圈。但家里有了新的面孔——奥雷里亚诺第二和他的双胞胎兄弟何塞·阿尔卡蒂奥第二。两个孩子长得一模一样——连乌尔苏拉都分不清。','家族进入了一个新的时代——一个充满狂欢、盛宴和生育的时代。马孔多也在变化——铁路修过来了，外国人来了，香蕉公司来了。一切都好像在加速——像一辆刹车坏了的火车。'], transition:'你选择——' }, choices:[
      { id:'ch8_r5_a', label:'投身家族狂欢', description:'开派对！把房子开放给所有人。用盛宴和舞蹈填满每一个房间——生命太短了。', nextScene:'ch8_r5a', effects:{ tags:['狂欢者'], fate:1, memory:null } },
      { id:'ch8_r5_b', label:'保持清醒——为风暴做准备', description:'狂欢是假的。你感觉到了——一场巨大的风暴正在靠近。为家人做好准备。', nextScene:'ch8_r5b', effects:{ tags:['未雨绸缪者'], fate:2, memory:null } },
      { id:'ch8_r5_c', label:'记录——写下家族的历史', description:'这个家族有太多故事了。如果不写下来——它们会像美人儿一样升天，再也回不来。', nextScene:'ch8_r5c', effects:{ tags:['家族史官'], fate:1, memory:'家族编年史' } }
    ...
    ch8_r5_settlement: { id:'ch8_r5_settlement', type:'settlement', chapter:8, round:5, title:'第五轮 · 结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['时代在变。马孔多不再是一个只有二十多间泥巴房的小村子——它正在变成一座城镇。铁路伸进来，蒸汽机在河对岸喷着白烟。布恩迪亚家也在变——旧的面孔离去，新的面孔出现。这是一个新的开始——也是新的终结的开始。']}, settlement:{ summary:'最终轮完成。家族翻开了新的篇章。', nextScene:'chapter8_end', nextLabel:'查看章末结算' } },
    chapter8_end: { id:'chapter8_end', type:'settlement', chapter:8, round:6, title:'第八章 · 章末结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['第八章完结。巨人走了，美人升天了，家族进入了狂欢的年代。但狂欢之下——有什么东西正在悄悄腐烂。','下一章：面具、假面舞会和一场将永远改变马孔多的屠杀。']}, settlement:{ summary:'第八章完结。你见证了一个时代的结束和另一个时代的开始。', isChapterEnd:true, nextLabel:'进入第九章 · 狂欢节屠杀' } }
  },
  memories: {
...
registerChapter({
  ...
  scenes: {
    ...
    ch9_r1_choice: { id:'ch9_r1_choice', type:'choice', chapter:9, round:1, title:'第一轮选择 · 费尔南达', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['费尔南达——从遥远的省城来的女孩，带着皇后一样的气质和一个家族使命。她从小被教导：她是女王。但现在她站在马孔多的狂欢节上——穿着旧裙子，脸上的妆已经被汗水融化了一半。','奥雷里亚诺第二看见了她。他停住了——手里的酒杯差点掉了。"我要娶她。"他说。没有人知道他是不是认真的——他总是在笑。但这一次他没有笑。'], transition:'你选择——' }, choices:[
      { id:'ch9_r1_a', label:'支持他——追求费尔南达', description:'奥雷里亚诺第二需要安定下来。费尔南达也许就是这个家的定海神针。', nextScene:'ch9_r1a', effects:{ tags:['支持者'], fate:1, memory:null } },
      { id:'ch9_r1_b', label:'警告他——她不合适', description:'费尔南达带着太多规则和"必须"。她不会融入布恩迪亚家——她会试图改造它。', nextScene:'ch9_r1b', effects:{ tags:['警告者'], fate:2, memory:null } },
      { id:'ch9_r1_c', label:'不干涉——让他自己决定', description:'布恩迪亚家的人从不听劝。让他自己走这条路——无论它通向哪里。', nextScene:'ch9_r1c', effects:{ tags:['沉默的旁观者'], fate:1, memory:null } }
    ...
    ch9_r1_settlement: { id:'ch9_r1_settlement', type:'settlement', chapter:9, round:1, title:'第一轮 · 结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['费尔南达进入了布恩迪亚家——带着她的行李箱，她的祈祷书，和她不愿意放弃的皇后身份。她走进这所房子的时候，抬头看了看天花板——然后皱了一下眉。她不喜欢这里。但她无处可去。']}, settlement:{ summary:'第一轮完成。费尔南达走进了布恩迪亚家。', nextScene:'ch9_r2_choice', nextLabel:'进入第二轮' } },
    ...
    ch9_r2_choice: { id:'ch9_r2_choice', type:'choice', chapter:9, round:2, title:'第二轮选择 · 狂欢节的悲剧', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['狂欢节到了高潮。人们摘下假面，互相拥抱——以为今天之后，一切都会不一样。但枪响了。不是一支枪——是很多支。士兵从各个方向涌进广场——不是来庆祝，是来清场。','政府说狂欢节上藏了"叛乱分子"——但被杀的人手里握着的是彩带，不是枪。血混在纸花里，被踩成浆糊。你在人群中——你身边有一个抱着孩子的女人倒下去了。她的孩子在哭——但你拉不动她。'], transition:'你选择——' }, choices:[
      { id:'ch9_r2_a', label:'救人——拉上尽可能多的人逃走', description:'你不能救所有人——但你可以救身边的每一个。抓住每一个你能触碰的人，带他们离开。', nextScene:'ch9_r2a', effects:{ tags:['拯救者'], fate:1, memory:null } },
      { id:'ch9_r2_b', label:'面对士兵——试图阻止屠杀', description:'你是布恩迪亚。你的名字在马孔多还有分量。站在士兵面前——让他们停下来。', nextScene:'ch9_r2b', effects:{ tags:['对峙者'], fate:2, memory:null } },
      { id:'ch9_r2_c', label:'躲起来——活下去', description:'这不是你的战争。这不是任何人的战争。这是屠杀。活下去——为了以后记得。', nextScene:'ch9_r2c', effects:{ tags:['幸存者'], fate:1, memory:'狂欢节的枪声' } }
    ...
    ch9_r2_settlement: { id:'ch9_r2_settlement', type:'settlement', chapter:9, round:2, title:'第二轮 · 结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['狂欢节变成了一场屠杀。多少人在纸花和彩带之间倒下了——数字没有人知道。政府把尸体搬上火车，运走了。第二天马孔多的广场被水冲洗干净——但纸花的碎片还粘在墙缝里。阳光照在湿漉漉的石子上——看起来像眼泪。']}, settlement:{ summary:'第二轮完成。你经历了马孔多历史上第一次大屠杀。', nextScene:'ch9_r3_choice', nextLabel:'进入第三轮' } },
    ...
    ch9_r3_choice: { id:'ch9_r3_choice', type:'choice', chapter:9, round:3, title:'第三轮选择 · 费尔南达的家规', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['费尔南达开始实施她的规则。窗帘必须拉上——"阳光会弄脏家具。"吃饭时必须用刀叉——不能用手。说话声音必须放低——"布恩迪亚家不是市集。"走廊里不能奔跑——不能打赤脚——不能在客厅里做爱。','奥雷里亚诺第二的胃口没有了。不是因为吃不下——是因为每次吃饭她都要念一段祷词。他等不及阿门就伸手去抓面包——她拍他的手。整个家开始像一个被慢慢勒紧的拳头。'], transition:'你选择——' }, choices:[
      { id:'ch9_r3_a', label:'抵制——维护布恩迪亚的自由', description:'这个家从来不需要规则。站在奥雷里亚诺第二一边——抵抗费尔南达的统治。', nextScene:'ch9_r3a', effects:{ tags:['抵抗者'], fate:2, memory:null } },
      { id:'ch9_r3_b', label:'妥协——给她一些空间', description:'也许这个家确实需要一些秩序。和费尔南达谈谈——找到中间地带。', nextScene:'ch9_r3b', effects:{ tags:['妥协者'], fate:1, memory:null } },
      { id:'ch9_r3_c', label:'搬出去——离开这个家', description:'你不需要忍受这个。收拾东西，搬到别处去——让费尔南达统治一个空房子。', nextScene:'ch9_r3c', effects:{ tags:['出走者'], fate:2, memory:'空荡的走廊', antiFate:true } }
    ...
    ch9_r3_settlement: { id:'ch9_r3_settlement', type:'settlement', chapter:9, round:3, title:'第三轮 · 结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['费尔南达的统治开始了——或退让了。布恩迪亚家不再是以前那个所有门窗都敞开的地方了。有些房间被锁上了，有些声音被压低了。但家还在——只是变得更像一座快要封顶的教堂了。']}, settlement:{ summary:'第三轮完成。你面对了费尔南达对这个家的改造。', nextScene:'ch9_r4_choice', nextLabel:'进入第四轮' } },
    ...
    ch9_r4_choice: { id:'ch9_r4_choice', type:'choice', chapter:9, round:4, title:'第四轮选择 · 奥雷里亚诺第二的逃离', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['奥雷里亚诺第二不再回家了。他住在佩特拉·科特斯家里——他的情妇那里。他的胃口回来了——他每天吃三头牛，喝整桶的酒。他的笑声又响起来了——在费尔南达听不到的地方。','但他不是为了佩特拉才不回家的。他是为了躲避那个说话像念祷告、走路像仪仗队的女人。他从来不承认他怕她——但他每次回家都只待到自己能忍耐的最后一秒。'], transition:'你选择——' }, choices:[
      { id:'ch9_r4_a', label:'劝他回家——挽回婚姻', description:'费尔南达也许不是最好的——但她是他的妻子。家庭需要他回去。', nextScene:'ch9_r4a', effects:{ tags:['劝和者'], fate:1, memory:null } },
      { id:'ch9_r4_b', label:'支持他——留在情妇身边', description:'他在佩特拉那里才真正活着。让他待在能让他笑的地方。', nextScene:'ch9_r4b', effects:{ tags:['自由的支持者'], fate:1, memory:null, antiFate:true } },
      { id:'ch9_r4_c', label:'不评判——让他自己选择', description:'婚姻是两个人的事——你不是第三个人。让他自己决定在哪张床上醒来。', nextScene:'ch9_r4c', effects:{ tags:['中立者'], fate:1, memory:null } }
    ...
    ch9_r5_choice: { id:'ch9_r5_choice', type:'choice', chapter:9, round:5, title:'第五轮选择 · 面具之下', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['狂欢节结束了。面具被收进了阁楼——但面具之下的伤口还在。马孔多再也没有举办过狂欢节。广场上的纸花碎片被风吹走——或被蚂蚁拖进巢穴里。','你坐在走廊上，看着夕阳把栗树的影子一寸一寸拉长。你想起那天晚上的枪声——想起你救下的人，你没能救下的人，你面对的那个年轻军官。你问自己：这一切到底是为了什么？但没有人回答。只有风吹过走廊——带着远处香蕉公司蒸汽机的轰鸣。'], transition:'你选择——' }, choices:[
      { id:'ch9_r5_a', label:'记住——发誓不忘记', description:'在栗树下挖一个坑，埋进一件狂欢节的东西——让它永远提醒你。', nextScene:'ch9_r5a', effects:{ tags:['记忆的守护者'], fate:2, memory:'埋藏的假面' } },
      { id:'ch9_r5_b', label:'放手——继续生活', description:'人不能永远活在过去的阴影里。把狂欢节的事放在一边——继续往前走。', nextScene:'ch9_r5b', effects:{ tags:['前行者'], fate:1, memory:null, antiFate:true } },
      { id:'ch9_r5_c', label:'化作行动——对抗不公', description:'你不只会记住——你会行动。加入那些正在对抗香蕉公司的人。让记忆变成力量。', nextScene:'ch9_r5c', effects:{ tags:['行动者'], fate:2, memory:null } }
...
registerChapter({
  ...
  scenes: {
    ...
    ch10_r1_choice: { id:'ch10_r1_choice', type:'choice', chapter:10, round:1, title:'第一轮选择 · 罢工前夜', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['你在工人宿舍的门廊上。夜很热——香蕉皮在没有排水沟的街道上发酵。工人睡在铁皮搭成的铺位上——身上长着脓疮，没有人看医生。','明天——工人要罢工了。他们要求厕所、医疗、现金工资。香蕉公司的回答——你还没有听到，但你预感不会是一个"是"。'], transition:'你选择——' }, choices:[
      { id:'ch10_r1_a', label:'领导罢工', description:'你是布恩迪亚——你必须站在他们前面。组织工人，带领他们走上街头。', nextScene:'ch10_r1a', effects:{ tags:['罢工领袖'], fate:3, memory:null } },
      { id:'ch10_r1_b', label:'支持——但在幕后', description:'你可以帮忙写标语、筹钱、联系其他地方。但你不必站在最前面——你的位置应该在策略桌上。', nextScene:'ch10_r1b', effects:{ tags:['幕后支持者'], fate:1, memory:null } },
      { id:'ch10_r1_c', label:'劝阻——暴力即将来临', description:'你预感到这场罢工会以血收场。劝工人们通过谈判争取——而不是走上街头。', nextScene:'ch10_r1c', effects:{ tags:['谨慎的预警者'], fate:1, memory:null, antiFate:true } }
    ...
    ch10_r1_settlement: { id:'ch10_r1_settlement', type:'settlement', chapter:10, round:1, title:'第一轮 · 结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['罢工开始了。三千多工人——加上他们的妻儿——聚集在火车站前的广场上。他们手上没有枪，但手里有标语。他们以为话语能保护他们。但话语是打不过子弹的。']}, settlement:{ summary:'第一轮完成。罢工已经开始——你选择了自己的位置。', nextScene:'ch10_r2_choice', nextLabel:'进入第二轮' } },
    ...
    ch10_r2_choice: { id:'ch10_r2_choice', type:'choice', chapter:10, round:2, title:'第二轮选择 · 三千人屠杀', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['军队包围了火车站——不是一小支，是整个营。一个军官站在高处宣读一份公告：五分钟内撤离——否则开火。','五分钟到了。没有人离开。工人手挽着手——他们不相信士兵会开枪。可你不确定。你在人群中——你看见了士兵们脸上的表情：不是愤怒，是恐惧。他们在害怕——害怕的人最容易扣下扳机。','你看见了机枪。不止一挺——是三挺，分别架在三个制高点上。'], transition:'你选择——' }, choices:[
      { id:'ch10_r2_a', label:'大喊——让大家趴下', description:'枪要响了——你能感觉到。用最大的声音喊出来——哪怕只能救一个人。', nextScene:'ch10_r2a', effects:{ tags:['最后的呐喊者'], fate:2, memory:null } },
      { id:'ch10_r2_b', label:'冲上去——面对军官', description:'你是布恩迪亚——也许你的名字还能让一个军官犹豫几秒。冲上去——面对他。', nextScene:'ch10_r2b', effects:{ tags:['对峙者'], fate:3, memory:null } },
      { id:'ch10_r2_c', label:'保护身边的人——用自己的身体挡住', description:'你身边有一个带着孩子的母亲。你用身体挡住他们——也许子弹不会穿透你的身体。', nextScene:'ch10_r2c', effects:{ tags:['牺牲者'], fate:2, memory:'三千人的名字' } }
    ...
    ch10_r3_choice: { id:'ch10_r3_choice', type:'choice', chapter:10, round:3, title:'第三轮选择 · 活着的证词', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['你活下来了——不知道是怎么活下来的。你从尸体堆里爬出来的时候，天已经黑了。火车站前空无一人——只有血。月光照在血上——让它看起来像黑色的水。','你走回马孔多——浑身是血。你敲开第一扇门——告诉他们：三千人死了。他们看着你——像看一个疯子。"别胡说——什么都没发生。"你敲开第二扇门——同样的反应。第三扇——第四扇——全马孔多的人都告诉你：你在做梦。'], transition:'你选择——' }, choices:[
      { id:'ch10_r3_a', label:'继续讲述——直到有人相信', description:'你不能让这场屠杀被遗忘。继续敲每一扇门——直到有一个人说："我相信你。"', nextScene:'ch10_r3a', effects:{ tags:['不倦的见证者'], fate:2, memory:null } },
      { id:'ch10_r3_b', label:'写下记录——藏起来', description:'你不求和活人争辩。你写下来——把真相藏在羊皮卷里，等将来的人发现。', nextScene:'ch10_r3b', effects:{ tags:['秘密记录者'], fate:1, memory:'被藏起的真相' } },
      { id:'ch10_r3_c', label:'停止讲述——用沉默纪念', description:'也许有些真相无法用语言传达。你不再说——但你在心里刻下了三千个名字。', nextScene:'ch10_r3c', effects:{ tags:['沉默的铭记者'], fate:1, memory:'刻在心里的名单' } }
    ...
    ch10_r4_choice: { id:'ch10_r4_choice', type:'choice', chapter:10, round:4, title:'第四轮选择 · 与遗忘对抗', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['香蕉公司撤走了——工人的尸体已经被鲨鱼吃掉。铁路被拆了，工棚被烧了，铁丝网被拆走了。河对岸重新变成了荒地——仿佛什么都没有发生过。','政府宣传说马孔多从来没有香蕉公司。年轻人相信了——因为他们没有见过。只有老人还记得——但他们正在一个接一个地死去。每一个老人的死，都是真相的一次缩小。'], transition:'你选择——' }, choices:[
      { id:'ch10_r4_a', label:'教年轻人——告诉他们真相', description:'不要让下一代活在他们编造的谎言里。把你知道的一切都教给年轻人。', nextScene:'ch10_r4a', effects:{ tags:['传道者'], fate:1, memory:null } },
      { id:'ch10_r4_b', label:'建一座纪念碑——哪怕私人的', description:'在你的院子里立一块石头——上面刻着"三千"。不需要解释——只需要存在。', nextScene:'ch10_r4b', effects:{ tags:['纪念碑建造者'], fate:1, memory:'院子里的石头' } },
      { id:'ch10_r4_c', label:'闭上嘴——保护自己', description:'你是唯一知道真相的人了。如果你死了——真相就真的死了。活下去——哪怕这意味着沉默。', nextScene:'ch10_r4c', effects:{ tags:['沉默的保护者'], fate:2, memory:null } }
    ...
    ch10_r4_settlement: { id:'ch10_r4_settlement', type:'settlement', chapter:10, round:4, title:'第四轮 · 结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['遗忘像潮水一样淹没了马孔多。但海浪下有一块石头——刻着三千。它不会漂浮，但它也不会被冲走。']}, settlement:{ summary:'第四轮完成。你选择了对抗遗忘的方式。', nextScene:'ch10_r5_choice', nextLabel:'进入最终轮' } },
    ...
    ch10_r5_choice: { id:'ch10_r5_choice', type:'choice', chapter:10, round:5, title:'第五轮选择 · 最后的见证', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['你很老了。你坐在梅尔基亚德斯的旧房间里——这间房间的时间不会流逝。你看着书架上那些羊皮卷——它们记录着这个家族的全部历史。你忽然想：也许这些羊皮卷里也有三千人的名字。也许没有。也许梅尔基亚德斯没有写到他们——因为他们不在布恩迪亚家的谱系里。','但你知道。你还活着——至少现在。你是三千人被遗忘的唯一阻止。当你也走了——他们就真的消失了。'], transition:'你选择——' }, choices:[
      { id:'ch10_r5_a', label:'把名字写进羊皮卷', description:'在梅尔基亚德斯的羊皮卷边缘，偷偷写下三千人的数字。让它成为家族记录的一部分。', nextScene:'ch10_r5a', effects:{ tags:['篡改者'], fate:2, memory:'羊皮卷边缘的数字' } },
      { id:'ch10_r5_b', label:'在死亡前——最后讲述一次', description:'把你的故事讲给最后一个人——也许是你家族的某个人，也许是风。', nextScene:'ch10_r5b', effects:{ tags:['最后的讲述者'], fate:1, memory:null } },
      { id:'ch10_r5_c', label:'安静等待——让历史自己说话', description:'你已经做了够多了。也许历史不需要被见证——也许只需要它自己知道它发生过。', nextScene:'ch10_r5c', effects:{ tags:['安详的告别者'], fate:1, memory:null } }
