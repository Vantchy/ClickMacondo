...
registerChapter({
  ...
  scenes: {
    ...
    ch5_r2_choice: { id:'ch5_r2_choice', type:'choice', chapter:5, round:2, title:'第二轮选择 · 战争来到马孔多', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['战争来了。不是以军队的形式——是以一封信的形式。信上写着：自由党在首都起义了，保守党正在各地搜捕"叛乱分子"。你的朋友——那个教你看星星的医生——被列在名单上。','士兵已经进入了马孔多。他们在大街上列队，枪上的刺刀在午后阳光下闪闪发光。他们把镇长的办公室改成了指挥部。有一个年轻军官正盯着布恩迪亚家的方向——他知道你的名字。'], transition:'你选择——' }, choices:[
      { id:'ch5_r2_a', label:'拿起武器加入自由党', description:'你不能坐视朋友被捕。从实验室里拿出武器——战斗从今天开始。', nextScene:'ch5_r2a', effects:{ tags:['革命者'], fate:3, memory:null } },
      { id:'ch5_r2_b', label:'保护家人——保持中立', description:'战争是别人的事。你的责任是守住这所房子，守住乌尔苏拉和孩子们。', nextScene:'ch5_r2b', effects:{ tags:['家族堡垒'], fate:1, memory:null } },
      { id:'ch5_r2_c', label:'试图与两边谈判', description:'也许避免流血的唯一方法是对话。去找军官和自由党人——用你的影响力斡旋。', nextScene:'ch5_r2c', effects:{ tags:['和平使者'], fate:2, memory:'谈判桌的空椅子' } }
    ...
    ch5_r3_choice: { id:'ch5_r3_choice', type:'choice', chapter:5, round:3, title:'第三轮选择 · 蕾梅黛丝之死', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['你不在家。你在前线——指挥第一场战役。然后信来了。乌尔苏拉只写了三个字："她走了。"','蕾梅黛丝死了。不是因为战争——是因为意外。她从楼梯上摔下来，怀着你未出生的孩子。她死的时候十四岁。你还记得她九岁时举着糖苹果的样子——那只蜜蜂绕着糖壳飞，她的嘴忘了咬。现在那个嘴巴永远不会咬了。那些苹果永远不会被吃完了。'], transition:'你选择——' }, choices:[
      { id:'ch5_r3_a', label:'回家——守在她墓前', description:'战争可以等。蕾梅黛丝不能等——你已经错过了她最后一面，至少不要错过告别。', nextScene:'ch5_r3a', effects:{ tags:['悲痛的丈夫'], fate:2, memory:'糖苹果与墓石' } },
      { id:'ch5_r3_b', label:'留在前线——用战争麻痹自己', description:'回家没有意义——她不在那里了。留在战场上，让自己被硝烟吞没。', nextScene:'ch5_r3b', effects:{ tags:['逃避者'], fate:3, memory:null } },
      { id:'ch5_r3_c', label:'写一封信——然后继续战斗', description:'你不能回去，但也不能沉默。写一封信给乌尔苏拉——告诉她蕾梅黛丝的名字不会被忘记。', nextScene:'ch5_r3c', effects:{ tags:['沉默的纪念者'], fate:2, memory:'写给亡妻的信' } }
