...
registerChapter({
  ...
  scenes: {
    ...
    ch3_r1_settlement: { id:'ch3_r1_settlement', type:'settlement', chapter:3, round:1, title:'第一轮 · 结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['丽贝卡开始慢慢习惯这个家。她不再只是角落里的影子——但她的骨灰盒还在床底下，而她的手指，偶尔还会在半夜伸向墙角的泥土。']}, settlement:{ summary:'第一轮选择完成。你选择了如何面对丽贝卡的秘密。', nextScene:'ch3_r2_choice', nextLabel:'进入第二轮', quadrantNarratives:{
          guardian:'家变大了——墙变多了，但你知道每一扇门后面都有人在呼吸。',
          prophet:'你建了暗室——一扇只有你知道的门。在所有人中间，你仍然是独自一人。',
          follower:'你放下锤子，拿起面包——有时候建造一个家不是用砖，是用一块面包和一碗汤。',
          rebel:'你反对扩建——房子已经够大了。但家族不听你的。就像河流不听堤岸一样。'
        } } },
    ...
    ch3_r2_choice: { id:'ch3_r2_choice', type:'choice', chapter:3, round:2, title:'第二轮选择 · 失眠症的第二次侵袭', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['失眠症又回来了。你已经三天没有合眼了。闭上眼睛的时候，脑子里就开始播放回忆的碎片。','村民们开始在墙上写下越来越多的标签。乌尔苏拉说："再这样下去，我们会在醒来的时候忘记自己是谁。"'], transition:'你选择——' }, choices:[
      { id:'ch3_r2_a', label:'发明绳结记事', description:'用绳子打结来代表每天发生的事。每个结都是一段记忆——看得见，摸得着。', nextScene:'ch3_r2a', effects:{ tags:['记忆发明家'], memory:'绳结记事', fate:2, bond:0 } },
      { id:'ch3_r2_b', label:'让丽贝卡做你的记忆', description:'她从不忘记任何东西——也许她的病是一种天赋。让她成为你的记忆。', nextScene:'ch3_r2b', effects:{ tags:['寄托者'], memory:null, fate:0, bond:2 } },
      { id:'ch3_r2_c', label:'写下一切', description:'在纸上写下所有记得的事——然后藏进箱子里，埋在栗树下。', nextScene:'ch3_r2c', effects:{ tags:['记录者'], memory:'箱底的纸卷', fate:1, bond:0 } }
    ...
    ch3_r2_settlement: { id:'ch3_r2_settlement', type:'settlement', chapter:3, round:2, title:'第二轮 · 结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['失眠症继续在村里蔓延——但它不再可怕。因为人们找到了各自的记忆方法。遗忘仍然会来——但人们不再等死。']}, settlement:{ summary:'第二轮选择完成。你创造了对抗遗忘的方法。', nextScene:'ch3_r3_choice', nextLabel:'进入第三轮', quadrantNarratives:{
          guardian:'家变大了——墙变多了，但你知道每一扇门后面都有人在呼吸。',
          prophet:'你建了暗室——一扇只有你知道的门。在所有人中间，你仍然是独自一人。',
          follower:'你放下锤子，拿起面包——有时候建造一个家不是用砖，是用一块面包和一碗汤。',
          rebel:'你反对扩建——房子已经够大了。但家族不听你的。就像河流不听堤岸一样。'
    ...
    ch3_r3_choice: { id:'ch3_r3_choice', type:'choice', chapter:3, round:3, title:'第三轮选择 · 家宅扩建', leftPage:{ speaker:'乌尔苏拉', speakerColor:'#a52020', paragraphs:['乌尔苏拉站在院子里，双手叉腰——这所房子太小了。"我们要扩建。"她从床底下取出积攒多年的金币。','"他一直以为我在存钱防老——但我在存钱等这一天。"'], transition:'你选择——' }, choices:[
      { id:'ch3_r3_a', label:'帮她一起扩建', description:'拿起锤子和锯子，和乌尔苏拉一起建一座能装下所有人的大宅。', nextScene:'ch3_r3a', effects:{ tags:['建设者'], memory:null, fate:-1, bond:2 } },
      { id:'ch3_r3_b', label:'建一间秘密实验室', description:'在扩建计划中加入一间只有你知道的暗室——炼金术需要一个安静的地方。', nextScene:'ch3_r3b', effects:{ tags:['隐秘建设者'], memory:'暗室之门', fate:1, bond:0 } },
      { id:'ch3_r3_c', label:'反对扩建——够住就好', description:'房子已经够大了。与其扩建，不如把多余的房间分给村里没房子的人。', nextScene:'ch3_r3c', effects:{ tags:['朴素者'], memory:null, fate:1, bond:-1 } }
    ...
    ch3_r3_settlement: { id:'ch3_r3_settlement', type:'settlement', chapter:3, round:3, title:'第三轮 · 结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['房子扩建好了。白色的墙壁，长长的走廊。家变大了——但不知怎么，人们之间的距离也变大了。一个更大的家意味着更多的角落，更多的角落意味着更多可以独自待着的地方。']}, settlement:{ summary:'第三轮选择完成。房子变大了——但家是什么？', nextScene:'ch3_r4_choice', nextLabel:'进入第四轮', quadrantNarratives:{
          guardian:'家变大了——墙变多了，但你知道每一扇门后面都有人在呼吸。',
          prophet:'你建了暗室——一扇只有你知道的门。在所有人中间，你仍然是独自一人。',
          follower:'你放下锤子，拿起面包——有时候建造一个家不是用砖，是用一块面包和一碗汤。',
          rebel:'你反对扩建——房子已经够大了。但家族不听你的。就像河流不听堤岸一样。'
    ...
    ch3_r4_choice: { id:'ch3_r4_choice', type:'choice', chapter:3, round:4, title:'第四轮选择 · 镇长的到来', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['阿波利纳尔·摩斯科特来了——政府派来的镇长。他带来了法令、文件和一面旗帜。"从今天开始，马孔多是政府管辖的镇子。"','何塞·阿尔卡蒂奥·布恩迪亚站在镇公所门口，双手握成拳头。你不确定他是在压制愤怒——还是在压制想要把那面旗子撕下来的冲动。'], transition:'你选择——' }, choices:[
      { id:'ch3_r4_a', label:'支持父亲——抵抗政府', description:'马孔多是你们建的——不是政府的。站在父亲身边。', nextScene:'ch3_r4a', effects:{ tags:['抵抗者'], memory:null, fate:1, bond:1 } },
      { id:'ch3_r4_b', label:'调解——找到妥协', description:'父亲和镇长各有道理。做一个中间人——让马孔多保留自由但接受秩序。', nextScene:'ch3_r4b', effects:{ tags:['调解人'], memory:null, fate:0, bond:2 } },
      { id:'ch3_r4_c', label:'支持镇长——拥抱秩序', description:'政府带来秩序、学校和医院。站在镇长一边——即使与父亲对立。', nextScene:'ch3_r4c', effects:{ tags:['秩序拥护者'], memory:'父与子的裂痕', fate:1, bond:-1 } },
      { id:'ch3_r4_d', label:'你看见了秩序的必要——一个家族需要围墙', description:'不是政府的围墙——是家族自己的边界。你知道这所房子需要规则来保护里面的人。不是因为害怕外面——是因为爱里面。', nextScene:'ch3_r4c', requiredFate: { min: 4 }, effects:{ tags:['看见秩序的人'], memory:null, fate: 1, bond: 0 } }
    ...
    ch3_r4_settlement: { id:'ch3_r4_settlement', type:'settlement', chapter:3, round:4, title:'第四轮 · 结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['镇长留下来了。马孔多的第一面国旗在镇公所门前飘了起来——但真正做决定的人，仍然是栗树下的那个男人和他的妻子。']}, settlement:{ summary:'第四轮选择完成。马孔多第一次面对外部权力——你选择了自己的立场。', nextScene:'ch3_r5_choice', nextLabel:'进入最终轮', quadrantNarratives:{
          guardian:'家变大了——墙变多了，但你知道每一扇门后面都有人在呼吸。',
          prophet:'你建了暗室——一扇只有你知道的门。在所有人中间，你仍然是独自一人。',
          follower:'你放下锤子，拿起面包——有时候建造一个家不是用砖，是用一块面包和一碗汤。',
          rebel:'你反对扩建——房子已经够大了。但家族不听你的。就像河流不听堤岸一样。'
    ...
    ch3_r5_choice: { id:'ch3_r5_choice', type:'choice', chapter:3, round:5, title:'第五轮选择 · 家族的未来', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['布恩迪亚家现在有了六个成员，一所大房子，一个被绑在栗树下的老族长。你开始感到一种奇怪的不安——家太大了，人太多了。每个角落都有人在发生你不知道的事。','你忽然想起梅尔基亚德斯说过的话："人最多的时候，往往最孤独。"'], transition:'你选择——' }, choices:[
      { id:'ch3_r5_a', label:'专注于炼金术', description:'退回到实验室里，关上那扇门。让外面的人自己处理外面的事。', nextScene:'ch3_r5a', effects:{ tags:['孤独的炼金术士'], memory:null, fate:2, bond:-1 } },
      { id:'ch3_r5_b', label:'承担家族责任', description:'你是布恩迪亚——这个家需要一个清醒的人来看着它。放下炼金术。', nextScene:'ch3_r5b', effects:{ tags:['家族支柱'], memory:null, fate:-1, bond:2 } },
      { id:'ch3_r5_c', label:'离开——去看世界', description:'马孔多太小了。去看看真正的大海——不是灰白的脏水，是真正蔚蓝的海洋。', nextScene:'ch3_r5c', effects:{ tags:['出走者'], memory:'未完成的地图', fate:1, bond:-2 } },
      { id:'ch3_r5_d', label:'你记得绳结的触感——用同样的方法编织家族的脉络', description:'失眠症那年你发明了绳结记事——每一道结都是一个被挽救的记忆。现在这个家族需要同样的东西：看得见的连接。用绳结标记每一个人的名字。', nextScene:'ch3_r5b', requiredMemory: '绳结记事', effects:{ tags:['编织家族脉络的人'], memory:null, fate: 0, bond: 2 } }
    ...
    ch3_r5_settlement: { id:'ch3_r5_settlement', type:'settlement', chapter:3, round:5, title:'第五轮 · 结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['布恩迪亚家大宅落成了。白色的墙，长长的走廊，四十多扇门。乌尔苏拉站在院子里——她老了，但她的眼睛还是年轻的。她知道这所房子会一直站着——哪怕里面的人来了又走。']}, settlement:{ summary:'最终轮选择完成。家族在扩张，而你找到了——或失去了——自己的位置。', nextScene:'chapter3_end', nextLabel:'查看章末结算', quadrantNarratives:{
          guardian:'家变大了——墙变多了，但你知道每一扇门后面都有人在呼吸。',
          prophet:'你建了暗室——一扇只有你知道的门。在所有人中间，你仍然是独自一人。',
          follower:'你放下锤子，拿起面包——有时候建造一个家不是用砖，是用一块面包和一碗汤。',
          rebel:'你反对扩建——房子已经够大了。但家族不听你的。就像河流不听堤岸一样。'
...
registerChapter({
  ...
  scenes: {
    ch4_opening: { id:'ch4_opening', type:'narrative', chapter:4, round:0, title:'第四幕开启 · 钢琴响起', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['那个音符不是被手弹出来的——是一枚硬币落进槽口，齿轮转动，铜制音筒开始旋转。第一声和弦从客厅传来。','自动钢琴在马孔多第一次奏响。皮埃特罗·克雷斯皮半夜用一枚硬币试了琴。他以为没人听见——但全家人都听见了。','这首曲子在你脑海里没有名字，它只有温度——从脚下的地板沿脚踝、膝盖升起，涌入胸腔，涌入眼眶。你不记得怎么走到客厅的——他站在钢琴旁，没有看见你。但阿玛兰妲看见了。'], clues:[
          { triggerText:'自动钢琴', itemId:'unsent_score', narrative:'一张手写乐谱夹在钢琴谱架里——皮埃特罗写的。没有标题，没有署名。你只能认出开头三个音符——然后墨迹就模糊了。也许他本来就没写完。', unlocksIn:['chapter13'] }
        ]}, choices:null, nextScene:'ch4_r1_choice' },
    ...
    ch4_r1_choice: { id:'ch4_r1_choice', type:'choice', chapter:4, round:1, title:'第一轮选择 · 爱情的种子', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['皮埃特罗·克雷斯皮——意大利钢琴师，优雅得像一尊希腊雕像。他讲话的声音很轻，像在每句话上裹了一层天鹅绒。','丽贝卡爱上他了。阿玛兰妲也爱上他了。她们还不知道对方心里的事——但你知道。你站在走廊阴影里，看着两个女孩的心在同一天晚上裂成不同形状。'], transition:'你选择——' }, choices:[
      { id:'ch4_r1_a', label:'帮助丽贝卡表达爱意', description:'丽贝卡太安静了——她需要有人帮她开口。教她写信，接近他。', nextScene:'ch4_r1a', effects:{ tags:['爱的推手'], memory:null, fate:0, bond:1 } },
      { id:'ch4_r1_b', label:'帮助阿玛兰妲', description:'阿玛兰妲更有勇气——但她需要有人告诉她：爱情不是占有。', nextScene:'ch4_r1b', effects:{ tags:['爱的导师'], memory:null, fate:0, bond:1 } },
      { id:'ch4_r1_c', label:'不介入——让她们自己解决', description:'这不是你的事。两个女人爱上同一个人——谁也帮不上忙。', nextScene:'ch4_r1c', effects:{ tags:['旁观者'], memory:'走廊的阴影', fate:1, bond:-1 } }
    ...
    ch4_r1_settlement: { id:'ch4_r1_settlement', type:'settlement', chapter:4, round:1, title:'第一轮 · 结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['钢琴每天夜里都会响起。皮埃特罗不知道——他在客厅弹莫扎特的时候，楼上两颗心在不同的节奏里跳动着。爱情还没说出口——但它已经在空气里了。']}, settlement:{ summary:'第一轮完成。两颗心开始为同一个人跳动。', nextScene:'ch4_r2_choice', nextLabel:'进入第二轮', quadrantNarratives:{
          guardian:'爱情在两个女孩之间裂开——你想同时接住两边。但有些东西接不住。',
          prophet:'你站在走廊阴影里——看得太清楚有时是一种诅咒。你看见了所有人心里的刺。',
          follower:'你帮助了一个女孩——不是因为你确定她是对的，是因为她需要有人站在她身边。',
          rebel:'你不介入——不是因为冷漠，是因为你觉得爱情不该有裁判。让她们自己打这场仗。'
        } } },
    ...
    ch4_r2_choice: { id:'ch4_r2_choice', type:'choice', chapter:4, round:2, title:'第二轮选择 · 嫉妒的毒药', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['皮埃特罗选择了丽贝卡。不是因为更爱她——是丽贝卡的信更安静。阿玛兰妲在他衬衫上缝了太多花——他怕那些花会把他困住。','阿玛兰妲在房间里待了三天。她坐在窗边，用针扎着手指——每下都不深，但每下都见血。"我会让这个婚礼永远办不成。"她说。她没有说谎。'], transition:'你选择——' }, choices:[
      { id:'ch4_r2_a', label:'警告丽贝卡', description:'告诉丽贝卡——阿玛兰妲不会善罢甘休。让她做好准备保护自己的爱情。', nextScene:'ch4_r2a', effects:{ tags:['保护者'], memory:null, fate:0, bond:1 } },
      { id:'ch4_r2_b', label:'找阿玛兰妲谈话', description:'在嫉妒毁掉一切之前，坐下来和她谈谈——也许她只需要被人听见。', nextScene:'ch4_r2b', effects:{ tags:['劝解者'], memory:null, fate:0, bond:1 } },
      { id:'ch4_r2_c', label:'静观其变', description:'你不是神——不能替每个人做决定。让她们自己选择，让后果自己到来。', nextScene:'ch4_r2c', effects:{ tags:['命运观察者'], memory:null, fate:1, bond:-1 } }
    ...
    ch4_r2_settlement: { id:'ch4_r2_settlement', type:'settlement', chapter:4, round:2, title:'第二轮 · 结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['钢琴声停了。皮埃特罗把最后一枚硬币取出来，合上琴盖。他不知道——今晚之后，这架钢琴会沉默很久。因为有两个女人在为一个音符编织不同含义——只有一个能被弹出来。']}, settlement:{ summary:'第二轮完成。嫉妒的种子已发芽。', nextScene:'ch4_r3_choice', nextLabel:'进入第三轮', quadrantNarratives:{
          guardian:'爱情在两个女孩之间裂开——你想同时接住两边。但有些东西接不住。',
          prophet:'你站在走廊阴影里——看得太清楚有时是一种诅咒。你看见了所有人心里的刺。',
          follower:'你帮助了一个女孩——不是因为你确定她是对的，是因为她需要有人站在她身边。',
          rebel:'你不介入——不是因为冷漠，是因为你觉得爱情不该有裁判。让她们自己打这场仗。'
    ...
    ch4_r3_choice: { id:'ch4_r3_choice', type:'choice', chapter:4, round:3, title:'第三轮选择 · 婚礼与毒药', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['婚礼日。丽贝卡试婚纱时手抖得厉害——不是因为紧张，是因为看见了桌上那杯咖啡。阿玛兰妲端来的。"喝吧——热的。"阿玛兰妲笑着说。','丽贝卡举起杯子——乌尔苏拉从厨房冲出来，打翻了咖啡。热气颜色不对，带着甜腥味，像碾碎的花籽。阿玛兰妲转身走了。乌尔苏拉在她房门外站了很久——没敲门，也没离开。'], transition:'你选择——' }, choices:[
      { id:'ch4_r3_a', label:'与乌尔苏拉一起保护丽贝卡', description:'阿玛兰妲需要被制止。帮助乌尔苏拉确保婚礼安全进行。', nextScene:'ch4_r3a', effects:{ tags:['家族守护者'], memory:null, characterFlags: { 'protected_rebeca': 1 }, fate:-1, bond:2 } },
      { id:'ch4_r3_b', label:'私下警告阿玛兰妲', description:'不惊动乌尔苏拉——自己找阿玛兰妲谈。你是唯一能让她停下来的人。', nextScene:'ch4_r3b', effects:{ tags:['私密的劝诫者'], memory:null, fate:1, bond:-1 } },
      { id:'ch4_r3_c', label:'让婚礼取消', description:'也许这场婚姻本就不该发生。说服皮埃特罗离开马孔多。', nextScene:'ch4_r3c', effects:{ tags:['破坏者'], memory:'破碎的婚约', fate:0, bond:0 } }
    ...
    ch4_r3_settlement: { id:'ch4_r3_settlement', type:'settlement', chapter:4, round:3, title:'第三轮 · 结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['婚礼的钟声——或沉默——在马孔多上空回荡。钢琴在客厅静静等待。有些旋律永远不会被弹出来——不是不美，是在弹响之前，弹琴的人就离开了。']}, settlement:{ summary:'第三轮完成。你决定了婚礼的结局。', nextScene:'ch4_r4_choice', nextLabel:'进入第四轮', quadrantNarratives:{
          guardian:'爱情在两个女孩之间裂开——你想同时接住两边。但有些东西接不住。',
          prophet:'你站在走廊阴影里——看得太清楚有时是一种诅咒。你看见了所有人心里的刺。',
          follower:'你帮助了一个女孩——不是因为你确定她是对的，是因为她需要有人站在她身边。',
          rebel:'你不介入——不是因为冷漠，是因为你觉得爱情不该有裁判。让她们自己打这场仗。'
    ...
    ch4_r4_choice: { id:'ch4_r4_choice', type:'choice', chapter:4, round:4, title:'第四轮选择 · 归来的巨人', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['一个巨人走进院子。肩膀几乎撑破门框——阳光从他背后照过来，影子投在整个天井里。何塞·阿尔卡蒂奥——那个十四岁跟吉卜赛人走了的孩子，走了十几年，现在回来了。','他看着丽贝卡。丽贝卡看着他。两人之间发生了一件事——不是目光交汇，是更深的东西。像两块磁铁在同一个空间找到彼此。乌尔苏拉手里的勺子掉在地上。'], transition:'你选择——' }, choices:[
      { id:'ch4_r4_a', label:'祝福他们', description:'丽贝卡找到归宿，何塞·阿尔卡蒂奥找到回家的理由。他们属于彼此。', nextScene:'ch4_r4a', effects:{ tags:['祝福者'], memory:null, fate: -1, bond: 2 } },
      { id:'ch4_r4_b', label:'反对——这是乱伦', description:'虽非亲兄妹——但太近了。这个结合会给家族带来诅咒。', nextScene:'ch4_r4b', effects:{ tags:['道德守卫者'], memory:null, fate: 1, bond: -1 } },
      { id:'ch4_r4_c', label:'沉默见证', description:'何塞·阿尔卡蒂奥从不需要许可，丽贝卡从不请求。让命运自己运行。', nextScene:'ch4_r4c', effects:{ tags:['沉默的见证人'], memory:null, fate: 0, bond: 0 } }
    ...
    ch4_r5_choice: { id:'ch4_r5_choice', type:'choice', chapter:4, round:5, title:'第五轮选择 · 钢琴的最后旋律', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['自动钢琴不再响了。没有人投币——皮埃特罗走了，丽贝卡走了，阿玛兰妲也不再缝花了。钢琴在客厅角落积灰，像一个装满了未出生音符的棺材。','乌尔苏拉站在钢琴前——不会弹琴，但用手掌擦了擦琴盖。她没有喜欢过皮埃特罗，也没有恨过他。她只是觉得：每段爱在马孔多都是被消耗殆尽后才准离开的。但钢琴还在——等一枚永远不会再来的硬币。'], transition:'你选择——' }, choices:[
      { id:'ch4_r5_a', label:'弹最后一支曲', description:'坐到钢琴前——不会弹，但按下一个键。一个音符。一声告别。', nextScene:'ch4_r5a', effects:{ tags:['送别者'], memory:'最后的音符', fate: 0, bond: 2 } },
      { id:'ch4_r5_b', label:'把钢琴送给教堂', description:'这架钢琴不该在这里积灰。让它去教堂——让更多人听到它的声音。', nextScene:'ch4_r5b', effects:{ tags:['给予者'], memory:null, fate: -1, bond: 1 } },
      { id:'ch4_r5_c', label:'保持沉默', description:'有些沉默不该被打破。让钢琴继续积灰——在沉默中讲述自己的故事。', nextScene:'ch4_r5c', effects:{ tags:['沉默的守护者'], memory:'尘封的琴弦', fate: 0, bond: -1 } },
      { id:'ch4_r5_d', label:'让皮埃特罗的旋律被更多人听到——打开门窗', description:'钢琴不该在积灰中沉默。它的旋律曾经让两个人爱上同一个人——让整个马孔多都听见。推开窗户——让音乐飞到街上去。', nextScene:'ch4_r5a', requiredBond: { min: 4 }, effects:{ tags:['打开门窗的人'], memory:null, fate: 0, bond: 2 } }
    ...
    ch4_r5_settlement: { id:'ch4_r5_settlement', type:'settlement', chapter:4, round:5, title:'第五轮 · 结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['钢琴沉默了。爱情在马孔多这个季节走过了它的第一轮循环——初遇、热恋、嫉妒、分离、沉默。所有旋律都有开始和结束——这架自动钢琴经历了一段完整的人生。']}, settlement:{ summary:'最终轮完成。钢琴的旋律结束了——但余音会在走廊里回荡很多年。', nextScene:'chapter4_end', nextLabel:'查看章末结算', quadrantNarratives:{
          guardian:'爱情在两个女孩之间裂开——你想同时接住两边。但有些东西接不住。',
          prophet:'你站在走廊阴影里——看得太清楚有时是一种诅咒。你看见了所有人心里的刺。',
          follower:'你帮助了一个女孩——不是因为你确定她是对的，是因为她需要有人站在她身边。',
          rebel:'你不介入——不是因为冷漠，是因为你觉得爱情不该有裁判。让她们自己打这场仗。'
...
registerChapter({
  ...
  scenes: {
    ch5_opening: { id:'ch5_opening', type:'narrative', chapter:5, round:0, title:'第五幕开启 · 她在吃一颗糖苹果', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['那天下午，你正在实验室里熔一枚金币。然后你从窗户看见了蕾梅黛丝。','她站在街对面，镇长家门前，手里举着一颗糖苹果。糖壳上有一只蜜蜂，正在徒劳地寻找裂缝。她的嘴张着——不是要咬，是忘了咬。她穿着淡绿的裙子——有些长，拖在泥地上，裙摆沾了细灰。风吹过来，裙子像一株早熟的植物在她身上抖动。','你手里的钳子停住了。坩埚里的金液晃了晃，溅了一滴在你手背上——不疼。或者说，疼已经被别的东西盖住了。你只是在心里说了一个字："她。"','她是阿波利纳尔·摩斯科特的女儿。她九岁。多年以后，你将会面对行刑队的枪口——想起这个下午。'], clues: [{ triggerText: '糖苹果', itemId: 'candied_shell', narrative: '糖壳在牙齿间碎开——甜的。但你尝到的不只是糖。是一个九岁女孩在街对面举起的手——透明的、易碎的、已经被时间预定要碎的东西。你把碎壳收进口袋——不是为了记住，是因为你不敢丢掉任何与她有关的东西。', unlocksIn: ['chapter15'] }, { triggerText: '行刑队', itemId: 'bullet_holes_wall', narrative: '墙上八个弹孔——不是你的。但这面墙等过你。每一颗子弹都在墙上留了一个位置——那是留给你的。你用手指摸着弹孔的边缘——粗糙，冰冷，像凝固的时间。', unlocksIn: ['chapter10'] }] }, echoCondition: { flag: 'showed_ice', min: 1 }, echoText: '你记得冰块的温度——不是冷。是父亲的手覆在你手背上的重量。那个遥远的下午到现在——你经历了爱情、战争、失去——但你的手指还记得冷的形状。', choices:null, nextScene:'ch5_r1_choice' },
    ...
    ch5_r1_choice: { id:'ch5_r1_choice', type:'choice', chapter:5, round:1, title:'第一轮选择 · 初恋的宣言', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['你无法忘记那个画面——蕾梅黛丝举着糖苹果，蜜蜂在她指尖嗡嗡作响。你从来没有对任何人有过这种感觉。不是肉欲——是一种近乎宗教的确定。你确定你将在余生所有重要时刻想起这颗糖苹果。','但她也只有九岁。而她父亲是镇长——那个你帮助或反对过的人。'], transition:'你选择——' }, choices:[
      ...
      { id:'ch5_r1_d', label:'用磁铁感应——寻找隐藏的金属', description:'你口袋里的磁铁还在嗡鸣。也许它能告诉你一些看不见的东西——关于这座房子，关于蕾梅黛丝，关于你自己。', nextScene:'ch5_r1c', requiredClue: 'magnet_hum', effects:{ tags:['磁铁的低语者'], memory:null, fate: 0, bond: 1 } },
      { id:'ch5_r1_e', label:'你知道蕾梅黛丝的结局——这一次，珍惜这个下午', description:'你上次经过这个下午时不知道糖苹果会在什么时候碎。这一次你知道了——但蜜蜂还在飞，糖壳还是透明的。你站在窗口——这一次你多看了她一眼。', nextScene:'ch5_r1a', requiredPlaythrough: 2, effects:{ tags:['珍惜每一颗糖苹果的人'], memory:null, fate: -1, bond: 2 } }
    ...
    ch5_r1_settlement: { id:'ch5_r1_settlement', type:'settlement', chapter:5, round:1, title:'第一轮 · 结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['蕾梅黛丝还在街对面吃着她的糖苹果，不知道有一个男人已经把自己的一生和她的名字系在了一起。战争还很远——但它在河对岸的山那边，正一步一步朝马孔多走来。']}, settlement:{ summary:'第一轮完成。你第一次爱上了——对象是九岁的蕾梅黛丝。', nextScene:'ch5_r2_choice', nextLabel:'进入第二轮', quadrantNarratives:{ guardian:'你走向镇长家——不是为了权力，是为了一个九岁女孩。你的勇气来自爱，不是来自野心。', prophet:'你在窗口看了她很久——没有走近。你看得太清楚了——看见了未来所有的糖苹果都会碎。', follower:'你选择等待——不是退缩，是用时间证明。有些爱不需要说出口——它只需要被放在心里，每天浇一点水。', rebel:'你关上了窗户——但心里的蜜蜂还在嗡嗡作响。你对抗的不是爱情——是你自己。' } } },
    ...
    ch5_r2_choice: { id:'ch5_r2_choice', type:'choice', chapter:5, round:2, title:'第二轮选择 · 战争来到马孔多', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['战争来了。不是以军队的形式——是以一封信的形式。信上写着：自由党在首都起义了，保守党正在各地搜捕"叛乱分子"。你的朋友——那个教你看星星的医生——被列在名单上。','士兵已经进入了马孔多。他们在大街上列队，枪上的刺刀在午后阳光下闪闪发光。他们把镇长的办公室改成了指挥部。有一个年轻军官正盯着布恩迪亚家的方向——他知道你的名字。'], transition:'你选择——' }, marginalia:{ text:'读到这里时我合上书去厨房倒了杯水。回来时发现自己攥着杯子的姿势像攥着一把枪。', style:'whisper' }, choices:[
      { id:'ch5_r2_a', label:'拿起武器加入自由党', description:'你不能坐视朋友被捕。从实验室里拿出武器——战斗从今天开始。', nextScene:'ch5_r2a', effects:{ tags:['革命者'], memory:null, relationshipEffects:{'乌尔苏拉·伊瓜兰':-10}, characterFlags:{'joined_war':1}, fate: 2, bond: -1 }, emotionalCost:'乌尔苏拉站在门口说"别死"——她没有说"回来"。这两个词之间的空白，是你此后所有战争的总重量', alternativeNarrative:'若你选择保护家人——你不会成为上校。你不会面对行刑队。你不会知道权力藤蔓缠绕肋骨的感觉。但你会在每个黄昏坐在门廊上，听见栗树下的老人画着圆圈——画了一辈子，从未停笔。' },
      { id:'ch5_r2_b', label:'保护家人——保持中立', description:'战争是别人的事。你的责任是守住这所房子，守住乌尔苏拉和孩子们。', nextScene:'ch5_r2b', effects:{ tags:['家族堡垒'], memory:null, relationshipEffects:{'乌尔苏拉·伊瓜兰':15}, characterFlags:{'ursula_cared':1,'family_first':1}, fate: -1, bond: 2 }, alternativeNarrative:'若你拿起武器——你将在战场上度过余生最漫长的夜晚。你会在硝烟中看见蕾梅黛丝举着糖苹果的背影——而你知道你再也回不到那个下午了。' },
      { id:'ch5_r2_c', label:'试图与两边谈判', description:'也许避免流血的唯一方法是对话。去找军官和自由党人——用你的影响力斡旋。', nextScene:'ch5_r2c', effects:{ tags:['和平使者'], memory:'谈判桌的空椅子', characterFlags:{'tried_peace':1}, fate: 0, bond: 2 }, alternativeNarrative:'若你选择不谈判——你永远不会知道那张空椅子在阳光下放了多久。你会直接走进战争的门——更快，更痛，但也许更诚实。和平有时比战争更让人精疲力竭。' }
    ...
    ch5_r2_settlement: { id:'ch5_r2_settlement', type:'settlement', chapter:5, round:2, title:'第二轮 · 结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['枪声在远处响起——不是马孔多，是河对岸的另一个镇子。但枪声像打雷一样，一阵一阵地传过来。栗树下的老人抬起头——他听见了战争的第一声低语。他继续画他的圆圈。他早就知道这场战争会来——他只是在等它路过。']}, settlement:{ summary:'第二轮完成。战争敲响了马孔多的大门。', nextScene:'ch5_r3_choice', nextLabel:'进入第三轮', quadrantNarratives:{ guardian:'你选择了保护——不是武器，是围栏。家族是你的战场——你在这里打仗，用铁条和耐心。', prophet:'你坐在空椅子前——他们都没有来。战争不需要理由——只需要借口。你看透了这一点——但看透并不等于自由。', follower:'你没有离开——你守在院子里。不是因为害怕战争，是因为有些东西比战争更需要你。', rebel:'你拿起了武器——不是因为恨，是因为不能坐视。你离开了马孔多——但你的影子还留在栗树下的泥土里。' } } },
    ...
    ch5_r3_choice: { id:'ch5_r3_choice', type:'choice', chapter:5, round:3, title:'第三轮选择 · 蕾梅黛丝之死', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['你不在家。你在前线——指挥第一场战役。然后信来了。乌尔苏拉只写了三个字："她走了。"','蕾梅黛丝死了。不是因为战争——是因为意外。她从楼梯上摔下来，怀着你未出生的孩子。她死的时候十四岁。你还记得她九岁时举着糖苹果的样子——那只蜜蜂绕着糖壳飞，她的嘴忘了咬。现在那个嘴巴永远不会咬了。那些苹果永远不会被吃完了。'], transition:'你选择——' }, marginalia:{ text:'这页有水渍。不是我弄的——是上一个读者。也可能是再上一个。这页永远会有水渍。', style:'warning' }, choices:[
      ...
      { id:'ch5_r3_e', label:'你知道乌尔苏拉会在厨房等你——回家喝汤', description:'你了解乌尔苏拉——她不会说"别死"，她只会把一碗汤放在桌上。你知道那碗汤还在那里——回去喝掉它。不是为了蕾梅黛丝——是为了还活着的人。', nextScene:'ch5_r3a', requiredRelationship: { character: '乌尔苏拉·伊瓜兰', min: 70 }, effects:{ tags:['被一碗汤召回的人'], memory:null, fate: -1, bond: 2 } }
    ...
    ch5_r3_settlement: { id:'ch5_r3_settlement', type:'settlement', chapter:5, round:3, title:'第三轮 · 结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['蕾梅黛丝走了。马孔多的栗树下多了一块白色石头。你还是上校——你的军装越来越旧，你的眼神越来越像你父亲被绑在树下之前的那个样子。战争在继续——它不关心爱情。']}, settlement:{ summary:'第三轮完成。你失去了蕾梅黛丝——选择了如何面对她的死亡。', nextScene:'ch5_r4_choice', nextLabel:'进入第四轮', quadrantNarratives:{ guardian:'你跪在她墓前——膝下的泥土是湿的。你从牙缝里省下的糖被蚂蚁搬走了——但你知道她看见了。爱比死亡多了一块糖的重量。', prophet:'你继续打仗——但每一场战役你都在心里留了一块空白。那块空白是蕾梅黛丝的形状——你会在余生所有重要的时刻想起糖苹果。', follower:'你回家了——不是为了告别，是因为她在这里。栗树旁边那块白色石头——是你每天浇水的地方。', rebel:'你写了一整夜——写给亡妻的信。不是道别——是你在和死神争抢最后一句话。你写完了。她收到了。' } } },
    ...
    ch5_r4_choice: { id:'ch5_r4_choice', type:'choice', chapter:5, round:4, title:'第四轮选择 · 权力的诱惑', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['你打赢了很多仗。人们开始叫你"上校"——不是官职，是尊称。你走进一个镇子的时候，人们自动让开一条路。你开始收到礼物：一支银柄手枪，一封来自首都的邀请函，一个年轻女人的照片——她的名字不重要。','你感到权力在你体内生长——不是像树，是像藤蔓。它缠绕着你的肋骨，让你每次呼吸都能闻到自己的影响力。它很甜——比糖苹果还甜。但它也在吃掉你。你明白这一点——但你停不下来。'], transition:'你选择——' }, choices:[
      { id:'ch5_r4_a', label:'拥抱权力——成为领袖', description:'你有能力领导——这是上天给你的责任。接受它，成为你需要成为的那个人。', nextScene:'ch5_r4a', effects:{ tags:['权力的拥抱者'], memory:null, fate: 2, bond: -1 } },
      { id:'ch5_r4_b', label:'拒绝——回到马孔多', description:'你不是为了权力才打仗的。把军装还给战争——回去做小金鱼。', nextScene:'ch5_r4b', effects:{ tags:['归隐者'], memory:'被拒绝的银手枪', fate: -1, bond: 1 } },
      { id:'ch5_r4_c', label:'寻找中间道路——为正义而战', description:'权力本身不是目的——用它来改变不公正。但你得小心：正义和权力很少是同一个东西。', nextScene:'ch5_r4c', effects:{ tags:['正义的骑手'], memory:null, fate: 1, bond: 0 } }
    ...
    ch5_r4_settlement: { id:'ch5_r4_settlement', type:'settlement', chapter:5, round:4, title:'第四轮 · 结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['战争继续着。你的人民越来越多——追随你和反对你的人都在增加。权力在你体内已经长成了一棵树——它有根了。你拔不掉它。也许你也不想拔了。']}, settlement:{ summary:'第四轮完成。权力敲了你的门——你选择开门还是关上。', nextScene:'ch5_r5_choice', nextLabel:'进入第五轮', quadrantNarratives:{ guardian:'你接过银柄手枪——不是想要权力，是想用权力保护那些不能保护自己的人。这让你与他们不同——你还记得枪口应该指向谁。', prophet:'你站在权力的中心——看见了它的全部面貌。不是力量——是孤独的放大器。你接受或拒绝——都已经太晚了：你已经看见了。', follower:'你回到了马孔多——把银柄手枪还给了送它的人。回家的路比出征的路更长——但每一步都值得。', rebel:'你拒绝在权力和归隐之间二选一——你选择了正义的中间道路。这是最危险的路——因为两边都把你视为背叛者。' } } },
    ...
    ch5_r5_choice: { id:'ch5_r5_choice', type:'choice', chapter:5, round:5, title:'第五轮选择 · 行刑队与不朽', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['你被俘了。不是被敌人——是被你曾经相信的人。他们把你绑在行刑队的墙前。你面前是八个端着枪的年轻士兵——其中有一个看起来像从前的你：眼睛清澈，手指颤抖。','你看着他们。你不怕死——不是因为勇敢，是因为你太累了。但你想起了那块冰。想起了奥雷里亚诺（如果你来自未来）或想起了你自己六岁时伸出的那根手指。你忽然笑了。士兵们面面相觑。你笑不是因为找到了解脱——是因为你终于理解了梅尔基亚德斯的话。'], transition:'你选择——' }, choices:[
      { id:'ch5_r5_a', label:'直视行刑队——拒绝蒙眼', description:'你要睁着眼睛看他们扣下扳机。让他们记住这张脸——它会出现在他们余生每一个梦里。', nextScene:'ch5_r5a', effects:{ tags:['不屈者'], memory:'行刑队前的微笑', fate: 2, bond: 0 } },
      { id:'ch5_r5_b', label:'要求最后的请求', description:'你要写最后一封信——给乌尔苏拉。不是道别，是感谢。感谢她在所有夜晚都在桌上摆了碗筷。', nextScene:'ch5_r5b', effects:{ tags:['感恩的告别者'], memory:'最后一封信', fate: -1, bond: 2 } },
      { id:'ch5_r5_c', label:'试图逃跑——哪怕失败', description:'你不是坐以待毙的人。哪怕机会渺茫——也要在墙前最后一秒朝左边扑去。', nextScene:'ch5_r5c', effects:{ tags:['至死不屈者'], memory:'墙边的弹孔', fate: 2, bond: 0 } },
      { id:'ch5_r5_d', label:'你拒绝闭上眼睛——你要他们记住你的脸', description:'不是逃跑，不是接受——是让他们永远记住：这个人到最后一秒都在看着你们。你要把行刑队的眼睛变成你的镜子。', nextScene:'ch5_r5a', requiredFate: { max: 2 }, effects:{ tags:['不闭眼的人'], memory:null, fate: 2, bond: 0 } },
      { id:'ch5_r5_e', label:'你感到父亲的手还覆在你手背上——你不会死在这里', description:'那个遥远的下午——冰块在你掌心融化，父亲的手覆在你的手背上。那温度穿过时间——穿过战争、穿过行刑队的墙。乌尔苏拉的汤还在灶上——你知道。你不会死在这里。不是怕死——是欠了两代人的债还没还。', nextScene:'ch5_r5c', requiredMemory: '覆手', requiredRelationship: { character: '乌尔苏拉·伊瓜兰', min: 70 }, effects:{ tags:['被记忆拯救的人'], memory:null, fate: -1, bond: 2 } }
    ...
    ch5_r5_settlement: { id:'ch5_r5_settlement', type:'settlement', chapter:5, round:5, title:'第五轮 · 结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['你活了下来——或以某种方式不朽了。许多年以后，面对行刑队的那个下午——或面对冰块的那个下午——或面对你父亲被绑在栗树下的那个下午——会变成马孔多最常被人讲述的故事。故事不在乎真相——故事只在乎是否被记住了。']}, settlement:{ summary:'第五轮完成。你面对了死亡——或死亡面对了你。', nextScene:'ch5_r6_choice', nextLabel:'进入最终轮', quadrantNarratives:{ guardian:'你写了最后一封信——不是道别，是感谢。感谢她在所有夜晚都在桌上摆了碗筷。死不是最可怕的——最可怕的是来不及说谢谢。', prophet:'你直视行刑队——睁着眼睛。你要让他们记住这张脸——它会在他们余生每一个梦里出现。你把自己变成了一颗钉子——钉在他们的记忆里。', follower:'你在最后关头朝左扑去——不是勇敢，是还没有准备好离开。死亡今天放过了你——它知道你还欠一碗汤。', rebel:'你拒绝了蒙眼布——你要看着他们扣下扳机。你不会给他们闭上眼睛的便利——你会在黑暗中继续盯着他们。' } } },
    ...
    ch5_r6_choice: { id:'ch5_r6_choice', type:'choice', chapter:5, round:6, title:'第六轮选择 · 回家的路', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['战争还没有结束——但你的战争已经结束了。你站在马孔多的路口——往左是栗树和实验室，往右是继续出征的路。你的军装已经旧了，你的手上还残留着火药味，你的心里有一个洞——那个洞曾经装着蕾梅黛丝。','乌尔苏拉站在家门口。她看见你了。她没有跑过来——她只是站在那里，手在围裙上擦了又擦。你离她还有一百步——但你已经闻到汤的味道了。'], transition:'你选择——' }, choices:[
      { id:'ch5_r6_a', label:'走回家——脱下军装', description:'走进院子，把军装挂在门后那副盔甲旁边。坐下喝汤。战争结束了。', nextScene:'ch5_r6a', effects:{ tags:['归乡者'], memory:'盔甲旁的军装', fate: -1, bond: 2 } },
      { id:'ch5_r6_b', label:'再次出征——完成使命', description:'你还有未竟之事。告诉乌尔苏拉你还会回来——然后在转身之前不要看她。', nextScene:'ch5_r6b', effects:{ tags:['永不停歇者'], memory:null, fate: 2, bond: -1 } },
      { id:'ch5_r6_c', label:'站在路口——不知何去何从', description:'你站在原地。风吹过来，带着栗树的气味。你不知道该去哪——也许你永远都不会知道。', nextScene:'ch5_r6c', effects:{ tags:['迷途者'], memory:'路口的风', fate: 0, bond: 0 } }
    ...
    ch5_r6_settlement: { id:'ch5_r6_settlement', type:'settlement', chapter:5, round:6, title:'第六轮 · 结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['战争的声音远去了——不是结束，是转移到了别的地方。马孔多还在。栗树还在。乌尔苏拉还在。你也许还在，也许不在了——这取决于你选择了哪条路。但不管怎样，这所房子会记得你。会在走廊的回声里，在煤油灯的灯芯里，在每一碗太咸的汤里——记得你。']}, settlement:{ summary:'最终轮完成。你回家了——或再次上路了。无论如何，马孔多记得你。', nextScene:'chapter5_end', nextLabel:'查看章末结算', quadrantNarratives:{ guardian:'你走进院子——把军装挂在门后那副盔甲旁边。坐下喝汤。战争结束了——至少对你来说。乌尔苏拉没有说"欢迎回家"——她把汤放在你面前。这就够了。', prophet:'你站在路口——左边是家，右边是战争。你不知道该往哪走——也许你永远都不会知道。风从栗树方向吹来——你知道它画的是圆圈。', follower:'你选择留在家里——不是因为没有未竟之事，是因为有些事比使命更重要。你在门廊上坐下——听见厨房里汤在锅里沸腾的声音。', rebel:'你再次出征——不是因为热爱战争，是因为停不下来。你翻身上马——不敢回头。因为如果你回头——你就再也走不了了。' } } },
    chapter5_end: { id:'chapter5_end', type:'settlement', chapter:5, round:7, title:'第五章 · 章末结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['第五章完结。从糖苹果到行刑队，从初恋到战争的循环——你走过了奥雷里亚诺·布恩迪亚上校一生中最漫长的路程。','战争是最漫长的失眠。遗忘是最彻底的死亡。你还没有忘记——所以你还活着。']}, settlement:{ summary:'第五章完结。你经历了爱的诞生与死亡、战争的开始与循环——终于站在了回家的路口。', isChapterEnd:true, nextLabel:'进入第六章 · 第一次战争', quadrantNarratives:{ guardian:'糖苹果碎了——但爱还在。你从行刑队的墙前走回家——乌尔苏拉在门口等你。汤还热着。', prophet:'你看了糖苹果一眼——然后看了整个世纪的战争。你理解了全部——但理解是另一种孤独。', follower:'你选择了回去——在蕾梅黛丝的墓前跪下。石头上没有字——但你知道她叫什么。', rebel:'你与一切战斗——爱情、死亡、行刑队。你输了每一场战争——但你从未停止扣动扳机。' }, emotionalCost:'多年以后，当你再次面对行刑队——或当你被绑在栗树下——你将会回想起这个下午。这个你合上第五章的下午。你不知道自己离香蕉公司的火车还有多远——但你已经开始听见铁轨在远方微微震颤。' } }
  },
  memories: {
