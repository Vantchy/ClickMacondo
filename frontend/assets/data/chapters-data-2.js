...
registerChapter({
  ...
  scenes: {
    ...
    ch3_r1_choice: { id:'ch3_r1_choice', type:'choice', chapter:3, round:1, title:'第一轮选择 · 收养与陌生', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['第二天早上，你在天井里看见了丽贝卡。她站在井边，手伸进口袋，摸出什么东西塞进嘴里。你走近——她嘴角有泥痕。', '"你在吃什么？"她吓了一跳。泥从指缝漏下来。"没有什么。"'], transition:'你选择——' }, choices:[
      { id:'ch3_r1_a', label:'保守她的秘密', description:'退后一步，假装什么都没看见。每个人都有权保留自己的秘密。', nextScene:'ch3_r1a', effects:{ tags:['沉默的守护者'], fate:1, memory:null } },
      { id:'ch3_r1_b', label:'告诉乌尔苏拉', description:'乌尔苏拉知道怎么照顾人。让她来处理丽贝卡的吃泥问题。', nextScene:'ch3_r1b', effects:{ tags:['告密者'], fate:1, memory:null } },
      { id:'ch3_r1_c', label:'给她一块面包', description:'从厨房拿一块面包，放在她手里。"泥不是食物。这个才是。"', nextScene:'ch3_r1c', effects:{ tags:['温柔的替代者'], fate:2, memory:'面包与泥' } }
    ...
    ch3_r2_choice: { id:'ch3_r2_choice', type:'choice', chapter:3, round:2, title:'第二轮选择 · 失眠症的第二次侵袭', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['失眠症又回来了。你已经三天没有合眼了。闭上眼睛的时候，脑子里就开始播放回忆的碎片。','村民们开始在墙上写下越来越多的标签。乌尔苏拉说："再这样下去，我们会在醒来的时候忘记自己是谁。"'], transition:'你选择——' }, choices:[
      { id:'ch3_r2_a', label:'发明绳结记事', description:'用绳子打结来代表每天发生的事。每个结都是一段记忆——看得见，摸得着。', nextScene:'ch3_r2a', effects:{ tags:['记忆发明家'], fate:2, memory:'绳结记事' } },
      { id:'ch3_r2_b', label:'让丽贝卡做你的记忆', description:'她从不忘记任何东西——也许她的病是一种天赋。让她成为你的记忆。', nextScene:'ch3_r2b', effects:{ tags:['寄托者'], fate:2, memory:null } },
      { id:'ch3_r2_c', label:'写下一切', description:'在纸上写下所有记得的事——然后藏进箱子里，埋在栗树下。', nextScene:'ch3_r2c', effects:{ tags:['记录者'], fate:1, memory:'箱底的纸卷' } }
    ...
    ch3_r3_choice: { id:'ch3_r3_choice', type:'choice', chapter:3, round:3, title:'第三轮选择 · 家宅扩建', leftPage:{ speaker:'乌尔苏拉', speakerColor:'#a52020', paragraphs:['乌尔苏拉站在院子里，双手叉腰——这所房子太小了。"我们要扩建。"她从床底下取出积攒多年的金币。','"他一直以为我在存钱防老——但我在存钱等这一天。"'], transition:'你选择——' }, choices:[
      { id:'ch3_r3_a', label:'帮她一起扩建', description:'拿起锤子和锯子，和乌尔苏拉一起建一座能装下所有人的大宅。', nextScene:'ch3_r3a', effects:{ tags:['建设者'], fate:1, memory:null } },
      { id:'ch3_r3_b', label:'建一间秘密实验室', description:'在扩建计划中加入一间只有你知道的暗室——炼金术需要一个安静的地方。', nextScene:'ch3_r3b', effects:{ tags:['隐秘建设者'], fate:2, memory:'暗室之门' } },
      { id:'ch3_r3_c', label:'反对扩建——够住就好', description:'房子已经够大了。与其扩建，不如把多余的房间分给村里没房子的人。', nextScene:'ch3_r3c', effects:{ tags:['朴素者'], fate:1, memory:null, antiFate:true } }
    ...
    ch3_r4_choice: { id:'ch3_r4_choice', type:'choice', chapter:3, round:4, title:'第四轮选择 · 镇长的到来', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['阿波利纳尔·摩斯科特来了——政府派来的镇长。他带来了法令、文件和一面旗帜。"从今天开始，马孔多是政府管辖的镇子。"','何塞·阿尔卡蒂奥·布恩迪亚站在镇公所门口，双手握成拳头。你不确定他是在压制愤怒——还是在压制想要把那面旗子撕下来的冲动。'], transition:'你选择——' }, choices:[
      { id:'ch3_r4_a', label:'支持父亲——抵抗政府', description:'马孔多是你们建的——不是政府的。站在父亲身边。', nextScene:'ch3_r4a', effects:{ tags:['抵抗者'], fate:2, memory:null } },
      { id:'ch3_r4_b', label:'调解——找到妥协', description:'父亲和镇长各有道理。做一个中间人——让马孔多保留自由但接受秩序。', nextScene:'ch3_r4b', effects:{ tags:['调解人'], fate:1, memory:null } },
      { id:'ch3_r4_c', label:'支持镇长——拥抱秩序', description:'政府带来秩序、学校和医院。站在镇长一边——即使与父亲对立。', nextScene:'ch3_r4c', effects:{ tags:['秩序拥护者'], fate:1, memory:'父与子的裂痕', antiFate:true } }
    ...
    ch3_r5_choice: { id:'ch3_r5_choice', type:'choice', chapter:3, round:5, title:'第五轮选择 · 家族的未来', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['布恩迪亚家现在有了六个成员，一所大房子，一个被绑在栗树下的老族长。你开始感到一种奇怪的不安——家太大了，人太多了。每个角落都有人在发生你不知道的事。','你忽然想起梅尔基亚德斯说过的话："人最多的时候，往往最孤独。"'], transition:'你选择——' }, choices:[
      { id:'ch3_r5_a', label:'专注于炼金术', description:'退回到实验室里，关上那扇门。让外面的人自己处理外面的事。', nextScene:'ch3_r5a', effects:{ tags:['孤独的炼金术士'], fate:2, memory:null } },
      { id:'ch3_r5_b', label:'承担家族责任', description:'你是布恩迪亚——这个家需要一个清醒的人来看着它。放下炼金术。', nextScene:'ch3_r5b', effects:{ tags:['家族支柱'], fate:1, memory:null } },
      { id:'ch3_r5_c', label:'离开——去看世界', description:'马孔多太小了。去看看真正的大海——不是灰白的脏水，是真正蔚蓝的海洋。', nextScene:'ch3_r5c', effects:{ tags:['出走者'], fate:2, memory:'未完成的地图', antiFate:true } }
...
registerChapter({
  ...
  scenes: {
    ...
    ch4_r1_choice: { id:'ch4_r1_choice', type:'choice', chapter:4, round:1, title:'第一轮选择 · 爱情的种子', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['皮埃特罗·克雷斯皮——意大利钢琴师，优雅得像一尊希腊雕像。他讲话的声音很轻，像在每句话上裹了一层天鹅绒。','丽贝卡爱上他了。阿玛兰妲也爱上他了。她们还不知道对方心里的事——但你知道。你站在走廊阴影里，看着两个女孩的心在同一天晚上裂成不同形状。'], transition:'你选择——' }, choices:[
      { id:'ch4_r1_a', label:'帮助丽贝卡表达爱意', description:'丽贝卡太安静了——她需要有人帮她开口。教她写信，接近他。', nextScene:'ch4_r1a', effects:{ tags:['爱的推手'], fate:1, memory:null } },
      { id:'ch4_r1_b', label:'帮助阿玛兰妲', description:'阿玛兰妲更有勇气——但她需要有人告诉她：爱情不是占有。', nextScene:'ch4_r1b', effects:{ tags:['爱的导师'], fate:1, memory:null } },
      { id:'ch4_r1_c', label:'不介入——让她们自己解决', description:'这不是你的事。两个女人爱上同一个人——谁也帮不上忙。', nextScene:'ch4_r1c', effects:{ tags:['旁观者'], fate:2, memory:'走廊的阴影' } }
    ...
    ch4_r2_choice: { id:'ch4_r2_choice', type:'choice', chapter:4, round:2, title:'第二轮选择 · 嫉妒的毒药', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['皮埃特罗选择了丽贝卡。不是因为更爱她——是丽贝卡的信更安静。阿玛兰妲在他衬衫上缝了太多花——他怕那些花会把他困住。','阿玛兰妲在房间里待了三天。她坐在窗边，用针扎着手指——每下都不深，但每下都见血。"我会让这个婚礼永远办不成。"她说。她没有说谎。'], transition:'你选择——' }, choices:[
      { id:'ch4_r2_a', label:'警告丽贝卡', description:'告诉丽贝卡——阿玛兰妲不会善罢甘休。让她做好准备保护自己的爱情。', nextScene:'ch4_r2a', effects:{ tags:['保护者'], fate:1, memory:null } },
      { id:'ch4_r2_b', label:'找阿玛兰妲谈话', description:'在嫉妒毁掉一切之前，坐下来和她谈谈——也许她只需要被人听见。', nextScene:'ch4_r2b', effects:{ tags:['劝解者'], fate:1, memory:null } },
      { id:'ch4_r2_c', label:'静观其变', description:'你不是神——不能替每个人做决定。让她们自己选择，让后果自己到来。', nextScene:'ch4_r2c', effects:{ tags:['命运观察者'], fate:2, memory:null } }
    ...
    ch4_r3_choice: { id:'ch4_r3_choice', type:'choice', chapter:4, round:3, title:'第三轮选择 · 婚礼与毒药', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['婚礼日。丽贝卡试婚纱时手抖得厉害——不是因为紧张，是因为看见了桌上那杯咖啡。阿玛兰妲端来的。"喝吧——热的。"阿玛兰妲笑着说。','丽贝卡举起杯子——乌尔苏拉从厨房冲出来，打翻了咖啡。热气颜色不对，带着甜腥味，像碾碎的花籽。阿玛兰妲转身走了。乌尔苏拉在她房门外站了很久——没敲门，也没离开。'], transition:'你选择——' }, choices:[
      { id:'ch4_r3_a', label:'与乌尔苏拉一起保护丽贝卡', description:'阿玛兰妲需要被制止。帮助乌尔苏拉确保婚礼安全进行。', nextScene:'ch4_r3a', effects:{ tags:['家族守护者'], fate:1, memory:null } },
      { id:'ch4_r3_b', label:'私下警告阿玛兰妲', description:'不惊动乌尔苏拉——自己找阿玛兰妲谈。你是唯一能让她停下来的人。', nextScene:'ch4_r3b', effects:{ tags:['私密的劝诫者'], fate:2, memory:null } },
      { id:'ch4_r3_c', label:'让婚礼取消', description:'也许这场婚姻本就不该发生。说服皮埃特罗离开马孔多。', nextScene:'ch4_r3c', effects:{ tags:['破坏者'], fate:2, memory:'破碎的婚约', antiFate:true } }
    ...
    ch4_r4_choice: { id:'ch4_r4_choice', type:'choice', chapter:4, round:4, title:'第四轮选择 · 归来的巨人', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['一个巨人走进院子。肩膀几乎撑破门框——阳光从他背后照过来，影子投在整个天井里。何塞·阿尔卡蒂奥——那个十四岁跟吉卜赛人走了的孩子，走了十几年，现在回来了。','他看着丽贝卡。丽贝卡看着他。两人之间发生了一件事——不是目光交汇，是更深的东西。像两块磁铁在同一个空间找到彼此。乌尔苏拉手里的勺子掉在地上。'], transition:'你选择——' }, choices:[
      { id:'ch4_r4_a', label:'祝福他们', description:'丽贝卡找到归宿，何塞·阿尔卡蒂奥找到回家的理由。他们属于彼此。', nextScene:'ch4_r4a', effects:{ tags:['祝福者'], fate:1, memory:null } },
      { id:'ch4_r4_b', label:'反对——这是乱伦', description:'虽非亲兄妹——但太近了。这个结合会给家族带来诅咒。', nextScene:'ch4_r4b', effects:{ tags:['道德守卫者'], fate:2, memory:null } },
      { id:'ch4_r4_c', label:'沉默见证', description:'何塞·阿尔卡蒂奥从不需要许可，丽贝卡从不请求。让命运自己运行。', nextScene:'ch4_r4c', effects:{ tags:['沉默的见证人'], fate:1, memory:null } }
    ...
    ch4_r5_choice: { id:'ch4_r5_choice', type:'choice', chapter:4, round:5, title:'第五轮选择 · 钢琴的最后旋律', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['自动钢琴不再响了。没有人投币——皮埃特罗走了，丽贝卡走了，阿玛兰妲也不再缝花了。钢琴在客厅角落积灰，像一个装满了未出生音符的棺材。','乌尔苏拉站在钢琴前——不会弹琴，但用手掌擦了擦琴盖。她没有喜欢过皮埃特罗，也没有恨过他。她只是觉得：每段爱在马孔多都是被消耗殆尽后才准离开的。但钢琴还在——等一枚永远不会再来的硬币。'], transition:'你选择——' }, choices:[
      { id:'ch4_r5_a', label:'弹最后一支曲', description:'坐到钢琴前——不会弹，但按下一个键。一个音符。一声告别。', nextScene:'ch4_r5a', effects:{ tags:['送别者'], fate:1, memory:'最后的音符' } },
      { id:'ch4_r5_b', label:'把钢琴送给教堂', description:'这架钢琴不该在这里积灰。让它去教堂——让更多人听到它的声音。', nextScene:'ch4_r5b', effects:{ tags:['给予者'], fate:1, memory:null } },
      { id:'ch4_r5_c', label:'保持沉默', description:'有些沉默不该被打破。让钢琴继续积灰——在沉默中讲述自己的故事。', nextScene:'ch4_r5c', effects:{ tags:['沉默的守护者'], fate:2, memory:'尘封的琴弦' } }
...
registerChapter({
  ...
  scenes: {
    ...
    ch5_r1_choice: { id:'ch5_r1_choice', type:'choice', chapter:5, round:1, title:'第一轮选择 · 初恋的宣言', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['你无法忘记那个画面——蕾梅黛丝举着糖苹果，蜜蜂在她指尖嗡嗡作响。你从来没有对任何人有过这种感觉。不是肉欲——是一种近乎宗教的确定。你确定你将在余生所有重要时刻想起这颗糖苹果。','但她也只有九岁。而她父亲是镇长——那个你帮助或反对过的人。'], transition:'你选择——' }, choices:[
      { id:'ch5_r1_a', label:'向她父亲提亲', description:'你是布恩迪亚——你知道自己想要什么。去找镇长，正式求娶蕾梅黛丝。', nextScene:'ch5_r1a', effects:{ tags:['勇敢的求婚者'], fate:2, memory:null } },
      { id:'ch5_r1_b', label:'等待她长大', description:'她还太小。把你的感情埋在心底，等她长大——用时间来证明你的真心。', nextScene:'ch5_r1b', effects:{ tags:['耐心的等待者'], fate:1, memory:null } },
      { id:'ch5_r1_c', label:'扼杀这份感情', description:'她只是个孩子。你告诉自己：这不是爱，是一种错觉。转身走开——趁还来得及。', nextScene:'ch5_r1c', effects:{ tags:['自我克制者'], fate:1, memory:'未说出口的爱', antiFate:true } }
    ...
    ch5_r2_choice: { id:'ch5_r2_choice', type:'choice', chapter:5, round:2, title:'第二轮选择 · 战争来到马孔多', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['战争来了。不是以军队的形式——是以一封信的形式。信上写着：自由党在首都起义了，保守党正在各地搜捕"叛乱分子"。你的朋友——那个教你看星星的医生——被列在名单上。','士兵已经进入了马孔多。他们在大街上列队，枪上的刺刀在午后阳光下闪闪发光。他们把镇长的办公室改成了指挥部。有一个年轻军官正盯着布恩迪亚家的方向——他知道你的名字。'], transition:'你选择——' }, marginalia:{ text:'读到这里时我合上书去厨房倒了杯水。回来时发现自己攥着杯子的姿势像攥着一把枪。', style:'whisper' }, choices:[
      { id:'ch5_r2_a', label:'拿起武器加入自由党', description:'你不能坐视朋友被捕。从实验室里拿出武器——战斗从今天开始。', nextScene:'ch5_r2a', effects:{ tags:['革命者'], fate:3, memory:null, relationshipEffects:{'乌尔苏拉·伊瓜兰':-10}, characterFlags:{'joined_war':1} }, emotionalCost:'乌尔苏拉站在门口说"别死"——她没有说"回来"。这两个词之间的空白，是你此后所有战争的总重量', alternativeNarrative:'若你选择保护家人——你不会成为上校。你不会面对行刑队。你不会知道权力藤蔓缠绕肋骨的感觉。但你会在每个黄昏坐在门廊上，听见栗树下的老人画着圆圈——画了一辈子，从未停笔。' },
      { id:'ch5_r2_b', label:'保护家人——保持中立', description:'战争是别人的事。你的责任是守住这所房子，守住乌尔苏拉和孩子们。', nextScene:'ch5_r2b', effects:{ tags:['家族堡垒'], fate:1, memory:null, relationshipEffects:{'乌尔苏拉·伊瓜兰':15}, characterFlags:{'ursula_cared':1,'family_first':1} }, alternativeNarrative:'若你拿起武器——你将在战场上度过余生最漫长的夜晚。你会在硝烟中看见蕾梅黛丝举着糖苹果的背影——而你知道你再也回不到那个下午了。' },
      { id:'ch5_r2_c', label:'试图与两边谈判', description:'也许避免流血的唯一方法是对话。去找军官和自由党人——用你的影响力斡旋。', nextScene:'ch5_r2c', effects:{ tags:['和平使者'], fate:2, memory:'谈判桌的空椅子', characterFlags:{'tried_peace':1} }, alternativeNarrative:'若你选择不谈判——你永远不会知道那张空椅子在阳光下放了多久。你会直接走进战争的门——更快，更痛，但也许更诚实。和平有时比战争更让人精疲力竭。' }
    ...
    ch5_r3_choice: { id:'ch5_r3_choice', type:'choice', chapter:5, round:3, title:'第三轮选择 · 蕾梅黛丝之死', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['你不在家。你在前线——指挥第一场战役。然后信来了。乌尔苏拉只写了三个字："她走了。"','蕾梅黛丝死了。不是因为战争——是因为意外。她从楼梯上摔下来，怀着你未出生的孩子。她死的时候十四岁。你还记得她九岁时举着糖苹果的样子——那只蜜蜂绕着糖壳飞，她的嘴忘了咬。现在那个嘴巴永远不会咬了。那些苹果永远不会被吃完了。'], transition:'你选择——' }, marginalia:{ text:'这页有水渍。不是我弄的——是上一个读者。也可能是再上一个。这页永远会有水渍。', style:'warning' }, choices:[
      { id:'ch5_r3_a', label:'回家——守在她墓前', description:'战争可以等。蕾梅黛丝不能等——你已经错过了她最后一面，至少不要错过告别。', nextScene:'ch5_r3a', effects:{ tags:['悲痛的丈夫'], fate:2, memory:'糖苹果与墓石', relationshipEffects:{'乌尔苏拉·伊瓜兰':10}, characterFlags:{'returned_for_love':1} }, emotionalCost:'你骑了三天三夜的马——但墓前只有一块白色石头。你不知道该说什么。你放下的糖被蚂蚁搬走了——也许这就是答案', alternativeNarrative:'若你留在前线——你的副官会替你指挥下一场战役。你不知道蕾梅黛丝的墓在地下沉了半寸——但乌尔苏拉知道。她每天都去浇水。她用厨房的水——本来是用来煮汤的。' },
      { id:'ch5_r3_b', label:'留在前线——用战争麻痹自己', description:'回家没有意义——她不在那里了。留在战场上，让自己被硝烟吞没。', nextScene:'ch5_r3b', effects:{ tags:['逃避者'], fate:3, memory:null, relationshipEffects:{'乌尔苏拉·伊瓜兰':-15}, characterFlags:{'fled_from_grief':1} }, emotionalCost:'你打了三十二场仗——但每一场你都在心里留了一小块空白。那块空白是蕾梅黛丝的形状', alternativeNarrative:'若你回去守墓——你会跪在那块白色石头前，膝下的泥土是湿的。你会闻到乌尔苏拉泼的水——它渗进了石头的纹理。你会知道：有些伤口不在皮肤上，在每一次你看见糖苹果的时候。' },
      { id:'ch5_r3_c', label:'写一封信——然后继续战斗', description:'你不能回去，但也不能沉默。写一封信给乌尔苏拉——告诉她蕾梅黛丝的名字不会被忘记。', nextScene:'ch5_r3c', effects:{ tags:['沉默的纪念者'], fate:2, memory:'写给亡妻的信', relationshipEffects:{'乌尔苏拉·伊瓜兰':5}, characterFlags:{'wrote_for_dead':1} }, alternativeNarrative:'若你回去守墓——你会看见乌尔苏拉站在墓旁。她没有哭——她只是蹲下来，用手把石头上的一只蚂蚁轻轻拨开。你那天才知道：她不是在照料坟墓——她是在照料那个永远不会出生的孩子。' }
    ...
    ch5_r4_choice: { id:'ch5_r4_choice', type:'choice', chapter:5, round:4, title:'第四轮选择 · 权力的诱惑', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['你打赢了很多仗。人们开始叫你"上校"——不是官职，是尊称。你走进一个镇子的时候，人们自动让开一条路。你开始收到礼物：一支银柄手枪，一封来自首都的邀请函，一个年轻女人的照片——她的名字不重要。','你感到权力在你体内生长——不是像树，是像藤蔓。它缠绕着你的肋骨，让你每次呼吸都能闻到自己的影响力。它很甜——比糖苹果还甜。但它也在吃掉你。你明白这一点——但你停不下来。'], transition:'你选择——' }, choices:[
      { id:'ch5_r4_a', label:'拥抱权力——成为领袖', description:'你有能力领导——这是上天给你的责任。接受它，成为你需要成为的那个人。', nextScene:'ch5_r4a', effects:{ tags:['权力的拥抱者'], fate:3, memory:null } },
      { id:'ch5_r4_b', label:'拒绝——回到马孔多', description:'你不是为了权力才打仗的。把军装还给战争——回去做小金鱼。', nextScene:'ch5_r4b', effects:{ tags:['归隐者'], fate:1, memory:'被拒绝的银手枪', antiFate:true } },
      { id:'ch5_r4_c', label:'寻找中间道路——为正义而战', description:'权力本身不是目的——用它来改变不公正。但你得小心：正义和权力很少是同一个东西。', nextScene:'ch5_r4c', effects:{ tags:['正义的骑手'], fate:2, memory:null } }
    ...
    ch5_r5_choice: { id:'ch5_r5_choice', type:'choice', chapter:5, round:5, title:'第五轮选择 · 行刑队与不朽', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['你被俘了。不是被敌人——是被你曾经相信的人。他们把你绑在行刑队的墙前。你面前是八个端着枪的年轻士兵——其中有一个看起来像从前的你：眼睛清澈，手指颤抖。','你看着他们。你不怕死——不是因为勇敢，是因为你太累了。但你想起了那块冰。想起了奥雷里亚诺（如果你来自未来）或想起了你自己六岁时伸出的那根手指。你忽然笑了。士兵们面面相觑。你笑不是因为找到了解脱——是因为你终于理解了梅尔基亚德斯的话。'], transition:'你选择——' }, choices:[
      { id:'ch5_r5_a', label:'直视行刑队——拒绝蒙眼', description:'你要睁着眼睛看他们扣下扳机。让他们记住这张脸——它会出现在他们余生每一个梦里。', nextScene:'ch5_r5a', effects:{ tags:['不屈者'], fate:3, memory:'行刑队前的微笑' } },
      { id:'ch5_r5_b', label:'要求最后的请求', description:'你要写最后一封信——给乌尔苏拉。不是道别，是感谢。感谢她在所有夜晚都在桌上摆了碗筷。', nextScene:'ch5_r5b', effects:{ tags:['感恩的告别者'], fate:2, memory:'最后一封信' } },
      { id:'ch5_r5_c', label:'试图逃跑——哪怕失败', description:'你不是坐以待毙的人。哪怕机会渺茫——也要在墙前最后一秒朝左边扑去。', nextScene:'ch5_r5c', effects:{ tags:['至死不屈者'], fate:2, memory:'墙边的弹孔', antiFate:true } }
    ...
    ch5_r6_choice: { id:'ch5_r6_choice', type:'choice', chapter:5, round:6, title:'第六轮选择 · 回家的路', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['战争还没有结束——但你的战争已经结束了。你站在马孔多的路口——往左是栗树和实验室，往右是继续出征的路。你的军装已经旧了，你的手上还残留着火药味，你的心里有一个洞——那个洞曾经装着蕾梅黛丝。','乌尔苏拉站在家门口。她看见你了。她没有跑过来——她只是站在那里，手在围裙上擦了又擦。你离她还有一百步——但你已经闻到汤的味道了。'], transition:'你选择——' }, choices:[
      { id:'ch5_r6_a', label:'走回家——脱下军装', description:'走进院子，把军装挂在门后那副盔甲旁边。坐下喝汤。战争结束了。', nextScene:'ch5_r6a', effects:{ tags:['归乡者'], fate:2, memory:'盔甲旁的军装' } },
      { id:'ch5_r6_b', label:'再次出征——完成使命', description:'你还有未竟之事。告诉乌尔苏拉你还会回来——然后在转身之前不要看她。', nextScene:'ch5_r6b', effects:{ tags:['永不停歇者'], fate:3, memory:null } },
      { id:'ch5_r6_c', label:'站在路口——不知何去何从', description:'你站在原地。风吹过来，带着栗树的气味。你不知道该去哪——也许你永远都不会知道。', nextScene:'ch5_r6c', effects:{ tags:['迷途者'], fate:2, memory:'路口的风', antiFate:true } }
