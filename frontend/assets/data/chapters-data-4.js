...
registerChapter({
  ...
  scenes: {
    ...
    ch11_r1_choice: { id:'ch11_r1_choice', type:'choice', chapter:11, round:1, title:'第一轮选择 · 面对洪水', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['雨下了一个月了。街道变成了河——泥水没过门槛，流进屋子里。鸡淹死了——它们浮在水面上，羽毛湿透，像被遗弃的枕头。','乌尔苏拉站在厨房里——水没过她的脚踝。她还在揉面——仿佛雨不存在。但她的手指在抖——不是因为冷，是因为她知道这场雨不寻常。'], transition:'你选择——' }, choices:[
      { id:'ch11_r1_a', label:'组织救援——加固房子', description:'你不能等雨停。组织家人：堆沙袋，通水渠，把粮食搬到高处。', nextScene:'ch11_r1a', effects:{ tags:['组织者'], memory:null , fate:-1, bond:2, relationshipEffects: { '佩特拉·科特ス': +10 } } },
      { id:'ch11_r1_b', label:'等待——相信雨会停', description:'大雨总会停的。让家人聚在一起——保存体力。雨不会永远下。', nextScene:'ch11_r1b', effects:{ tags:['等待者'], memory:null , fate:1, bond:0, relationshipEffects: { '佩特拉·科特ス': +5 } } },
      { id:'ch11_r1_c', label:'离开——去高处避雨', description:'马孔多会被淹没。带上能带的人——去山上的高地。等雨停了再回来。', nextScene:'ch11_r1c', effects:{ tags:['撤离者'], memory:null , fate:1, bond:-1, relationshipEffects: { '佩特拉·科特ス': -10 } } }
    ...
    ch11_r3_choice: { id:'ch11_r3_choice', type:'choice', chapter:11, round:3, title:'第三轮选择 · 佩特拉与费尔南达', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['奥雷里亚诺第二在两个家之间划着他的小船。佩特拉的房子在低处——已经被水淹了一半。他每天划船去给她送饭——一小袋米，几块干面包。','费尔南达在家里数着剩下的蜡烛——她已经很久没有见到丈夫了。她不说——但她在窗口放了一盏灯。不是为了照亮房间——是为了让他划船回来的时候能看到。'], transition:'你选择——' }, choices:[
      { id:'ch11_r3_a', label:'留在佩特拉身边', description:'在灾难中——他需要她，她也需要他。真正的爱在雨中更清晰。', nextScene:'ch11_r3a', effects:{ tags:['忠诚的爱人'], memory:null, fate:1, bond:1, relationshipEffects: { '佩特拉·科特ス': +15 } } },
      { id:'ch11_r3_b', label:'回到费尔南达身边', description:'她是妻子。灾难面前——家庭的责任比个人情感更重要。', nextScene:'ch11_r3b', effects:{ tags:['尽责的丈夫'], memory:null, fate:-1, bond:2, relationshipEffects: { '佩特拉·科特ス': -10 } } },
      { id:'ch11_r3_c', label:'把两个女人接到一起', description:'不能让任何一个人在雨中独自挨饿。把佩特拉接过来——不管费尔南达怎么想。', nextScene:'ch11_r3c', effects:{ tags:['统一者'], memory:null, fate:1, bond:1, relationshipEffects: { '佩特拉·科特ス': +10 } } },
      { id:'ch11_r3_d', label:'你无法选择——但你不需要选择', description:'佩特拉和费尔南达——她们都是你生命的一部分。不是二选一——是把她们都叫到同一张桌子前。雨还在下——但桌上多摆两副碗筷不会更重。', nextScene:'ch11_r3c', requiredBond: { min: 4 }, effects:{ tags:['摆下更多碗筷的人'], memory:null, fate: 0, bond: 2 } }
    ...
    ch11_r4_choice: { id:'ch11_r4_choice', type:'choice', chapter:11, round:4, title:'第四轮选择 · 牲畜与生存', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['奥雷里亚诺第二的牲口——那些靠着他好胃口而无限繁殖的牛和猪——正在雨水中一匹匹死去。不是因为饿——是因为绝望。它们站在齐膝深的水里，不再吃东西，不再走动，只是站着——等死。','他的财富在溶化。布恩迪亚家曾经靠他的牲口过上好日子——现在那些日子像雨水一样流走了。他看着最后一头牛在雨中倒下去——它的眼睛看着他，像在问：你当初答应过我要照顾好我们的。'], transition:'你选择——' }, choices:[
      { id:'ch11_r4_a', label:'卖掉剩下的牲口', description:'趁它们还活着——换成钱，买粮食。这是理性的选择——哪怕残忍。', nextScene:'ch11_r4a', effects:{ tags:['理性者'], memory:null, fate:1, bond:0, relationshipEffects: { '佩特拉·科特ス': -5 } } },
      { id:'ch11_r4_b', label:'让它们自由——打开栅栏', description:'不卖，不杀。把栅栏打开——让它们自己寻找活路。也许大自然知道该怎么办。', nextScene:'ch11_r4b', effects:{ tags:['慈悲者'], memory:null, fate:0, bond:1, relationshipEffects: { '佩特拉·科特ス': +10 } } },
      { id:'ch11_r4_c', label:'和它们一起等死', description:'它们是他的朋友——不是财产。他不能背叛它们。如果它们要死——至少有人在它们身边。', nextScene:'ch11_r4c', effects:{ tags:['忠诚者'], memory:'最后一头牛的凝视', fate:-1, bond:2, relationshipEffects: { '佩特拉·科特ス': +15 } } }
    ...
    ch11_r5_choice: { id:'ch11_r5_choice', type:'choice', chapter:11, round:5, title:'第五轮选择 · 雨停了', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['雨开始变小了。不是突然停——是像一个人哭累了，从嚎啕变成啜泣，从啜泣变成沉默。最后一滴雨落下来的时候——马孔多已经变了。不是那个你认识的村子了——街道上长满了青苔，房子歪了，栗树还在——但叶子掉光了。','你走出门——阳光刺眼。你已经四年没见过太阳了。你的皮肤苍白如纸——但你能感觉到：空气在变干。土地在呼吸。世界还没有忘记马孔多。'], transition:'你选择——' }, choices:[
      ...
      { id:'ch11_r5_d', label:'佩特拉还站在你身边——和她一起挖第一铲', description:'她没有离开。四年大雨，泥泞，衰败——她都没有离开。不要让她等你开口——牵起她的手，走向那片废墟。第一铲一起挖。', nextScene:'ch11_r5a', requiredRelationship: { character: '佩特拉·科特斯', min: 55 }, effects:{ tags:['一起挖第一铲的人'], memory:null, fate: 0, bond: 2 } }
...
registerChapter({
  ...
  scenes: {
    ...
    ch12_r3_choice: { id:'ch12_r3_choice', type:'choice', chapter:12, round:3, title:'第三轮选择 · 家族的回忆', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['乌尔苏拉坐在她的摇椅上——她开始回忆。不是偶尔想起——是被回忆淹没。她每天在脑海里重走一遍马孔多的街道——不是现在的马孔多，是那个只有二十多间泥巴房的马孔多。','她想起了何塞·阿尔卡蒂奥·布恩迪亚年轻时的脸——狂热，确信，手里攥着两块磁铁。她想起了蕾梅黛丝升天的那个下午。想起了三千人尸体的火车——她从来没见过，但她感觉到了。','她的一生太长了——长到可以装下整整一个世纪的孤独。'], transition:'你选择——' }, choices:[
      ...
      { id:'ch12_r3_d', label:'你埋过一个人——你知道怎么告别', description:'栗树下的普鲁登西奥——你还记得那个坑的深度。那之后这么多年，你学会了埋葬，也学会了放手。说再见不是遗忘。', nextScene:'ch12_r3a', requiredFlag: { flag: 'buried_him', min: 1 }, effects:{ tags:['埋葬过的人'], memory:null, fate: 0, bond: 2 } },
      { id:'ch12_r3_e', label:'你不接受无声的告别——讲述出来', description:'命运要你沉默地离开——但你不是沉默的人。在失明之前——最后一次大声说出那些名字。让他们听见——让房子听见。', nextScene:'ch12_r3a', requiredFate: { max: 2 }, effects:{ tags:['不沉默的告别者'], memory:null, fate: 2, bond: 0 } },
      { id:'ch12_r3_f', label:'你被爱过——也被你爱过的人爱过。把这一切讲出来。', description:'你不需要眼睛也能看见——那些深夜里多摆的碗筷、多留的灯、多等的那几分钟。你被这个家爱过——不是一次，是每一天。讲述这一切——不是为了让他们记住你，是为了让他们知道自己被怎样地爱过。', nextScene:'ch12_r3a', requiredFlag: { flag: 'ursula_cared', min: 4 }, requiredBond: { min: 4 }, effects:{ tags:['被爱定义的灵魂'], memory:null, fate: 0, bond: 2 } }
    ...
    ch12_r4_choice: { id:'ch12_r4_choice', type:'choice', chapter:12, round:4, title:'第四轮选择 · 告别', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['乌尔苏拉知道自己要走了。一百多年的生命——她知道身体什么时候要停下。但她的眼睛是瞎的——她看不见那些围在她床边的人。她的耳朵还在工作——她听见了呼吸声。有些呼吸她认得——有些已经不认得。但它们在——这就够了。','她伸出手——有人在握着。是阿玛兰妲？是梅梅？是费尔南达？她不确定——但那只手是温热的。这让她想起了她第一次握住何塞·阿尔卡蒂奥·布恩迪亚的手——那天她十八岁，穿着白裙子，裙摆沾了泥。'], transition:'你选择——' }, choices:[
      ...
      { id:'ch12_r4_e', label:'你爱过他们每一个人——现在让他们爱你最后一次', description:'你与这个家的羁绊比血还深——你不是在离开他们，你是在把自己变成这所房子的一部分。每一块砖、每一道裂缝、每一个深夜的脚步声——都是你。让他们围在你身边——让他们学会告别。', nextScene:'ch12_r4a', requiredRelationship: { character: '乌尔苏拉·伊瓜兰', min: 85 }, effects:{ tags:['成为房子的人'], memory:null, fate: 0, bond: 2 } }
