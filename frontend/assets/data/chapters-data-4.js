...
registerChapter({
  ...
  scenes: {
    ...
    ch11_r1_choice: { id:'ch11_r1_choice', type:'choice', chapter:11, round:1, title:'第一轮选择 · 面对洪水', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['雨下了一个月了。街道变成了河——泥水没过门槛，流进屋子里。鸡淹死了——它们浮在水面上，羽毛湿透，像被遗弃的枕头。','乌尔苏拉站在厨房里——水没过她的脚踝。她还在揉面——仿佛雨不存在。但她的手指在抖——不是因为冷，是因为她知道这场雨不寻常。'], transition:'你选择——' }, choices:[
      { id:'ch11_r1_a', label:'组织救援——加固房子', description:'你不能等雨停。组织家人：堆沙袋，通水渠，把粮食搬到高处。', nextScene:'ch11_r1a', effects:{ tags:['组织者'], fate:1, memory:null } },
      { id:'ch11_r1_b', label:'等待——相信雨会停', description:'大雨总会停的。让家人聚在一起——保存体力。雨不会永远下。', nextScene:'ch11_r1b', effects:{ tags:['等待者'], fate:1, memory:null } },
      { id:'ch11_r1_c', label:'离开——去高处避雨', description:'马孔多会被淹没。带上能带的人——去山上的高地。等雨停了再回来。', nextScene:'ch11_r1c', effects:{ tags:['撤离者'], fate:2, memory:null } }
    ...
    ch11_r1_settlement: { id:'ch11_r1_settlement', type:'settlement', chapter:11, round:1, title:'第一轮 · 结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['雨还在下。第一个月过去了——然后是第二个月。人们开始忘记太阳的颜色。街道变成了河道——船取代了骡子。马孔多正在变成一片沼泽。']}, settlement:{ summary:'第一轮完成。你面对了四年大雨的开始。', nextScene:'ch11_r2_choice', nextLabel:'进入第二轮' } },
    ...
    ch11_r2_choice: { id:'ch11_r2_choice', type:'choice', chapter:11, round:2, title:'第二轮选择 · 衰败的迹象', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['雨下了一年了。房子开始腐烂——墙壁上长出了蘑菇，木梁上生了白蚁，衣服上全是霉斑。乌尔苏拉每天擦洗——但她擦完一块墙壁，另一块又开始滴水。','费尔南达把自己关在房间里——不是怕湿，是怕看到她祖母留下的家具在霉变。奥雷里亚诺第二不笑了——他的胃口消失了。雨水把一切味道都冲淡了。'], transition:'你选择——' }, choices:[
      { id:'ch11_r2_a', label:'坚持清理——对抗腐坏', description:'每天擦洗，每天修补。腐烂是敌人——你必须和它战斗到最后一刻。', nextScene:'ch11_r2a', effects:{ tags:['不屈者'], fate:2, memory:null } },
      { id:'ch11_r2_b', label:'接受衰败——保存核心', description:'有些东西注定会毁掉。集中精力保护最重要的东西——人和记忆。', nextScene:'ch11_r2b', effects:{ tags:['务实者'], fate:1, memory:null } },
      { id:'ch11_r2_c', label:'寻找雨停的迹象', description:'出去——在雨中寻找任何可能意味着雨要停了的迹象。哪怕只是一线希望。', nextScene:'ch11_r2c', effects:{ tags:['希望寻找者'], fate:1, memory:null } }
    ...
    ch11_r2_settlement: { id:'ch11_r2_settlement', type:'settlement', chapter:11, round:2, title:'第二轮 · 结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['雨下了一年。墙在腐烂，粮食在发霉，希望在一寸一寸地被泡软。但人还在——只要人还在，马孔多就没有彻底沉没。']}, settlement:{ summary:'第二轮完成。你在雨中找到了自己的节奏。', nextScene:'ch11_r3_choice', nextLabel:'进入第三轮' } },
    ...
    ch11_r3_choice: { id:'ch11_r3_choice', type:'choice', chapter:11, round:3, title:'第三轮选择 · 佩特拉与费尔南达', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['奥雷里亚诺第二在两个家之间划着他的小船。佩特拉的房子在低处——已经被水淹了一半。他每天划船去给她送饭——一小袋米，几块干面包。','费尔南达在家里数着剩下的蜡烛——她已经很久没有见到丈夫了。她不说——但她在窗口放了一盏灯。不是为了照亮房间——是为了让他划船回来的时候能看到。'], transition:'你选择——' }, choices:[
      { id:'ch11_r3_a', label:'留在佩特拉身边', description:'在灾难中——他需要她，她也需要他。真正的爱在雨中更清晰。', nextScene:'ch11_r3a', effects:{ tags:['忠诚的爱人'], fate:1, memory:null, antiFate:true } },
      { id:'ch11_r3_b', label:'回到费尔南达身边', description:'她是妻子。灾难面前——家庭的责任比个人情感更重要。', nextScene:'ch11_r3b', effects:{ tags:['尽责的丈夫'], fate:1, memory:null } },
      { id:'ch11_r3_c', label:'把两个女人接到一起', description:'不能让任何一个人在雨中独自挨饿。把佩特拉接过来——不管费尔南达怎么想。', nextScene:'ch11_r3c', effects:{ tags:['统一者'], fate:2, memory:null } }
    ...
    ch11_r3_settlement: { id:'ch11_r3_settlement', type:'settlement', chapter:11, round:3, title:'第三轮 · 结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['雨声里——爱和责任的边界变得模糊。在灾难中，人们不再计较谁对谁错——只计较谁能在一起。']}, settlement:{ summary:'第三轮完成。你在大雨中面对了爱与责任的抉择。', nextScene:'ch11_r4_choice', nextLabel:'进入第四轮' } },
    ...
    ch11_r4_choice: { id:'ch11_r4_choice', type:'choice', chapter:11, round:4, title:'第四轮选择 · 牲畜与生存', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['奥雷里亚诺第二的牲口——那些靠着他好胃口而无限繁殖的牛和猪——正在雨水中一匹匹死去。不是因为饿——是因为绝望。它们站在齐膝深的水里，不再吃东西，不再走动，只是站着——等死。','他的财富在溶化。布恩迪亚家曾经靠他的牲口过上好日子——现在那些日子像雨水一样流走了。他看着最后一头牛在雨中倒下去——它的眼睛看着他，像在问：你当初答应过我要照顾好我们的。'], transition:'你选择——' }, choices:[
      { id:'ch11_r4_a', label:'卖掉剩下的牲口', description:'趁它们还活着——换成钱，买粮食。这是理性的选择——哪怕残忍。', nextScene:'ch11_r4a', effects:{ tags:['理性者'], fate:1, memory:null } },
      { id:'ch11_r4_b', label:'让它们自由——打开栅栏', description:'不卖，不杀。把栅栏打开——让它们自己寻找活路。也许大自然知道该怎么办。', nextScene:'ch11_r4b', effects:{ tags:['慈悲者'], fate:1, memory:null } },
      { id:'ch11_r4_c', label:'和它们一起等死', description:'它们是他的朋友——不是财产。他不能背叛它们。如果它们要死——至少有人在它们身边。', nextScene:'ch11_r4c', effects:{ tags:['忠诚者'], fate:2, memory:'最后一头牛的凝视' } }
    ...
    ch11_r4_settlement: { id:'ch11_r4_settlement', type:'settlement', chapter:11, round:4, title:'第四轮 · 结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['牲口死了——或走了。布恩迪亚家的财富在雨水中溶化。但重要的是：人们还活着。只要人活着——一切都可以重新开始。']}, settlement:{ summary:'第四轮完成。你面对了财富的消逝。', nextScene:'ch11_r5_choice', nextLabel:'进入最终轮' } },
    ...
    ch11_r5_choice: { id:'ch11_r5_choice', type:'choice', chapter:11, round:5, title:'第五轮选择 · 雨停了', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['雨开始变小了。不是突然停——是像一个人哭累了，从嚎啕变成啜泣，从啜泣变成沉默。最后一滴雨落下来的时候——马孔多已经变了。不是那个你认识的村子了——街道上长满了青苔，房子歪了，栗树还在——但叶子掉光了。','你走出门——阳光刺眼。你已经四年没见过太阳了。你的皮肤苍白如纸——但你能感觉到：空气在变干。土地在呼吸。世界还没有忘记马孔多。'], transition:'你选择——' }, choices:[
      { id:'ch11_r5_a', label:'开始重建', description:'拿起铲子——清理淤泥，修复房子，把马孔多从泥泞中拉回来。重建从来不是一个人的事。', nextScene:'ch11_r5a', effects:{ tags:['重建者'], fate:1, memory:null } },
      { id:'ch11_r5_b', label:'跪下——感谢天', description:'你从不信神——但四年雨后你懂了：有些力量比人更大。跪下，不是屈服，是感恩。', nextScene:'ch11_r5b', effects:{ tags:['感恩者'], fate:1, memory:null } },
      { id:'ch11_r5_c', label:'看着废墟——不知道从何开始', description:'太多了——需要做的太多了。你站在原地，不知道第一铲该挖在哪里。', nextScene:'ch11_r5c', effects:{ tags:['茫然者'], fate:2, memory:'四年雨后的阳光' } }
    ...
    ch11_r5_settlement: { id:'ch11_r5_settlement', type:'settlement', chapter:11, round:5, title:'第五轮 · 结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['四年雨停了。马孔多像一个从水中被捞起来的溺水者——苍白的，虚弱的，但还在呼吸。阳光第一次照在湿透的墙壁上——水汽在蒸发，像大地在长叹一口气。']}, settlement:{ summary:'最终轮完成。雨停了——你在废墟中找到了站起来的力气。', nextScene:'chapter11_end', nextLabel:'查看章末结算' } },
    chapter11_end: { id:'chapter11_end', type:'settlement', chapter:11, round:6, title:'第十一章 · 章末结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['第十一章完结。四年大雨过去了——但马孔多永远不会回到以前的样子了。','在废墟中——有一个老人正在失去了她的视力。她是乌尔苏拉。她看不见废墟——但她摸得到。她的手在一寸一寸地数着这个家的伤口。']}, settlement:{ summary:'第十一章完结。大雨冲刷了一切——但有些东西在泥泞中生了根。', isChapterEnd:true, nextLabel:'进入第十二章 · 乌尔苏拉之死' } }
  },
  memories: {
...
registerChapter({
  ...
  scenes: {
    ...
    ch12_r1_choice: { id:'ch12_r1_choice', type:'choice', chapter:12, round:1, title:'第一轮选择 · 失明的力量', leftPage:{ speaker:'乌尔苏拉', speakerColor:'#a52020', paragraphs:['你失明了。但你不告诉任何人。你学会了用耳朵分辨方位，用手指记忆墙壁的每一道裂缝。你假装还能看见——因为你不想让孩子们担心。你不想让他们觉得你变成了需要被照顾的人。','这一天——你听见了走廊里有什么不对劲。一个脚步——很轻，是孩子在哭。你知道是谁——是梅梅。你不需要眼睛就能知道。'], transition:'你选择——' }, choices:[
      { id:'ch12_r1_a', label:'去找她——用你的方式', description:'你不需要眼睛——你需要手臂。摸着墙壁走到她身边，把她搂在怀里。', nextScene:'ch12_r1a', effects:{ tags:['看不见的母亲'], fate:1, memory:null } },
      { id:'ch12_r1_b', label:'假装没听见——让她自己疗愈', description:'有些眼泪需要独处。你知道她在哪——但你选择不过去。不是因为冷漠——是因为信任。', nextScene:'ch12_r1b', effects:{ tags:['沉默的守护者'], fate:1, memory:null } },
      { id:'ch12_r1_c', label:'叫人去帮她', description:'你走不了那么快——但你可以叫阿玛兰妲去。有时候需要让活人能做的事让活人去做。', nextScene:'ch12_r1c', effects:{ tags:['智慧的调度者'], fate:1, memory:null } }
    ...
    ch12_r1_settlement: { id:'ch12_r1_settlement', type:'settlement', chapter:12, round:1, title:'第一轮 · 结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['乌尔苏拉的失明没有让她变得无用——反而让她看得更清楚了。不是用眼睛看——是用一百年的经验去看。她不需要窗户——她心里有一张这所房子的地图。']}, settlement:{ summary:'第一轮完成。盲目的乌尔苏拉比任何明眼人都看得更清。', nextScene:'ch12_r2_choice', nextLabel:'进入第二轮' } },
    ...
    ch12_r2_choice: { id:'ch12_r2_choice', type:'choice', chapter:12, round:2, title:'第二轮选择 · 房子在腐烂', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['大雨过后——房子在腐烂。不是墙壁——是根基。白蚁在木梁里做窝，老鼠在地板下繁殖，蘑菇在各个角落生长。乌尔苏拉能闻到——霉菌、腐朽、死亡的气味。','费尔南达试图维持体面——但她擦不过来。房子太大了——四十多间房，只有几个人住。大多数房间已经很多年没有打开过了。乌尔苏拉想去清理——但她的身体不允许了。'], transition:'你选择——' }, choices:[
      { id:'ch12_r2_a', label:'召集家人——大扫除', description:'这所房子让她亲手扩建起来——不能让它烂掉。召集每一个能动手的人。', nextScene:'ch12_r2a', effects:{ tags:['不屈的家长'], fate:1, memory:null } },
      { id:'ch12_r2_b', label:'封掉没用的房间', description:'既然没人住——就把它们封起来。保存剩下的——放弃已经坏掉的。', nextScene:'ch12_r2b', effects:{ tags:['务实者'], fate:1, memory:null } },
      { id:'ch12_r2_c', label:'接受——房子和人一起老去', description:'她老了，房子也老了。老去不是一个需要被修复的问题——它是一个需要被接受的季节。', nextScene:'ch12_r2c', effects:{ tags:['顺应者'], fate:1, memory:'老房子的呼吸' } }
    ...
    ch12_r2_settlement: { id:'ch12_r2_settlement', type:'settlement', chapter:12, round:2, title:'第二轮 · 结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['房子在衰老——和家人一样。但有乌尔苏拉在——它不会倒。不是因为墙更坚固了，是因为有一个人仍然在每天擦洗同一块地板。']}, settlement:{ summary:'第二轮完成。你选择如何面对房子的衰败。', nextScene:'ch12_r3_choice', nextLabel:'进入第三轮' } },
    ...
    ch12_r3_choice: { id:'ch12_r3_choice', type:'choice', chapter:12, round:3, title:'第三轮选择 · 家族的回忆', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['乌尔苏拉坐在她的摇椅上——她开始回忆。不是偶尔想起——是被回忆淹没。她每天在脑海里重走一遍马孔多的街道——不是现在的马孔多，是那个只有二十多间泥巴房的马孔多。','她想起了何塞·阿尔卡蒂奥·布恩迪亚年轻时的脸——狂热，确信，手里攥着两块磁铁。她想起了蕾梅黛丝升天的那个下午。想起了三千人尸体的火车——她从来没见过，但她感觉到了。','她的一生太长了——长到可以装下整整一个世纪的孤独。'], transition:'你选择——' }, choices:[
      { id:'ch12_r3_a', label:'讲述——把故事传给下一代', description:'让年轻人坐下来——听你讲。不是讲历史，是讲故事。让他们知道他们从哪里来。', nextScene:'ch12_r3a', effects:{ tags:['讲述者'], fate:1, memory:null } },
      { id:'ch12_r3_b', label:'把回忆写下来', description:'你识字不多——但可以让人代笔。把你还记得的事都写下来——留给以后的人。', nextScene:'ch12_r3b', effects:{ tags:['记录者'], fate:1, memory:'摇椅上的口述' } },
      { id:'ch12_r3_c', label:'沉默——把回忆带进坟墓', description:'有些故事只属于亲历者。让它们和你一起离开——不需要被任何人继承。', nextScene:'ch12_r3c', effects:{ tags:['沉默的守护者'], fate:2, memory:null } }
    ...
    ch12_r3_settlement: { id:'ch12_r3_settlement', type:'settlement', chapter:12, round:3, title:'第三轮 · 结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['乌尔苏拉的记忆是这个家族最后的档案。它们不一定准确——但它们是真实的。因为记忆从来不是关于事实的——是关于那些你曾经爱过的人的。']}, settlement:{ summary:'第三轮完成。你选择了家族记忆的去向。', nextScene:'ch12_r4_choice', nextLabel:'进入最终轮' } },
    ...
    ch12_r4_choice: { id:'ch12_r4_choice', type:'choice', chapter:12, round:4, title:'第四轮选择 · 告别', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['乌尔苏拉知道自己要走了。一百多年的生命——她知道身体什么时候要停下。但她的眼睛是瞎的——她看不见那些围在她床边的人。她的耳朵还在工作——她听见了呼吸声。有些呼吸她认得——有些已经不认得。但它们在——这就够了。','她伸出手——有人在握着。是阿玛兰妲？是梅梅？是费尔南达？她不确定——但那只手是温热的。这让她想起了她第一次握住何塞·阿尔卡蒂奥·布恩迪亚的手——那天她十八岁，穿着白裙子，裙摆沾了泥。'], transition:'你选择——' }, choices:[
      { id:'ch12_r4_a', label:'说再见——叫每个人的名字', description:'用最后的力气，一个一个地叫出他们的名字。让他们知道你记得每一个人。', nextScene:'ch12_r4a', effects:{ tags:['完整的告别'], fate:2, memory:'最后的点名' } },
      { id:'ch12_r4_b', label:'安静离开——不要惊动任何人', description:'你不想让他们看见这一刻。在睡梦中慢慢松开手——让他们在你走了之后才发现。', nextScene:'ch12_r4b', effects:{ tags:['安静的告别'], fate:1, memory:null } },
      { id:'ch12_r4_c', label:'说一句——然后把空间留给他们', description:'只说一句——"吃饭了。"——然后闭上眼睛。让他们记住你在喊他们吃饭的样子。', nextScene:'ch12_r4c', effects:{ tags:['日常的告别'], fate:2, memory:'最后的晚饭' } }
    ...
    ch12_r4_settlement: { id:'ch12_r4_settlement', type:'settlement', chapter:12, round:4, title:'最终轮 · 结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['乌尔苏拉·伊瓜兰——布恩迪亚家族的基石，马孔多的母亲——离开了。她活了一百多年——比她的丈夫、她的儿女、她的孙辈都久。她看过建村，看过战争，看过大雨，看过一切——然后用她自己的方式说了再见。','厨房空了。没有人在揉面。但火还没有灭——她走的时候把最后一把柴塞进了炉膛里。']}, settlement:{ summary:'最终轮完成。乌尔苏拉走了——她以她选择的方式告别了这个世界。', nextScene:'chapter12_end', nextLabel:'查看章末结算' } },
    chapter12_end: { id:'chapter12_end', type:'settlement', chapter:12, round:5, title:'第十二章 · 章末结算', leftPage:{ speaker:null, speakerColor:null, paragraphs:['第十二章完结。乌尔苏拉不在了——这个家失去了它最后的一根柱子。','走廊空了。但在走廊尽头——一只黄色的蝴蝶正扇动着翅膀。它代表着一个新的爱情故事——梅梅的故事。']}, settlement:{ summary:'第十二章完结。乌尔苏拉的离世标志着一个时代的结束。', isChapterEnd:true, nextLabel:'进入第十三章 · 梅梅与黄蝴蝶' } }
  },
  memories: {
