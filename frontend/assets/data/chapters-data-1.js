      ...
      choices: [
        {
          ...
          effects: { tags: ['执着勘探者'], memory: null, relationshipEffects: { '乌尔苏拉·伊瓜兰': -10, '梅尔基亚德斯': 5 }, characterFlags: { 'obsession_path': 1 } },
        ...
        },
        {
          ...
          effects: { tags: ['家庭的守望者'], memory: null, relationshipEffects: { '乌尔苏拉·伊瓜兰': 15, '梅尔基亚德斯': -5 }, characterFlags: { 'ursula_cared': 1 } },
        ...
        },
        {
          ...
          effects: { tags: ['精明的妥协者'], memory: null, relationshipEffects: { '乌尔苏拉·伊瓜兰': 5, '梅尔基亚德斯': -10 }, characterFlags: { 'anti_fate_choice': 1 } },
      ...
      choices: [
        {
          ...
          effects: { tags: ['科学与牺牲'], memory: null, relationshipEffects: { '乌尔苏拉·伊瓜兰': -15 }, characterFlags: { 'betrayed_ursula_trust': 1 } },
        ...
        },
        {
          ...
          effects: { tags: ['代价与收获', '失去面容的人'], memory: null, relationshipEffects: { '梅尔基亚德斯': 10 }, characterFlags: { 'paid_with_memory': 1 } },
        ...
        },
        {
          ...
          effects: { tags: ['清醒的狂热者'], memory: null, relationshipEffects: { '乌尔苏拉·伊瓜兰': 10 }, characterFlags: { 'ursula_cared': 1 } },
      ...
      choices: [
        {
          ...
          effects: { tags: ['冰块的导师'], memory: null, relationshipEffects: { '奥雷里亚诺·布恩迪亚': 15, '何塞·阿尔卡蒂奥': -5 }, characterFlags: { 'showed_ice': 1 } },
        ...
        },
        {
          ...
          effects: { tags: ['命运的揭示者'], memory: null, relationshipEffects: { '奥雷里亚诺·布恩迪亚': 5, '庇拉尔·特尔内拉': 10 }, characterFlags: { 'heard_prophecy': 1 } },
        ...
        },
        {
          ...
          effects: { tags: ['观看者'], memory: null, relationshipEffects: { '何塞·阿尔卡蒂奥': 10, '奥雷里亚诺·布恩迪亚': 5 } },
      ...
      choices: [
        {
          ...
          effects: { tags: ['远行者'], memory: '不是海的海', relationshipEffects: { '乌尔苏拉·伊瓜兰': -20 }, characterFlags: { 'left_alone': 1 } },
        ...
        },
        {
          ...
          effects: { tags: ['同行者'], memory: '一只手', relationshipEffects: { '乌尔苏拉·伊瓜兰': 10, '何塞·阿尔卡蒂奥': 5, '奥雷里亚诺·布恩迪亚': 5 }, characterFlags: { 'ursula_cared': 1, 'family_together': 1 } },
        ...
        },
        {
          ...
          effects: { tags: ['造梦者'], memory: '泥土中的马孔多', relationshipEffects: { '乌尔苏拉·伊瓜兰': 5 }, characterFlags: { 'built_city': 1, 'anti_fate_choice': 1 } },
