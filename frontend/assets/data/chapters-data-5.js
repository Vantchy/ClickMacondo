...
registerChapter({
  ...
  scenes: {
    ...
    ch13_r1_choice: { id:'ch13_r1_choice', type:'choice', chapter:13, round:1, title:'第一轮选择 · 蝴蝶之约', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['马乌里肖·巴比伦——香蕉公司机械师的学徒。他身上总有机油味——和蝴蝶。黄色的蝴蝶总是跟着他——像他是一朵移动的花。','他约你去电影院——不是马孔多的电影院（马孔多没有），是省城的。你母亲费尔南达决不会允许——但你不是你母亲。'], transition:'你选择——' }, choices:[
      { id:'ch13_r1_a', label:'偷偷去——不让母亲知道', description:'爱情不需要许可。翻窗，穿过花园——让他带你去。蝴蝶会为你们开路。', nextScene:'ch13_r1a', effects:{ tags:['偷偷恋爱者'], memory:null } },
      { id:'ch13_r1_b', label:'告诉母亲——争取她的理解', description:'你不是离家出走——你是去爱。告诉费尔南达——也许她会理解。也许她不会。', nextScene:'ch13_r1b', effects:{ tags:['坦诚者'], memory:null } },
      { id:'ch13_r1_c', label:'拒绝——保持安全的距离', description:'他是香蕉公司的工人——你母亲永远不会接受。趁还没有陷得太深——停下来。', nextScene:'ch13_r1c', effects:{ tags:['自制者'], memory:'未赴的约',} }
    ...
    ch13_r2_choice: { id:'ch13_r2_choice', type:'choice', chapter:13, round:2, title:'第二轮选择 · 费尔南达的愤怒', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['费尔南达发现了——不是蝴蝶，是电影院的门票。她在梅梅的口袋里找到了一张撕了一半的电影票。她拿着票在桌子上质问梅梅——票在发抖，不是因为她的手在抖，是因为她的整个世界观都被这半张纸撕碎了。','"你和一个工人——出去？"这不是问句。这是判决。费尔南达在她的人生剧本里——梅梅要嫁给贵族，要住在省城，要在教堂里举办婚礼。马乌里肖·巴比伦——这个满手机油的男人——不在剧本里。'], transition:'你选择——' }, choices:[
      { id:'ch13_r2_a', label:'反抗——维护你的爱', description:'站在母亲面前，告诉她：你爱他。不管她同不同意——你已经决定了。', nextScene:'ch13_r2a', effects:{ tags:['反抗的女儿'], memory:null } },
      { id:'ch13_r2_b', label:'低头——但暗地继续', description:'表面上服从——让母亲以为你放弃了。但暗地里继续见他。用更巧妙的方式。', nextScene:'ch13_r2b', effects:{ tags:['伪装者'], memory:null } },
      { id:'ch13_r2_c', label:'妥协——和他约定将来', description:'现在时机不对——但可以等。和马乌里肖约定：等时机成熟再在一起。', nextScene:'ch13_r2c', effects:{ tags:['耐心的爱人'], memory:null } }
    ...
    ch13_r3_choice: { id:'ch13_r3_choice', type:'choice', chapter:13, round:3, title:'第三轮选择 · 夜间的幽会', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['深夜。黄蝴蝶在后院的棕榈树下聚集——它们的光芒在黑暗中像摇动的烛火。马乌里肖在等你。他每天都来——不管下雨还是晴天。他已经等了很久。','费尔南达不知道——但她感觉到了。她今天在后院的草丛里发现了汽油的痕迹。她让人在后院放了岗哨——门房每晚都守着。但马乌里肖有他的途径——他翻墙，爬树，避开一切障碍——只为见你几分钟。'], transition:'你选择——' }, choices:[
      { id:'ch13_r3_a', label:'继续——每晚见他', description:'费尔南达的岗哨挡不住爱情。每天晚上——在后院，在蝴蝶的掩护下。', nextScene:'ch13_r3a', effects:{ tags:['不悔的爱人'], memory:null } },
      { id:'ch13_r3_b', label:'减少频率——更谨慎', description:'现在太危险了。减少见面——但每次见面都更珍贵。让他知道你不是不爱——是更爱。', nextScene:'ch13_r3b', effects:{ tags:['谨慎的爱人'], memory:null } },
      { id:'ch13_r3_c', label:'一起去省城——私奔', description:'马孔多容不下这个爱情。和他一起离开——去一个没有岗哨和蝴蝶也要重新开始的地方。', nextScene:'ch13_r3c', effects:{ tags:['私奔者'], memory:null } }
    ...
    ch13_r4_choice: { id:'ch13_r4_choice', type:'choice', chapter:13, round:4, title:'第四轮选择 · 费尔南达的报复', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['费尔南达的报复来得很快。她不是自己去做的——她叫来了警察。在后院——在那个你每晚和马乌里肖约会的地方——枪响了。不是杀人的枪——是射向天花的枪。但子弹打破的不只是空气——是你的世界。','马乌里肖倒在地上——子弹打中了他的脊椎。他没有死——但他再也站不起来了。费尔南达把他送到了遥远的医院——她付了钱，条件是他永远不回来。蝴蝶消失了——不是一只一只，是同时全部消失。空气里只剩下汽油味。'], transition:'你选择——' }, choices:[
      { id:'ch13_r4_a', label:'去他的医院——陪着他', description:'马乌里肖需要你。不管费尔南达怎么想——你要去陪着他直到他站起来。', nextScene:'ch13_r4a', effects:{ tags:['忠诚的爱人'], memory:null } },
      { id:'ch13_r4_b', label:'留在家——但永不忘恨', description:'你不能去——但你会记住。在你的心里为费尔南达建一座坟。', nextScene:'ch13_r4b', effects:{ tags:['怀恨者'], memory:null } },
      { id:'ch13_r4_c', label:'把自己关起来——不说话', description:'你不去任何地方——也不说任何话。用沉默建造一座监狱——把自己和世界隔开。', nextScene:'ch13_r4c', effects:{ tags:['沉默的囚徒'], memory:'沉默的监狱' } }
    ...
    ch13_r5_choice: { id:'ch13_r5_choice', type:'choice', chapter:13, round:5, title:'第五轮选择 · 修道院', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['费尔南达决定把梅梅送走——送到远方的修道院。"让你在那里学会规矩。"她说。这不是建议——是命令。梅梅的行李已经打包好了——两件裙子，一本圣经，一张马乌里肖的照片（藏在内衬里）。','费尔南达站在门口——她的脸像石像一样。梅梅看着她——这对母女之间已经没有任何东西可以说的了。所有的话都被那声枪响说完了。'], transition:'你选择——' }, choices:[
      { id:'ch13_r5_a', label:'顺从——但带着他的记忆', description:'去修道院——但在心里藏好马乌里肖的照片和你们的每一个夜晚。费尔南达可以决定你住哪——不能决定你是谁。', nextScene:'ch13_r5a', effects:{ tags:['带着爱的囚徒'], memory:'藏起照片的行李' } },
      { id:'ch13_r5_b', label:'最后一次反抗——拒绝上车', description:'你已经没有什么可以失去的了。站在门口——不上去。让全世界都看见费尔南达的女儿不服从。', nextScene:'ch13_r5b', effects:{ tags:['最后的反抗者'], memory:null } },
      { id:'ch13_r5_c', label:'走——但发誓有一天回来', description:'现在走吧——让费尔南达以为她赢了。但你在心里刻下一个誓言：有一天你会回来。不是为了她——是为了自己。', nextScene:'ch13_r5c', effects:{ tags:['带着誓言的流放者'], memory:null } }
...
registerChapter({
  ...
  scenes: {
    ...
    ch14_r1_choice: { id:'ch14_r1_choice', type:'choice', chapter:14, round:1, title:'第一轮选择 · 最后的工人', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['香蕉公司已经撤走了——但有几个工人留了下来。他们住在废弃的工棚里——没有工资，没有食物，没有未来。他们来找你——何塞·阿尔卡蒂奥第二，老罢工领袖。"我们该怎么办？"','你看着他们——他们的脸上还有那场屠杀的阴影。你也不知道该怎么办。但你至少可以告诉他们一件事。'], transition:'你选择——' }, choices:[
      { id:'ch14_r1_a', label:'组织他们——要求赔偿', description:'不能就这样算了。帮他们组织起来——向政府和公司要求应得的赔偿。', nextScene:'ch14_r1a', effects:{ tags:['不倦的组织者'], memory:null } },
      { id:'ch14_r1_b', label:'告诉他们真相——至少让他们知道', description:'也许拿不到赔偿——但至少他们应该知道发生了什么。讲给他们听。', nextScene:'ch14_r1b', effects:{ tags:['真相传递者'], memory:null } },
      { id:'ch14_r1_c', label:'劝他们离开——保护性命', description:'继续斗下去只会死更多人。劝他们离开马孔多——去别的地方重新开始。', nextScene:'ch14_r1c', effects:{ tags:['保护者'], memory:null } }
    ...
    ch14_r2_choice: { id:'ch14_r2_choice', type:'choice', chapter:14, round:2, title:'第二轮选择 · 记忆的孤独', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['马孔多的人不再谈论香蕉公司——也不再谈论那三千人。不是因为他们忘记了——是因为他们累了。他们想要生活继续——哪怕继续意味着假装什么都没发生。','只有你还在说。你在广场上、在市场上、在教堂门口——告诉大家真相。他们绕着你走——不是他们恨你，是他们害怕：如果承认你对了，他们这些年沉默的罪也就坐实了。'], transition:'你选择——' }, choices:[
      { id:'ch14_r2_a', label:'继续讲述——哪怕被人当成疯子', description:'真相比你自己的名声更重要。继续讲——哪怕全世界都说你疯了。', nextScene:'ch14_r2a', effects:{ tags:['不屈的见证者'], memory:null } },
      { id:'ch14_r2_b', label:'退一步——改用写作', description:'说话没人听——那就写。写下真相，藏起来，留给后人。语言的寿命比人长。', nextScene:'ch14_r2b', effects:{ tags:['转向文字者'], memory:'被封存的真相' } },
      { id:'ch14_r2_c', label:'放弃——接受遗忘', description:'你累了。也许遗忘是人类学会的最痛但也是最有用的技能。放弃讲述——让风把它带走。', nextScene:'ch14_r2c', effects:{ tags:['疲倦的放弃者'], memory:null,} }
    ...
    ch14_r3_choice: { id:'ch14_r3_choice', type:'choice', chapter:14, round:3, title:'第三轮选择 · 秘密继承人', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['一个婴儿被送到了布恩迪亚家门口。没有人知道是谁送的——但你知道。这是梅梅的孩子——马乌里肖·巴比伦的儿子。费尔南达把他藏了起来——不让他知道自己的出身。','你看见这个男孩在走廊里爬——他的眼睛像梅梅，嘴巴像马乌里肖。但他不会知道自己是谁——费尔南达会确保这一点。她把他锁在房子里——不让他上学，不让他和其他孩子玩。她说他是"捡来的"。'], transition:'你选择——' }, choices:[
      { id:'ch14_r3_a', label:'告诉他真相——将来', description:'现在他太小了。但等他长大了——你要告诉他他是谁。他是布恩迪亚——不是捡来的。', nextScene:'ch14_r3a', effects:{ tags:['真相的守护者'], memory:null } },
      { id:'ch14_r3_b', label:'服从费尔南达——保持沉默', description:'费尔南达有她的理由——也许不知道比被遗弃更幸福。让他安静长大——没有标签和恩怨。', nextScene:'ch14_r3b', effects:{ tags:['沉默的顺从者'], memory:null } },
      { id:'ch14_r3_c', label:'偷偷给他留下线索', description:'你不能直接说——但你可以留一些东西。一封信，一件物——让他在你的记事中发现自己的真相。', nextScene:'ch14_r3c', effects:{ tags:['线索的埋藏者'], memory:'留给男孩的信' } }
    ...
    ch14_r4_choice: { id:'ch14_r4_choice', type:'choice', chapter:14, round:4, title:'第四轮选择 · 官方记忆的抹除', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['来了一队政府官员——带着笔和墨，带着新的教科书。他们逐家逐户地"更正"历史。香蕉公司？从来没有雇过超过一百人。屠杀？纯粹是工人之间的小冲突——没有死人。','你是何塞·阿尔卡蒂奥第二。你是唯一还剩下来的见证者。你被叫去"纠正"——被文明地威胁：如果你再说话，你会被送进精神病院。'], transition:'你选择——' }, choices:[
      { id:'ch14_r4_a', label:'拒绝签字——继续抗争', description:'不签。让他们把你送去精神病院——那里的墙挡不住真话。', nextScene:'ch14_r4a', effects:{ tags:['不屈服者'], memory:null } },
      { id:'ch14_r4_b', label:'假意配合——暗地记录', description:'表面签字——但他们不注意的时候，把真相藏在不会被发现的地方。', nextScene:'ch14_r4b', effects:{ tags:['地下记录者'], memory:null } },
      { id:'ch14_r4_c', label:'签字——但留下你的故事在别处', description:'在官方文件上签字——但在此之前，你已经把真实留在了梅尔基亚德斯的房间里。让他们擦掉纸上的字——擦不掉房间里的。', nextScene:'ch14_r4c', effects:{ tags:['双面者'], memory:null } }
    ...
    ch14_r5_choice: { id:'ch14_r5_choice', type:'choice', chapter:14, round:5, title:'第五轮选择 · 告别梅尔基亚德斯的房间', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['你很老了。你坐在梅尔基亚德斯的房间里——这间时间不会流逝的房间。窗外马孔多正在缓慢地腐烂——墙壁上爬满了苔藓，栗树的叶子掉光了，走廊里已经很久没有人走动了。','但你不在了——你还在这里。你是最后的见证者。你把手放在羊皮卷上——它们很冷，像冰块。你感觉到了什么——一种召唤。像是梅尔基亚德斯在说些什么，用一种你不需要学就已经懂了的语言。'], transition:'你选择——' }, choices:[
      { id:'ch14_r5_a', label:'留在房间里——直到最后一刻', description:'这间房间保护了你一辈子。在这里闭上眼睛——让羊皮卷做你的裹尸布。', nextScene:'ch14_r5a', effects:{ tags:['忠诚的守护者'], memory:'房间里的最后一眼' } },
      { id:'ch14_r5_b', label:'走出去——最后一次讲述', description:'在生命的尽头，离开这间房间——到广场上去，最后一次告诉人们真相。', nextScene:'ch14_r5b', effects:{ tags:['最后的呐喊者'], memory:null } },
      { id:'ch14_r5_c', label:'把钥匙交给那个男孩', description:'你应该让梅梅的儿子继承这间房间。把钥匙给他——让他自己找到这里。', nextScene:'ch14_r5c', effects:{ tags:['传递者'], memory:'传递的钥匙' } }
...
registerChapter({
  ...
  scenes: {
    ...
    ch15_r1_choice: { id:'ch15_r1_choice', type:'choice', chapter:15, round:1, title:'第一轮选择 · 被锁住的童年', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['你在这所房子里长大——但你从来没有出过门。费尔南达说外面很危险——但你偷看窗外的时候，看见孩子们在街上奔跑。你不明白：为什么他们可以，你不行？','你在走廊里独自玩耍——你发现了很多奇怪的东西：栗树下被绑着的老人，厨房里揉面的百岁盲女，还有一间奇怪的房间——它的门总是锁着。'], transition:'你选择——' }, choices:[
      { id:'ch15_r1_a', label:'顺从——在房子里寻找秘密', description:'你不出门——但你在房子里探索每一个角落，每一本旧书，每一个锁着的房间。', nextScene:'ch15_r1a', effects:{ tags:['内向的探索者'], memory:null } },
      { id:'ch15_r1_b', label:'反抗——偷跑出去', description:'费尔南达不让你出去——但你是布恩迪亚。翻墙！去街上看看真正的世界。', nextScene:'ch15_r1b', effects:{ tags:['私自出逃者'], memory:null } },
      { id:'ch15_r1_c', label:'向费尔南达提问——我是谁', description:'你不想偷跑，不想到处寻找——你想直接问她。"我是谁？为什么我不能出去？"', nextScene:'ch15_r1c', effects:{ tags:['质疑者'], memory:null } }
    ...
    ch15_r2_choice: { id:'ch15_r2_choice', type:'choice', chapter:15, round:2, title:'第二轮选择 · 发现羊皮卷', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['你发现那扇门没有锁。也许是一直没锁——也许是你长到足够大时它自己开了。你走进去——这间房间不像家里的其他地方。这里没有灰尘——没有霉斑——时间在这里不流动。','书架上放满了书——古老的、用一种你不认识的语言写的书。桌上有一叠羊皮纸——上面的字迹很密，每一个字符都像在微微颤动。你不认识这种语言——但你被它吸引。它像磁铁一样拉着你。'], transition:'你选择——' }, choices:[
      { id:'ch15_r2_a', label:'每天来——尝试破译', description:'你不需要老师——羊皮卷本身就是老师。每天来这里，一个字一个字地学。', nextScene:'ch15_r2a', effects:{ tags:['自学者'], memory:null } },
      { id:'ch15_r2_b', label:'找何塞·阿尔卡蒂奥第二帮助', description:'他是唯一在这间房间里待过的人。去问他——这些羊皮卷是什么意思？', nextScene:'ch15_r2b', effects:{ tags:['求助者'], memory:null } },
      { id:'ch15_r2_c', label:'把羊皮卷放回原处——时候未到', description:'你感觉自己还没准备好。这些字看起来太古老、太重要了——不该由你来碰。再等等。', nextScene:'ch15_r2c', effects:{ tags:['敬畏者'], memory:null } }
    ...
    ch15_r3_choice: { id:'ch15_r3_choice', type:'choice', chapter:15, round:3, title:'第三轮选择 · 费尔南达的衰老', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['费尔南达老了。她的声音不再那样咄咄逼人——她开始忘记东西。她有时叫你"陌生人"，有时叫你"梅梅"。她的眼睛不再看人——她只是盯着窗外——窗帘永远拉着。','你看着她——这个把你锁了一辈子的女人。你现在比她还高了——你可以轻易推开她走出那扇门。但你没有——不是因为怕她，是因为某种更复杂的东西：她喂养了你，尽管是以她不懂的方式。'], transition:'你选择——' }, choices:[
      { id:'ch15_r3_a', label:'原谅她——照顾她的晚年', description:'她做了她以为正确的事。现在她老了——她需要有人帮她端水、吃药、换床单。', nextScene:'ch15_r3a', effects:{ tags:['宽恕者'], memory:null } },
      { id:'ch15_r3_b', label:'离开她——找回自己的生活', description:'你不欠她的。你被她锁了太多年——现在该轮到你了。走出这所房子——去世界看看。', nextScene:'ch15_r3b', effects:{ tags:['解放者'], memory:null,} },
      { id:'ch15_r3_c', label:'留下来——但不再顺从', description:'你照顾她——以你自己的方式。不是仆人，是监护者。你来决定规则——不再是她。', nextScene:'ch15_r3c', effects:{ tags:['成熟的监护者'], memory:null } }
    ...
    ch15_r4_choice: { id:'ch15_r4_choice', type:'choice', chapter:15, round:4, title:'第四轮选择 · 你是谁', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['你破译了羊皮卷的第一行字。你的手在抖——不是因为难，是因为你读懂了。那行字写的是：","家族的第一个人被捆在一棵树上，最后一个人正被蚂蚁吃掉。","你停下笔——你需要想一想。这行字说的是谁？被绑在树上的是栗树下的老人。被蚂蚁吃掉的是——你不敢往下想。','但你还需要知道：你是谁。你在这卷羊皮纸里——是什么角色？是旁观者？是继承者？是最后的布恩迪亚？'], transition:'你选择——' }, choices:[
      { id:'ch15_r4_a', label:'继续翻译——快速寻找答案', description:'不能停下——继续读。用最快的速度破译羊皮卷——答案就在其中。', nextScene:'ch15_r4a', effects:{ tags:['急切者'], memory:null } },
      { id:'ch15_r4_b', label:'慢慢来——怕读到结局', description:'你预感结局不会美好。慢慢读——让每一个字都被消化掉，不要一次太快地走到终点。', nextScene:'ch15_r4b', effects:{ tags:['谨慎者'], memory:null } },
      { id:'ch15_r4_c', label:'停下来——去院子里走走', description:'你感到窒息。放下笔——走出去，到栗树下呼吸一下空气。你不需要今天就找到答案。', nextScene:'ch15_r4c', effects:{ tags:['暂停者'], memory:null,} }
...
registerChapter({
  ...
  scenes: {
    ...
    ch16_r1_choice: { id:'ch16_r1_choice', type:'choice', chapter:16, round:1, title:'第一轮选择 · 初见', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['她看着你——你看着羊皮卷。她走进那间时间不会流逝的房间——"你是谁？"你抬头——她的眼睛像另一个布恩迪亚，但你不知道像谁。','加斯通站在门口——他看起来不太确定自己为什么在这里。阿玛兰妲·乌尔苏拉说要回来重建家园——但他看见的是一片废墟。','但你不关心加斯通。你关心的是：这个女人的眼睛——为什么你在羊皮卷里读到过它们？'], transition:'你选择——' }, choices:[
      { id:'ch16_r1_a', label:'告诉她羊皮卷的秘密', description:'她是布恩迪亚——她有权知道。把你正在翻译的事告诉她。', nextScene:'ch16_r1a', effects:{ tags:['坦诚的守护者'], memory:null } },
      { id:'ch16_r1_b', label:'保持距离——观察她', description:'你不了解她。让她先证明自己——然后再决定可以告诉她多少。', nextScene:'ch16_r1b', effects:{ tags:['谨慎者'], memory:null } },
      { id:'ch16_r1_c', label:'欢迎她——帮忙重建', description:'她回来修复这所房子——你可以帮忙。在共同劳作中慢慢认识彼此。', nextScene:'ch16_r1c', effects:{ tags:['合作者'], memory:null } }
    ...
    ch16_r2_choice: { id:'ch16_r2_choice', type:'choice', chapter:16, round:2, title:'第二轮选择 · 加斯通的离开', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['加斯通感觉到了——他的妻子正在远离他。不是出轨——是更深的：她的心已经在马孔多生了根。他提议回去——"欧洲有你的诊所，你的生活。"她犹豫了。','他最后说服她尝试——用一封航空信。他订了机票——但信上没有写日期。他知道自己在赌。'], transition:'你选择——' }, choices:[
      { id:'ch16_r2_a', label:'劝她留下', description:'不要让她走——马孔多需要她，羊皮卷需要她。有些话如果现在不说——就永远没机会了。', nextScene:'ch16_r2a', effects:{ tags:['挽留者'], memory:null } },
      { id:'ch16_r2_b', label:'不干涉——让她自己选', description:'婚姻是她的——去留也是她的。你不能替她做这个决定。', nextScene:'ch16_r2b', effects:{ tags:['尊重者'], memory:null } },
      { id:'ch16_r2_c', label:'告诉加斯通真相', description:'她正在爱上马孔多——或许不止马孔多。让加斯通知道——他的心虽然会碎，但比被骗好。', nextScene:'ch16_r2c', effects:{ tags:['诚实者'], memory:null } }
    ...
    ch16_r3_choice: { id:'ch16_r3_choice', type:'choice', chapter:16, round:3, title:'第三轮选择 · 接近', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['加斯通走了以后——房子里只剩下你们两个人。（还有栗树下的老人——但他不算数了。）','你们白天一起修房子——晚上一起读羊皮卷。她的头发在烛光下是暗金色的。她翻译拉丁文的速度比你还快——因为她在欧洲学过。但她的笑声是你没有听过的——在这个古老的房间里，笑声听起来像一种会被禁用的语言。'], transition:'你选择——' }, choices:[
      { id:'ch16_r3_a', label:'吻她', description:'你不想再等了。烛光、羊皮卷、她的头发——这些信号不需要翻译。', nextScene:'ch16_r3a', effects:{ tags:['勇敢的爱人'], memory:null } },
      { id:'ch16_r3_b', label:'等待——保持友谊', description:'太快了。她刚送走丈夫——你需要给她时间。哪怕你的心已经在你的舌头上跳动了。', nextScene:'ch16_r3b', effects:{ tags:['克制的爱人'], memory:null } },
      { id:'ch16_r3_c', label:'用羊皮卷表达', description:'你不会说话——但你会在羊皮卷的翻译边缘写下一行小字：你在这里。在所有的名字里——你在读的这一页里。', nextScene:'ch16_r3c', effects:{ tags:['以笔代口者'], memory:'羊皮卷边缘的情书' } }
    ...
    ch16_r4_choice: { id:'ch16_r4_choice', type:'choice', chapter:16, round:4, title:'第四轮选择 · 重建家园', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['阿玛兰妲·乌尔苏拉看着这所房子——腐烂、破败、几乎要倒。但她看见的不是废墟——她看见的是她的童年，是乌尔苏拉的厨房，是走廊里的阳光。','她说："我们要重建它。"不是疑问句——是布恩迪亚式的决定。她拿出了她在欧洲赚的钱——不多，但足够。'], transition:'你选择——' }, choices:[
      { id:'ch16_r4_a', label:'全力帮忙重建', description:'和她一起——修墙、换梁、种花。让这所房子重新活过来。', nextScene:'ch16_r4a', effects:{ tags:['重建者'], memory:null } },
      { id:'ch16_r4_b', label:'保护羊皮卷——不让重建打扰', description:'房子可以修——但羊皮卷不能被干扰。划定区域——梅尔基亚德斯的房间不能动。', nextScene:'ch16_r4b', effects:{ tags:['保护者'], memory:null } },
      { id:'ch16_r4_c', label:'反对——房子不值得修', description:'马孔多已经死了。与其修房子——不如离开这里，去一个新地方重新开始。', nextScene:'ch16_r4c', effects:{ tags:['现实主义者'], memory:null } }
    ...
    ch16_r5_choice: { id:'ch16_r5_choice', type:'choice', chapter:16, round:5, title:'第五轮选择 · 承认', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['一天晚上——她在走廊上等你。她没有说话——只是站着。她的影子被月光拉得很长——一直延伸到你的脚边。','你知道她要说什么——你心里一直都知道。这不是可以被永远推迟的问题。你们擦过了肩膀太多次，在烛光下对视了太久。现在这一刻来了——你需要说出那三个字。或不说。'], transition:'你选择——' }, choices:[
      { id:'ch16_r5_a', label:'说"我爱你"', description:'说出来——不要再逃避。这是禁忌，但她不是你的姐妹——她是你的曾曾祖母的曾曾孙女。隔了太多代人。', nextScene:'ch16_r5a', effects:{ tags:['告白者'], memory:'走廊上的告白' } },
      { id:'ch16_r5_b', label:'用行动——而不是语言', description:'不说——但握住她的手。让她感觉到你的手指在说话——不需要翻译。', nextScene:'ch16_r5b', effects:{ tags:['沉默的恋人'], memory:null } },
      { id:'ch16_r5_c', label:'说不——尽管爱', description:'你知道这不对。哪怕隔了那么多代——你们还是布恩迪亚。拒绝她——不是因为不爱，是因为太爱。', nextScene:'ch16_r5c', effects:{ tags:['自我牺牲者'], memory:'被拒绝的走廊',} }
...
registerChapter({
  ...
  scenes: {
    ...
    ch17_r1_choice: { id:'ch17_r1_choice', type:'choice', chapter:17, round:1, title:'第一轮选择 · 确认关系', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['你们已经在一起了——那种比任何婚姻都更牢固的、被羊皮卷预言绑定的在一起。但费尔南达说过的话还在走廊里回响："这个家族会被诅咒——如果布恩迪亚和布恩迪亚之间有了孩子。"','阿玛兰妲·乌尔苏拉不怕——她是欧洲回来的，不信古老的诅咒。但你——你每一天都在羊皮卷里读到越来越近的结局。你开始害怕——不是怕诅咒，是怕预言。'], transition:'你选择——' }, choices:[
      { id:'ch17_r1_a', label:'拥抱爱情——不管预言', description:'羊皮卷写的是过去——不是命令。你们可以选择自己的未来。继续爱她——不怕一切。', nextScene:'ch17_r1a', effects:{ tags:['无畏的爱人'], memory:null } },
      { id:'ch17_r1_b', label:'克制——避免孩子', description:'你们可以在一起——但不要让预言实现。不要让布恩迪亚和布恩迪亚的孩子出生。', nextScene:'ch17_r1b', effects:{ tags:['谨慎的爱人'], memory:null } },
      { id:'ch17_r1_c', label:'停止翻译——不去看结局', description:'也许不知道结局就可以不被它影响。放下羊皮卷——活在当下，不去读那最后一页。', nextScene:'ch17_r1c', effects:{ tags:['逃避预言者'], memory:null,} }
    ...
    ch17_r2_choice: { id:'ch17_r2_choice', type:'choice', chapter:17, round:2, title:'第二轮选择 · 破译加速', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['羊皮卷的翻译速度在加快——快到你觉得不是你在读它，是它在你的脑海里直接印上文字。你看到了何塞·阿尔卡蒂奥·布恩迪亚被绑在栗树下的那一天——不是文字，是画面。你看到了蕾梅黛丝升天的那个下午——你甚至感觉到了一滴上天堂之前的雨水。','然后你看到了一行字——它让你停下了呼吸：","家族的第一个人被捆在一棵树上，最后一个人正被蚂蚁吃掉。","'], transition:'你选择——' }, choices:[
      { id:'ch17_r2_a', label:'继续读——面对全部真相', description:'不能逃避。读完它——哪怕最后一句是你不想看到的。', nextScene:'ch17_r2a', effects:{ tags:['勇敢的读者'], memory:null } },
      { id:'ch17_r2_b', label:'出去走走——消化一下', description:'你需要空气。放下羊皮卷——和阿玛兰妲·乌尔苏拉一起去栗树下走走。', nextScene:'ch17_r2b', effects:{ tags:['暂停者'], memory:null } },
      { id:'ch17_r2_c', label:'撕掉那一页——改变预言', description:'如果你撕掉它——也许预言就不会实现了？也许羊皮卷不是绝对的？', nextScene:'ch17_r2c', effects:{ tags:['反抗者'], memory:'被撕下的一页',} }
    ...
    ch17_r3_choice: { id:'ch17_r3_choice', type:'choice', chapter:17, round:3, title:'第三轮选择 · 她的恐惧', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['阿玛兰妲·乌尔苏拉也读了羊皮卷——只读了一小段——就被吓得脸都白了。她读到了那句关于"最后一个人正被蚂蚁吃掉"的话。她开始做梦——梦里有蚂蚁从墙缝里涌出来，爬过她的脚踝，爬过孩子的摇篮。','她醒来的时候——手心全是汗。她看着你——"我们不会有孩子吧？"她的声音在抖。但你不知道答案——你还没读到那一页。'], transition:'你选择——' }, choices:[
      { id:'ch17_r3_a', label:'安慰她——不会有事', description:'抱住她，告诉她这只是一个古老的预言。不一定会发生——不一定是指你们。', nextScene:'ch17_r3a', effects:{ tags:['安慰者'], memory:null } },
      { id:'ch17_r3_b', label:'诚实——告诉她你也不知道', description:'不给她虚假的承诺。预言可能是真的——但你们会一起面对。不管发生什么。', nextScene:'ch17_r3b', effects:{ tags:['诚实的伴侣'], memory:null } },
      { id:'ch17_r3_c', label:'重新翻译——看看有没有误解', description:'也许是翻译错了。重新检查那一段——用字典，用逻辑，用一切可能的解读方式。', nextScene:'ch17_r3c', effects:{ tags:['学者'], memory:null } }
    ...
    ch17_r4_choice: { id:'ch17_r4_choice', type:'choice', chapter:17, round:4, title:'第四轮选择 · 栗树下的老人', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['何塞·阿尔卡蒂奥·布恩迪亚——家族的第一个人——仍然被绑在栗树下。他已经很多年没有说过人话了——他说的都是梅尔基亚德斯教他的古老语言。但你听得懂——因为你现在正在翻译同样的语言。','他说的是："冰……它在烧……磁铁……没有黄金……大海……灰白的……""然后他抬起头——他的眼睛在百年之后忽然变得清澈。他看见了阿玛兰妲·乌尔苏拉。他笑了笑——然后说："乌尔苏拉，你还在揉面？"她不是乌尔苏拉——但她是。她就站在那里——就像百年前那个女人站在门口，双手叉腰，看着丈夫用一头骡子和一对山羊换两块磁铁。'], transition:'你选择——' }, choices:[
      { id:'ch17_r4_a', label:'陪他说话——用古老的语言', description:'你是唯一能懂他的人了。坐下来——用梅尔基亚德斯的语言和他对话。让他最后有人能听懂。', nextScene:'ch17_r4a', effects:{ tags:['最后的对话者'], memory:'古老语言的对话' } },
      { id:'ch17_r4_b', label:'解开他的绳子——让他自由', description:'他被绑了一百年了——没有人绑着他，是那些绳子忘了可以被解开。解开它们。让他走。', nextScene:'ch17_r4b', effects:{ tags:['解放者'], memory:null } },
      { id:'ch17_r4_c', label:'让他安静——不要打扰', description:'他在栗树下找到了自己的世界——不需要你来改变它。让他继续画圆圈——不要去触碰那种平衡。', nextScene:'ch17_r4c', effects:{ tags:['尊重者'], memory:null } }
    ...
    ch17_r5_choice: { id:'ch17_r5_choice', type:'choice', chapter:17, round:5, title:'第五轮选择 · 真相浮现', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['你读到羊皮卷的倒数第二页。你的手在颤抖——不是因为你读不懂——是因为你读到了你自己的名字。在梅尔基亚德斯的字体里——写着你。写着阿玛兰妲·乌尔苏拉。写着你们正在发生的爱——写着即将出生的孩子——写着蚂蚁。','你明白了。你不需要继续读最后一页——因为你正在活最后一页。羊皮卷写完了全部——包括你此刻在此处犹豫要不要翻下去的这一个动作。'], transition:'你选择——' }, choices:[
      { id:'ch17_r5_a', label:'翻到最后一页——接受命运', description:'读完它。知道自己的结局——然后去面对它。既然已经被写好了——那就活成它最好的版本。', nextScene:'ch17_r5a', effects:{ tags:['接受者'], memory:null } },
      { id:'ch17_r5_b', label:'不翻——用余生去猜', description:'留下最后一页——不去看结局。你们的余生会是一个谜——也许这比知道答案更仁慈。', nextScene:'ch17_r5b', effects:{ tags:['悬念保持者'], memory:null,} },
      { id:'ch17_r5_c', label:'把羊皮卷烧掉', description:'如果预言不存在——你们就可以自由。把羊皮卷扔进火里——连同它的所有句号。', nextScene:'ch17_r5c', effects:{ tags:['焚书者'], memory:'灰烬中的字' } }
...
registerChapter({
  ...
  scenes: {
    ...
    ch18_r1_choice: { id:'ch18_r1_choice', type:'choice', chapter:18, round:1, title:'第一轮选择 · 分娩', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['分娩持续了整整一夜。没有医生——马孔多已经没有医生了。没有助产士——你是唯一能帮她的人。你的手在抖——但你的声音很稳。','阿玛兰妲·乌尔苏拉喊了很多人的名字——她的母亲，她的祖母，乌尔苏拉——她喊了加斯通一次。但她握着的手是你的。'], transition:'你选择——' }, choices:[
      { id:'ch18_r1_a', label:'专注接生——保持冷静', description:'你不能慌。她是你在乎的人——保持专注，把每一个步骤都做好。深呼吸。', nextScene:'ch18_r1a', effects:{ tags:['冷静的接生者'], memory:null } },
      { id:'ch18_r1_b', label:'祈祷——向任何可能听见的力量', description:'你从来没有信过神——但今晚不是关于信仰，是关于希望。向梅尔基亚德斯祈祷，向乌尔苏拉祈祷。', nextScene:'ch18_r1b', effects:{ tags:['祈祷者'], memory:null } },
      { id:'ch18_r1_c', label:'跑出去找人帮忙', description:'马孔多一定还有人在——哪怕一个老人，一个懂草药的乡下女人。出去找。', nextScene:'ch18_r1c', effects:{ tags:['求助者'], memory:null } }
    ...
    ch18_r2_choice: { id:'ch18_r2_choice', type:'choice', chapter:18, round:2, title:'第二轮选择 · 孩子的名字', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['孩子出生了——是个男孩。他的皮肤是粉红色的，但眼睛已经很亮了。你抱着他——这是你第一次抱着一个和你血脉相连的人。','阿玛兰妲·乌尔苏拉躺在床上——虚弱，但微笑。"叫他什么？"她问。你忽然想起了费尔南达——想起她收到那个"捡来的"婴儿时一定带着多少恐惧。但现在你不怕了。'], transition:'你选择——' }, choices:[
      { id:'ch18_r2_a', label:'奥雷里亚诺——像你一样', description:'这是布恩迪亚家的名字——每一代都有一个奥雷里亚诺。延续传统。', nextScene:'ch18_r2a', effects:{ tags:['传统维护者'], memory:null } },
      { id:'ch18_r2_b', label:'何塞·阿尔卡蒂奥——像始祖', description:'用家族创始人的名字——让他带着第一个布恩迪亚的名字开始最后一个布恩迪亚的人生。', nextScene:'ch18_r2b', effects:{ tags:['致敬者'], memory:null } },
      { id:'ch18_r2_c', label:'一个全新的名字', description:'不用旧名字——给他一个新的。不属于任何历史——只属于他自己。打破循环。', nextScene:'ch18_r2c', effects:{ tags:['革新者'], memory:null,} }
    ...
    ch18_r3_choice: { id:'ch18_r3_choice', type:'choice', chapter:18, round:3, title:'第三轮选择 · 阿玛兰妲·乌尔苏拉之死', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['分娩顺利——但第二天阿玛兰妲·乌尔苏拉开始流血。不是普通的那种——是止不住的那种。她的脸色越来越白——像羊皮纸。','她没有喊——她很安静。她看着天花板——看着那些裂缝——她说："我终于明白了——为什么乌尔苏拉在失明之前一直擦墙壁。"她的嘴唇在动，但声音越来越轻。'], transition:'你选择——' }, choices:[
      { id:'ch18_r3_a', label:'守在她身边——不走开', description:'你没有放手。她的手指越来越冷——但你一直握着。她走的时候不是一个人。', nextScene:'ch18_r3a', effects:{ tags:['不离不弃者'], memory:'最后的诀别' } },
      { id:'ch18_r3_b', label:'去找药——哪怕希望渺茫', description:'你不能眼睁睁看着她走。跑去河对岸——也许废弃的香蕉公司医院里还有止血的药。', nextScene:'ch18_r3b', effects:{ tags:['最后的努力者'], memory:null } },
      { id:'ch18_r3_c', label:'把婴孩放在她怀里', description:'让她最后一次抱着孩子离开。让她的最后一刻是作为一个母亲——而不是一个流血的女人。', nextScene:'ch18_r3c', effects:{ tags:['慈悲者'], memory:'怀抱中的离去' } }
    ...
    ch18_r4_choice: { id:'ch18_r4_choice', type:'choice', chapter:18, round:4, title:'第四轮选择 · 独自面对', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['现在只剩下你和孩子了。栗树下的老人不算数——他已经不再属于这个世界了。房子里很安静——安静到你能听见蚂蚁在墙壁里行军的声音。','你抱着孩子——他正在哭。你不知道该如何做一个父亲——你是被费尔南达锁大的，你从来没有看过一个真正的父亲应该是什么样。但你看着这个婴儿——看着他粉红色的脸——你想起了你在羊皮卷里读到的东西。'], transition:'你选择——' }, choices:[
      { id:'ch18_r4_a', label:'接受——独自抚养他', description:'你可能是最后一个布恩迪亚了——但你不是一个人。把孩子养大——哪怕世界在倒塌。', nextScene:'ch18_r4a', effects:{ tags:['父亲'], memory:null } },
      { id:'ch18_r4_b', label:'哭泣——释放悲伤', description:'你不装坚强。你坐在她刚刚离开的床边——抱着孩子——哭了出来。', nextScene:'ch18_r4b', effects:{ tags:['允许悲痛者'], memory:null } },
      { id:'ch18_r4_c', label:'继续翻译——用工作麻痹自己', description:'你不能停下来。羊皮卷还剩下最后一页——你需要读完它。哪怕只是为了让自己不要想到她。', nextScene:'ch18_r4c', effects:{ tags:['逃避者'], memory:null } }
...
registerChapter({
  ...
  scenes: {
    ...
    ch19_r1_choice: { id:'ch19_r1_choice', type:'choice', chapter:19, round:1, title:'第一轮选择 · 蚂蚁与孩子', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['蚂蚁爬上了摇篮。它们不是要吃孩子——它们是来带走他。因为羊皮卷写好了：最后一个布恩迪亚会被蚂蚁带走。','你看见了——红线在白色的床单上延伸。孩子还在睡。他是无辜的——他只是生在了错误的家，错误的时间，错误的羊皮卷页上。'], transition:'你选择——' }, choices:[
      { id:'ch19_r1_a', label:'赶走蚂蚁——保护孩子', description:'预言说他会死——但你不接受。用手拍，用水冲，用火烧——不管用什么方法，赶走它们。', nextScene:'ch19_r1a', effects:{ tags:['反抗预言者'], memory:null,} },
      { id:'ch19_r1_b', label:'抱起孩子——逃跑', description:'离开这所房子。离开马孔多。如果预言只适用于这里——那就带着他离开这里。', nextScene:'ch19_r1b', effects:{ tags:['逃亡者'], memory:null } },
      { id:'ch19_r1_c', label:'站着——看着预言实现', description:'你伸出手——但你的手停住了。也许有些预言不应该被阻止。也许阻止它会让更糟的事情发生。', nextScene:'ch19_r1c', effects:{ tags:['见证者'], memory:'蚂蚁带走的孩子' } }
    ...
    ch19_r2_choice: { id:'ch19_r2_choice', type:'choice', chapter:19, round:2, title:'第二轮选择 · 飓风来临', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['风来了——不是微风，是飓风。它从东北方向来——从香蕉公司曾经喷吐蒸汽的那个方向。天空变成了一片浑浊的黄色——像梅尔基亚德斯的羊皮纸。','窗子被吹飞了——不是一扇一扇，是所有窗子同时飞出去。墙上的石灰像雪花一样飘落。栗树在风中剧烈摇晃——老人没有动，他还在画圆圈。他画的那个最大的圆圈——也许是为这阵风准备的。','马孔多正在被抹去——不是被敌人，不是被时间——是被风。被一种早在建村之前就已经写好的风。'], transition:'你选择——' }, choices:[
      { id:'ch19_r2_a', label:'回到梅尔基亚德斯的房间——读完羊皮卷', description:'在对的地方，读对的东西。在那间时间不会流逝的房间里——把你的故事读完。', nextScene:'ch19_r2a', effects:{ tags:['最后的读者'], memory:null } },
      { id:'ch19_r2_b', label:'跑出房子——看马孔多最后一眼', description:'如果一切都要消失——至少你的眼睛可以见证。跑出去，站在街道上——看看这个小镇最后的样子。', nextScene:'ch19_r2b', effects:{ tags:['最后的眺望者'], memory:'马孔多的最后一瞥' } },
      { id:'ch19_r2_c', label:'站在栗树下——和始祖一起等待', description:'走到栗树下——坐在老人旁边。他是第一个，你是最后一个。一起等待风把你们两人都带走。', nextScene:'ch19_r2c', effects:{ tags:['循环的闭合者'], memory:null } }
    ...
    ch19_r3_choice: { id:'ch19_r3_choice', type:'choice', chapter:19, round:3, title:'第三轮选择 · 最后的时刻', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['羊皮卷上最后的文字在你眼前成形。你不需要读了——你已经知道。","注定要一百年孤独的家族不会有第二次机会在大地上出现。","风在房子外面咆哮——墙壁正在被剥掉。你没有多少时间了。','你在这间时间不会流逝的房间里——在读着这最后一页。当你读完最后一行字的那一刻——这间房间的时间会和外面的时间对齐。然后风会进来——然后一切都会结束。'], transition:'你选择——' }, choices:[
      { id:'ch19_r3_a', label:'读完最后一行——接受结束', description:'你有勇气开始——你也有勇气结束。读完它。让风来做它该做的事。', nextScene:'ch19_r3a', effects:{ tags:['完成者'], memory:null } },
      { id:'ch19_r3_b', label:'闭上眼睛——不读最后一行', description:'也许不读完——故事就不会结束。也许最后一个字永远不被读到的故事可以永远活下去。', nextScene:'ch19_r3b', effects:{ tags:['永恒的悬念'], memory:'未完的最后一行',} },
      { id:'ch19_r3_c', label:'在羊皮卷末尾写下自己的名字', description:'你不是只被预言——你也可以预言。拿起梅尔基亚德斯的鹅毛笔——在羊皮卷末尾加上一个词。', nextScene:'ch19_r3c', effects:{ tags:['续写者'], memory:'自己写下的名字' } }
...
registerChapter({
  ...
  scenes: {
    ...
    ch20_r1_choice: { id:'ch20_r1_choice', type:'choice', chapter:20, round:1, title:'第一轮选择 · 记忆的重量', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['你感到你的记忆在涌出来——不是作为文字，是作为画面。它们从你的意识中升起，像气泡一样漂浮在你周围。','你看见何塞·阿尔卡蒂奥·布恩迪亚蹲在地上，手里握着两块磁铁。你看见乌尔苏拉在厨房里揉面。你看见奥雷里亚诺上校站在行刑队的墙前——他没有蒙眼。你看见阿玛兰妲缝着她的裹尸布。你看见梅梅的蝴蝶，三千人的火车，四年的大雨，美人升天——最后你看见了自己。你坐在一个屏幕前——你的手还在键盘上。'], transition:'你选择——' }, choices:[
      { id:'ch20_r1_a', label:'拥抱全部记忆——轻或重都要', description:'这些不是负担——是你存在过的证据。把它们全部收进心里——连同那些最痛的。', nextScene:'ch20_r1a', effects:{ tags:['全盘接受者'], memory:null } },
      { id:'ch20_r1_b', label:'选择留下温暖的部分', description:'让那些最痛的记忆离去——只留下让你微笑的。你不欠那些痛苦——你可以选择放下。', nextScene:'ch20_r1b', effects:{ tags:['选择记忆者'], memory:null } },
      { id:'ch20_r1_c', label:'放手——全部忘记', description:'一百年的孤独已经够了。放下一切——让自己变轻。你不是记忆的囚徒。', nextScene:'ch20_r1c', effects:{ tags:['释放者'], memory:null,} }
    ...
    ch20_r2_choice: { id:'ch20_r2_choice', type:'choice', chapter:20, round:2, title:'第二轮选择 · 永恒的回归', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['一片安静的白色。不是羊皮纸的白——是某种更深沉的、包含了所有颜色的白。你感觉有一个人在你身后——不是梅尔基亚德斯。是你自己。','你回头——你看见了：那个在屏幕上握着鼠标或手指悬在键盘上的人。那人就是你——从故事开始之前就在阅读的你。你们面对面看着——读者和被写入书中的灵魂。你已经分不清谁是创造者，谁是被创造的了。也许从来就分不清。'], transition:'你选择——' }, choices:[
      { id:'ch20_r2_a', label:'合上书——带着那些故事继续生活', description:'故事已经讲完了——但你还活着。合上它，站起来，走进你自己的生活里。带着所有布恩迪亚在你身上留下的痕迹。', nextScene:'ch20_r2a', effects:{ tags:['回归者'], memory:null } },
      { id:'ch20_r2_b', label:'再读一遍——从另一个入口', description:'回到序章——从另一个时代重新开始。看看如果你选择了另一条路，这个家族会不会有不同的结局。', nextScene:'ch20_r2b', effects:{ tags:['循环者'], memory:null } },
      { id:'ch20_r2_c', label:'写下你自己的开始', description:'不要合上书——打开一页空白的纸，写下你自己的故事。不是布恩迪亚的——是你自己的。', nextScene:'ch20_r2c', effects:{ tags:['创作者'], memory:'空白的第一页',} }
