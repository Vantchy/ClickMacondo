...
registerChapter({
  ...
  scenes: {
    ...
    ch13_r1_choice: { id:'ch13_r1_choice', type:'choice', chapter:13, round:1, title:'第一轮选择 · 蝴蝶之约', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['马乌里肖·巴比伦——香蕉公司机械师的学徒。他身上总有机油味——和蝴蝶。黄色的蝴蝶总是跟着他——像他是一朵移动的花。','他约你去电影院——不是马孔多的电影院（马孔多没有），是省城的。你母亲费尔南达决不会允许——但你不是你母亲。'], transition:'你选择——' }, choices:[
      { id:'ch13_r1_a', label:'偷偷去——不让母亲知道', description:'爱情不需要许可。翻窗，穿过花园——让他带你去。蝴蝶会为你们开路。', nextScene:'ch13_r1a', effects:{ tags:['偷偷恋爱者'], memory:null, fate: -1, bond: 2, relationshipEffects: { '梅梅（雷纳塔·蕾梅黛丝·布恩迪亚）': +15 } } },
      { id:'ch13_r1_b', label:'告诉母亲——争取她的理解', description:'你不是离家出走——你是去爱。告诉费尔南达——也许她会理解。也许她不会。', nextScene:'ch13_r1b', effects:{ tags:['坦诚者'], memory:null, fate: 1, bond: 1, relationshipEffects: { '梅梅（雷纳塔·蕾梅黛丝·布恩迪亚）': +10 } } },
      { id:'ch13_r1_c', label:'拒绝——保持安全的距离', description:'他是香蕉公司的工人——你母亲永远不会接受。趁还没有陷得太深——停下来。', nextScene:'ch13_r1c', effects:{ tags:['自制者'], memory:'未赴的约', fate: 1, bond: -1, relationshipEffects: { '梅梅（雷纳塔·蕾梅黛丝·布恩迪亚）': -10 } } }
    ...
    ch13_r2_choice: { id:'ch13_r2_choice', type:'choice', chapter:13, round:2, title:'第二轮选择 · 费尔南达的愤怒', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['费尔南达发现了——不是蝴蝶，是电影院的门票。她在梅梅的口袋里找到了一张撕了一半的电影票。她拿着票在桌子上质问梅梅——票在发抖，不是因为她的手在抖，是因为她的整个世界观都被这半张纸撕碎了。','"你和一个工人——出去？"这不是问句。这是判决。费尔南达在她的人生剧本里——梅梅要嫁给贵族，要住在省城，要在教堂里举办婚礼。马乌里肖·巴比伦——这个满手机油的男人——不在剧本里。'], transition:'你选择——' }, choices:[
      { id:'ch13_r2_a', label:'反抗——维护你的爱', description:'站在母亲面前，告诉她：你爱他。不管她同不同意——你已经决定了。', nextScene:'ch13_r2a', effects:{ tags:['反抗的女儿'], memory:null, fate: 0, bond: 2, relationshipEffects: { '梅梅（雷纳塔·蕾梅黛丝·布恩迪亚）': +15 } } },
      { id:'ch13_r2_b', label:'低头——但暗地继续', description:'表面上服从——让母亲以为你放弃了。但暗地里继续见他。用更巧妙的方式。', nextScene:'ch13_r2b', effects:{ tags:['伪装者'], memory:null, fate: 0, bond: 2, relationshipEffects: { '梅梅（雷纳塔·蕾梅黛丝·布恩迪亚）': +10 } } },
      { id:'ch13_r2_c', label:'妥协——和他约定将来', description:'现在时机不对——但可以等。和马乌里肖约定：等时机成熟再在一起。', nextScene:'ch13_r2c', effects:{ tags:['耐心的爱人'], memory:null, fate: 1, bond: -1, relationshipEffects: { '梅梅（雷纳塔·蕾梅黛丝·布恩迪亚）': -5 } } }
    ...
    ch13_r3_choice: { id:'ch13_r3_choice', type:'choice', chapter:13, round:3, title:'第三轮选择 · 夜间的幽会', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['深夜。黄蝴蝶在后院的棕榈树下聚集——它们的光芒在黑暗中像摇动的烛火。马乌里肖在等你。他每天都来——不管下雨还是晴天。他已经等了很久。','费尔南达不知道——但她感觉到了。她今天在后院的草丛里发现了汽油的痕迹。她让人在后院放了岗哨——门房每晚都守着。但马乌里肖有他的途径——他翻墙，爬树，避开一切障碍——只为见你几分钟。'], transition:'你选择——' }, choices:[
      { id:'ch13_r3_a', label:'继续——每晚见他', description:'费尔南达的岗哨挡不住爱情。每天晚上——在后院，在蝴蝶的掩护下。', nextScene:'ch13_r3a', effects:{ tags:['不悔的爱人'], memory:null, fate: 0, bond: 2, relationshipEffects: { '梅梅（雷纳塔·蕾梅黛丝·布恩迪亚）': +15 } } },
      { id:'ch13_r3_b', label:'减少频率——更谨慎', description:'现在太危险了。减少见面——但每次见面都更珍贵。让他知道你不是不爱——是更爱。', nextScene:'ch13_r3b', effects:{ tags:['谨慎的爱人'], memory:null, fate: 1, bond: -1, relationshipEffects: { '梅梅（雷纳塔·蕾梅黛丝·布恩迪亚）': +5 } } },
      { id:'ch13_r3_c', label:'一起去省城——私奔', description:'马孔多容不下这个爱情。和他一起离开——去一个没有岗哨和蝴蝶也要重新开始的地方。', nextScene:'ch13_r3c', effects:{ tags:['私奔者'], memory:null, fate: 1, bond: -1, relationshipEffects: { '梅梅（雷纳塔·蕾梅黛丝·布恩迪亚）': +10 } } }
    ...
    ch13_r4_choice: { id:'ch13_r4_choice', type:'choice', chapter:13, round:4, title:'第四轮选择 · 费尔南达的报复', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['费尔南达的报复来得很快。她不是自己去做的——她叫来了警察。在后院——在那个你每晚和马乌里肖约会的地方——枪响了。不是杀人的枪——是射向天花的枪。但子弹打破的不只是空气——是你的世界。','马乌里肖倒在地上——子弹打中了他的脊椎。他没有死——但他再也站不起来了。费尔南达把他送到了遥远的医院——她付了钱，条件是他永远不回来。蝴蝶消失了——不是一只一只，是同时全部消失。空气里只剩下汽油味。'], transition:'你选择——' }, choices:[
      { id:'ch13_r4_a', label:'去他的医院——陪着他', description:'马乌里肖需要你。不管费尔南达怎么想——你要去陪着他直到他站起来。', nextScene:'ch13_r4a', effects:{ tags:['忠诚的爱人'], memory:null, fate: -1, bond: 2, relationshipEffects: { '梅梅（雷纳塔·蕾梅黛丝·布恩迪亚）': +15 } } },
      { id:'ch13_r4_b', label:'留在家——但永不忘恨', description:'你不能去——但你会记住。在你的心里为费尔南达建一座坟。', nextScene:'ch13_r4b', effects:{ tags:['怀恨者'], memory:null, fate: 1, bond: -1, relationshipEffects: { '梅梅（雷纳塔·蕾梅黛丝·布恩迪亚）': -10 } } },
      { id:'ch13_r4_c', label:'把自己关起来——不说话', description:'你不去任何地方——也不说任何话。用沉默建造一座监狱——把自己和世界隔开。', nextScene:'ch13_r4c', effects:{ tags:['沉默的囚徒'], memory:'沉默的监狱', fate: 0, bond: -2, relationshipEffects: { '梅梅（雷纳塔·蕾梅黛丝·布恩迪亚）': -5 } } }
...
registerChapter({
  ...
  scenes: {
    ...
    ch16_r1_choice: { id:'ch16_r1_choice', type:'choice', chapter:16, round:1, title:'第一轮选择 · 初见', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['她看着你——你看着羊皮卷。她走进那间时间不会流逝的房间——"你是谁？"你抬头——她的眼睛像另一个布恩迪亚，但你不知道像谁。','加斯通站在门口——他看起来不太确定自己为什么在这里。阿玛兰妲·乌尔苏拉说要回来重建家园——但他看见的是一片废墟。','但你不关心加斯通。你关心的是：这个女人的眼睛——为什么你在羊皮卷里读到过它们？'], transition:'你选择——' }, choices:[
      { id:'ch16_r1_a', label:'告诉她羊皮卷的秘密', description:'她是布恩迪亚——她有权知道。把你正在翻译的事告诉她。', nextScene:'ch16_r1a', effects:{ tags:['坦诚的守护者'], memory:null, fate: -1, bond: 2, relationshipEffects: { '阿玛兰妲·乌尔苏拉': +15 } } },
      { id:'ch16_r1_b', label:'保持距离——观察她', description:'你不了解她。让她先证明自己——然后再决定可以告诉她多少。', nextScene:'ch16_r1b', effects:{ tags:['谨慎者'], memory:null, fate: 1, bond: -1, relationshipEffects: { '阿玛兰妲·乌尔苏拉': -10 } } },
      { id:'ch16_r1_c', label:'欢迎她——帮忙重建', description:'她回来修复这所房子——你可以帮忙。在共同劳作中慢慢认识彼此。', nextScene:'ch16_r1c', effects:{ tags:['合作者'], memory:null, fate: 0, bond: 0, relationshipEffects: { '阿玛兰妲·乌尔苏拉': +10 } } }
    ...
    ch16_r2_choice: { id:'ch16_r2_choice', type:'choice', chapter:16, round:2, title:'第二轮选择 · 加斯通的离开', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['加斯通感觉到了——他的妻子正在远离他。不是出轨——是更深的：她的心已经在马孔多生了根。他提议回去——"欧洲有你的诊所，你的生活。"她犹豫了。','他最后说服她尝试——用一封航空信。他订了机票——但信上没有写日期。他知道自己在赌。'], transition:'你选择——' }, choices:[
      { id:'ch16_r2_a', label:'劝她留下', description:'不要让她走——马孔多需要她，羊皮卷需要她。有些话如果现在不说——就永远没机会了。', nextScene:'ch16_r2a', effects:{ tags:['挽留者'], memory:null, fate: -1, bond: 2, relationshipEffects: { '阿玛兰妲·乌尔苏拉': +15 } } },
      { id:'ch16_r2_b', label:'不干涉——让她自己选', description:'婚姻是她的——去留也是她的。你不能替她做这个决定。', nextScene:'ch16_r2b', effects:{ tags:['尊重者'], memory:null, fate: 0, bond: 1, relationshipEffects: { '阿玛兰妲·乌尔苏拉': +10 } } },
      { id:'ch16_r2_c', label:'告诉加斯通真相', description:'她正在爱上马孔多——或许不止马孔多。让加斯通知道——他的心虽然会碎，但比被骗好。', nextScene:'ch16_r2c', effects:{ tags:['诚实者'], memory:null, fate: 1, bond: -1, relationshipEffects: { '阿玛兰妲·乌尔苏拉': -5 } } }
    ...
    ch16_r3_choice: { id:'ch16_r3_choice', type:'choice', chapter:16, round:3, title:'第三轮选择 · 接近', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['加斯通走了以后——房子里只剩下你们两个人。（还有栗树下的老人——但他不算数了。）','你们白天一起修房子——晚上一起读羊皮卷。她的头发在烛光下是暗金色的。她翻译拉丁文的速度比你还快——因为她在欧洲学过。但她的笑声是你没有听过的——在这个古老的房间里，笑声听起来像一种会被禁用的语言。'], transition:'你选择——' }, choices:[
      { id:'ch16_r3_a', label:'吻她', description:'你不想再等了。烛光、羊皮卷、她的头发——这些信号不需要翻译。', nextScene:'ch16_r3a', effects:{ tags:['勇敢的爱人'], memory:null, fate: 1, bond: 2, relationshipEffects: { '阿玛兰妲·乌尔苏拉': +15 } } },
      { id:'ch16_r3_b', label:'等待——保持友谊', description:'太快了。她刚送走丈夫——你需要给她时间。哪怕你的心已经在你的舌头上跳动了。', nextScene:'ch16_r3b', effects:{ tags:['克制的爱人'], memory:null, fate: -1, bond: 1, relationshipEffects: { '阿玛兰妲·乌尔苏拉': +10 } } },
      { id:'ch16_r3_c', label:'用羊皮卷表达', description:'你不会说话——但你会在羊皮卷的翻译边缘写下一行小字：你在这里。在所有的名字里——你在读的这一页里。', nextScene:'ch16_r3c', effects:{ tags:['以笔代口者'], memory:'羊皮卷边缘的情书', fate: 0, bond: 1, relationshipEffects: { '阿玛兰妲·乌尔苏拉': +10 } } }
    ...
    ch16_r4_choice: { id:'ch16_r4_choice', type:'choice', chapter:16, round:4, title:'第四轮选择 · 重建家园', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['阿玛兰妲·乌尔苏拉看着这所房子——腐烂、破败、几乎要倒。但她看见的不是废墟——她看见的是她的童年，是乌尔苏拉的厨房，是走廊里的阳光。','她说："我们要重建它。"不是疑问句——是布恩迪亚式的决定。她拿出了她在欧洲赚的钱——不多，但足够。'], transition:'你选择——' }, choices:[
      { id:'ch16_r4_a', label:'全力帮忙重建', description:'和她一起——修墙、换梁、种花。让这所房子重新活过来。', nextScene:'ch16_r4a', effects:{ tags:['重建者'], memory:null, fate: -1, bond: 2, relationshipEffects: { '阿玛兰妲·乌尔苏拉': +15 } } },
      { id:'ch16_r4_b', label:'保护羊皮卷——不让重建打扰', description:'房子可以修——但羊皮卷不能被干扰。划定区域——梅尔基亚德斯的房间不能动。', nextScene:'ch16_r4b', effects:{ tags:['保护者'], memory:null, fate: 2, bond: -1, relationshipEffects: { '阿玛兰妲·乌尔苏拉': -5 } } },
      { id:'ch16_r4_c', label:'反对——房子不值得修', description:'马孔多已经死了。与其修房子——不如离开这里，去一个新地方重新开始。', nextScene:'ch16_r4c', effects:{ tags:['现实主义者'], memory:null, fate: 1, bond: -1, relationshipEffects: { '阿玛兰妲·乌尔苏拉': -10 } } },
