...
registerChapter({
  ...
  scenes: {
    ...
    ch9_r1_choice: { id:'ch9_r1_choice', type:'choice', chapter:9, round:1, title:'第一轮选择 · 费尔南达', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['费尔南达——从遥远的省城来的女孩，带着皇后一样的气质和一个家族使命。她从小被教导：她是女王。但现在她站在马孔多的狂欢节上——穿着旧裙子，脸上的妆已经被汗水融化了一半。','奥雷里亚诺第二看见了她。他停住了——手里的酒杯差点掉了。"我要娶她。"他说。没有人知道他是不是认真的——他总是在笑。但这一次他没有笑。'], transition:'你选择——' }, choices:[
      { id:'ch9_r1_a', label:'支持他——追求费尔南达', description:'奥雷里亚诺第二需要安定下来。费尔南达也许就是这个家的定海神针。', nextScene:'ch9_r1a', effects:{ tags:['支持者'], memory:null, fate:0, bond:1, relationshipEffects: { '费尔南达·德尔·卡皮奥': +15 } } },
      { id:'ch9_r1_b', label:'警告他——她不合适', description:'费尔南达带着太多规则和"必须"。她不会融入布恩迪亚家——她会试图改造它。', nextScene:'ch9_r1b', effects:{ tags:['警告者'], memory:null, fate:1, bond:0, relationshipEffects: { '费尔南达·德尔·卡皮奥': -10 } } },
      { id:'ch9_r1_c', label:'不干涉——让他自己决定', description:'布恩迪亚家的人从不听劝。让他自己走这条路——无论它通向哪里。', nextScene:'ch9_r1c', effects:{ tags:['沉默的旁观者'], memory:null, fate:0, bond:-1, relationshipEffects: { '费尔南达·德尔·卡皮奥': +5 } } }
    ...
    ch9_r3_choice: { id:'ch9_r3_choice', type:'choice', chapter:9, round:3, title:'第三轮选择 · 费尔南达的家规', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['费尔南达开始实施她的规则。窗帘必须拉上——"阳光会弄脏家具。"吃饭时必须用刀叉——不能用手。说话声音必须放低——"布恩迪亚家不是市集。"走廊里不能奔跑——不能打赤脚——不能在客厅里做爱。','奥雷里亚诺第二的胃口没有了。不是因为吃不下——是因为每次吃饭她都要念一段祷词。他等不及阿门就伸手去抓面包——她拍他的手。整个家开始像一个被慢慢勒紧的拳头。'], transition:'你选择——' }, choices:[
      { id:'ch9_r3_a', label:'抵制——维护布恩迪亚的自由', description:'这个家从来不需要规则。站在奥雷里亚诺第二一边——抵抗费尔南达的统治。', nextScene:'ch9_r3a', effects:{ tags:['抵抗者'], memory:null, fate:2, bond:-1, relationshipEffects: { '费尔南达·德尔·卡皮奥': -10 } } },
      { id:'ch9_r3_b', label:'妥协——给她一些空间', description:'也许这个家确实需要一些秩序。和费尔南达谈谈——找到中间地带。', nextScene:'ch9_r3b', effects:{ tags:['妥协者'], memory:null, fate:0, bond:1, relationshipEffects: { '费尔南达·德尔·卡皮奥': +15 } } },
      { id:'ch9_r3_c', label:'搬出去——离开这个家', description:'你不需要忍受这个。收拾东西，搬到别处去——让费尔南达统治一个空房子。', nextScene:'ch9_r3c', effects:{ tags:['出走者'], memory:'空荡的走廊', fate:1, bond:-1, relationshipEffects: { '费尔南达·德尔·卡皮オ': -5 } } }
    ...
    ch9_r4_choice: { id:'ch9_r4_choice', type:'choice', chapter:9, round:4, title:'第四轮选择 · 奥雷里亚诺第二的逃离', leftPage:{ speaker:'旁白', speakerColor:'#4a2a18', paragraphs:['奥雷里亚诺第二不再回家了。他住在佩特拉·科特斯家里——他的情妇那里。他的胃口回来了——他每天吃三头牛，喝整桶的酒。他的笑声又响起来了——在费尔南达听不到的地方。','但他不是为了佩特拉才不回家的。他是为了躲避那个说话像念祷告、走路像仪仗队的女人。他从来不承认他怕她——但他每次回家都只待到自己能忍耐的最后一秒。'], transition:'你选择——' }, choices:[
      { id:'ch9_r4_a', label:'劝他回家——挽回婚姻', description:'费尔南达也许不是最好的——但她是他的妻子。家庭需要他回去。', nextScene:'ch9_r4a', effects:{ tags:['劝和者'], memory:null, fate:0, bond:1, relationshipEffects: { '费尔南达·德尔·卡皮オ': +15 } } },
      { id:'ch9_r4_b', label:'支持他——留在情妇身边', description:'他在佩特拉那里才真正活着。让他待在能让他笑的地方。', nextScene:'ch9_r4b', effects:{ tags:['自由的支持者'], memory:null, fate:1, bond:1, relationshipEffects: { '费尔南达·德尔·卡皮オ': -10 } } },
      { id:'ch9_r4_c', label:'不评判——让他自己选择', description:'婚姻是两个人的事——你不是第三个人。让他自己决定在哪张床上醒来。', nextScene:'ch9_r4c', effects:{ tags:['中立者'], memory:null, fate:0, bond:0, relationshipEffects: { '费尔南达·德尔·卡皮オ': +5 } } }
